...
void main(List<String> args) {
  ...
  // Dart2js
  //
  addTask('dart2js', createDartCompilerTask(['web/game_web.dart'], minify: true,
  ...
  addTask('app_update_js', createCopyJSTask('app_package', browserDart: true,
      browserInterop: true));

  //
  // gh_pages
  //
  addTask('pages', (ctx) => branchForDir(ctx, 'master', 'web', 'gh-pages'));
