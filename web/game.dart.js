...
$$.Object = {"":
 ...
 get$keyIdentifier: function() {
  return this.noSuchMethod$2("get:keyIdentifier", []);
 },
...
$$.GameElement = {"":
 ...
 _toggleFlag$2: function(x,y){var ss=this.get$game().getSquareState$2(x,y);if($.eqB(ss,$.CTC34)){this.get$game().setFlag$3(x,y,true);$.playAudio('Flag2');return true;}else if($.eqB(ss,$.CTC36)){this.get$game().setFlag$3(x,y,false);$.playAudio('Unflag2');return true;}return false;},
...
$._onKeyDown = function(args){switch(args.get$keyIdentifier()){case 'U+001B':$._toggleAbout(false);break;case 'U+003F':case 'U+0048':$._toggleAbout(null);break;}};
...
$.$defineNativeClass('KeyboardEvent', ["keyIdentifier?", "shiftKey?"], {
});
