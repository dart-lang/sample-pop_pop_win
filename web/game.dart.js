...
$$.FutureImpl = {"":
 ...
 _setValue$1: function(value){if(this._isComplete)throw $.$$throw($.FutureAlreadyCompleteException$());this._lib1_value=value;this._complete$0();},
...
$$.HashMapImplementation = {"":
 ...
 "super": "Object",
 _probeForAdding$1: function(key){if(key==null)throw $.$$throw($.CTC0);var t1=$.hashCode(key);if(t1!==(t1|0))return this._probeForAdding$1$bailout(1,key,t1);var hash=(t1&this._keys.length-1)>>>0;for(var numberOfProbes=1,insertionIndex=-1;true;){t1=this._keys;if(hash<0||hash>=t1.length)throw $.ioore(hash);var existingKey=t1[hash];if(existingKey==null){if(insertionIndex<0)return hash;return insertionIndex;}else if($.eqB(existingKey,key))return hash;else if(insertionIndex<0&&$.CTC11===existingKey)insertionIndex=hash;var numberOfProbes0=numberOfProbes+1;hash=$.HashMapImplementation__nextProbe(hash,numberOfProbes,this._keys.length);numberOfProbes=numberOfProbes0;}},
 ...
 remove$1: function(key){var index=this._probeForLookup$1(key);if($.geB(index,0)){this._numberOfEntries=this._numberOfEntries-1;var t1=this._values;if(index!==(index|0))throw $.iae(index);if(index<0||index>=t1.length)throw $.ioore(index);var value=t1[index];t1[index]=null;t1=this._keys;if(index>=t1.length)throw $.ioore(index);t1[index]=$.CTC11;this._numberOfDeleted=this._numberOfDeleted+1;return value;}return;},
 isEmpty$0: function(){return this._numberOfEntries===0;},
 get$length: function(){return this._numberOfEntries;},
 forEach$1: function(f){var length$=this._keys.length;for(var i=0;i<length$;++i){var t1=this._keys;if(i>=t1.length)throw $.ioore(i);var key=t1[i];if(!(key==null)&&!(key===$.CTC11)){t1=this._values;if(i>=t1.length)throw $.ioore(i);f.call$2(key,t1[i]);}}},
...
$$.HashSetIterator = {"":
 ["_lib1_entries", "_nextValidIndex"],
 "super": "Object",
 hasNext$0: function(){var t1=this._nextValidIndex;var t2=this._lib1_entries;var t3=t2.length;if(t1>=t3)return false;if(t1<0)throw $.ioore(t1);if(t2[t1]===$.CTC11)this._advance$0();return this._nextValidIndex<t3;},
 next$0: function(){if(this.hasNext$0()!==true)throw $.$$throw($.CTC12);var t1=this._lib1_entries;var t2=this._nextValidIndex;if(t2<0||t2>=t1.length)throw $.ioore(t2);var res=t1[t2];this._advance$0();return res;},
 _advance$0: function(){var t1=this._lib1_entries;var length$=t1.length;var entry=null;do{var t2=this._nextValidIndex+1;this._nextValidIndex=t2;if(t2>=length$)break;t2=this._nextValidIndex;if(t2<0||t2>=length$)throw $.ioore(t2);entry=t1[t2];}while(entry==null||entry===$.CTC11);},
...
$$.DoubleLinkedQueueEntry = {"":
 ["_previous!", "_lib1_next=", "_element?"],
 "super": "Object",
 _link$2: function(p,n){this._lib1_next=n;this._previous=p;p.set$_lib1_next(this);n.set$_previous(this);},
 prepend$1: function(e){$.DoubleLinkedQueueEntry$(e)._link$2(this._previous,this);},
 remove$0: function(){var t1=this._lib1_next;this._previous.set$_lib1_next(t1);t1=this._previous;this._lib1_next.set$_previous(t1);this._lib1_next=null;this._previous=null;return this._element;},
...
$$.DoubleLinkedQueue = {"":
 ...
 removeFirst$0: function(){return this._sentinel._lib1_next.remove$0();},
 ...
 isEmpty$0: function(){var t1=this._sentinel;return t1._lib1_next===t1;},
 clear$0: function(){var t1=this._sentinel;t1._lib1_next=t1;t1=this._sentinel;t1._previous=t1;},
 forEach$1: function(f){var entry=this._sentinel._lib1_next;for(;!(entry===this._sentinel);){var nextEntry=entry.get$_lib1_next();f.call$1(entry.get$_element());entry=nextEntry;}},
 every$1: function(f){var entry=this._sentinel._lib1_next;for(;!(entry===this._sentinel);){var nextEntry=entry.get$_lib1_next();if(f.call$1(entry.get$_element())!==true)return false;entry=nextEntry;}return true;},
 map$1: function(f){var other=$.Queue_Queue();var entry=this._sentinel._lib1_next;for(;!(entry===this._sentinel);){var nextEntry=entry.get$_lib1_next();$.addLast(other,f.call$1(entry.get$_element()));entry=nextEntry;}return other;},
 filter$1: function(f){var other=$.Queue_Queue();var entry=this._sentinel._lib1_next;for(;!(entry===this._sentinel);){var nextEntry=entry.get$_lib1_next();if(f.call$1(entry.get$_element())===true)$.addLast(other,entry.get$_element());entry=nextEntry;}return other;},
...
$$._DoubleLinkedQueueIterator = {"":
 ...
 "super": "Object",
 hasNext$0: function(){return !(this._currentEntry.get$_lib1_next()===this._sentinel);},
 next$0: function(){if(this.hasNext$0()!==true)throw $.$$throw($.CTC12);this._currentEntry=this._currentEntry.get$_lib1_next();return this._currentEntry.get$element();},
...
$$._MatchImplementation = {"":
 ["pattern", "str", "_lib1_start", "_end", "_groups"],
 "super": "Object",
...
$$._AllMatchesIterator = {"":
 ["_re", "_str", "_lib1_next=", "_done"],
 "super": "Object",
 next$0: function(){if(this.hasNext$0()!==true)throw $.$$throw($.CTC12);var next=this._lib1_next;this._lib1_next=null;return next;},
 hasNext$0: function(){if(this._done)return false;else if(!(this._lib1_next==null))return true;this._lib1_next=this._re.firstMatch$1(this._str);if(this._lib1_next==null){this._done=true;return false;}else return true;}
};
...
$$.Object = {"":
 ...
 noSuchMethod$2: function(name$,args){throw $.$$throw($.NoSuchMethodError$(this,name$,args,null));},
 ...
 wireSquareMouseEvent$1: function($0) {
  return this.noSuchMethod$2("wireSquareMouseEvent", [$0]);
 },
 _set$2: function($0, $1) {
  return this.noSuchMethod$2("_set", [$0, $1]);
 },
 _playAudioCore$1: function($0) {
  return this.noSuchMethod$2("_playAudioCore", [$0]);
 },
 ...
 _clearTimeout$0: function() {
  return this.noSuchMethod$2("_clearTimeout", []);
 },
 ...
 _doMouseUp$2: function($0, $1) {
  return this.noSuchMethod$2("_doMouseUp", [$0, $1]);
 },
 ...
 assign$1: function($0) {
  return this.noSuchMethod$2("assign", [$0]);
 },
 _count_1$0: function() {
 ...
 _doMouseDown$2: function($0, $1) {
  return this.noSuchMethod$2("_doMouseDown", [$0, $1]);
 },
 ...
 get$_squareMouseMove: function() {
  return this.noSuchMethod$2("get:_squareMouseMove", []);
 },
 ...
 get$keyDown: function() {
  return this.noSuchMethod$2("get:keyDown", []);
 },
 get$id: function() {
  return this.noSuchMethod$2("get:id", []);
 },
 get$_mouseDownTimeoutHandle: function() {
  return this.noSuchMethod$2("get:_mouseDownTimeoutHandle", []);
 },
 ...
 get$_canvas: function() {
  return this.noSuchMethod$2("get:_canvas", []);
 },
 get$_squareMouseDown: function() {
  return this.noSuchMethod$2("get:_squareMouseDown", []);
 },
 ...
 get$_onLoad: function() {
  return this.noSuchMethod$2("get:_onLoad", []);
 },
 ...
 get$toElement: function() {
  return this.noSuchMethod$2("get:toElement", []);
 },
 ...
 get$_playAudio: function() {
  return this.noSuchMethod$2("get:_playAudio", []);
 },
 get$scaleX: function() {
 ...
 get$rootElement: function() {
  return this.noSuchMethod$2("get:rootElement", []);
 },
 ...
 get$keyCode: function() {
  return this.noSuchMethod$2("get:keyCode", []);
 },
 ...
 get$_audioContext: function() {
  return this.noSuchMethod$2("get:_audioContext", []);
 },
 get$url: function() {
 ...
 get$_squareMouseUp: function() {
  return this.noSuchMethod$2("get:_squareMouseUp", []);
 },
 ...
 get$bombCount: function() {
  return this.noSuchMethod$2("get:bombCount", []);
 },
 ...
 get$bombsLeft: function() {
  return this.noSuchMethod$2("get:bombsLeft", []);
 },
...
$$.ConstantMap = {"":
 ...
 getValues$0: function(){var result=[];$.forEach(this._lib4_keys,new $.ConstantMap_getValues_anon(this,result));return result;},
 isEmpty$0: function(){return $.eq($.get$length(this),0);},
 toString$0: function(){return $.Maps_mapToString(this);},
...
$$._Audio = {"":
 ...
 get$done: function(){var t1=this._audioLoader;if(t1==null)return true;else return $.eq(t1.get$state(),'loaded');},
 get$_audioContext: function(){var t1=this._audioLoader;if(!(t1==null))return t1.get$context();else return;},
 _onLoad$1: function(args){var t1=$.iterator($.CTC);var t2=this._buffers;if(typeof t2!=='object'||t2===null||(t2.constructor!==Array||!!t2.immutable$list)&&!t2.is$JavaScriptIndexingBehavior())return this._onLoad$1$bailout(1,t2,t1);var t4=this._audioLoader;for(;t1.hasNext$0()===true;){var t3=t1.next$0();var t5=t4.getResource$1('audio/'+$.S(t3)+'.webm');if(t3!==(t3|0))throw $.iae(t3);if(t3<0||t3>=t2.length)throw $.ioore(t3);t2[t3]=t5;}},
 _onLoad$1$bailout: function(state0,t2,t1){var t4=this._audioLoader;for(;t1.hasNext$0()===true;){var t3=t1.next$0();$.indexSet(t2,t3,t4.getResource$1('audio/'+$.S(t3)+'.webm'));}},
...
$$._FilteredElementList = {"":
 ...
 sort$1: function(compare){throw $.$$throw($.CTC50);},
...
$$._ChildrenElementList = {"":
 ...
 _toList$0$bailout: function(state0,t1){var output=$.ListImplementation_List($.get$length(t1));for(var len=$.get$length(t1),i=0;$.ltB(i,len);++i){var t2=$.index(t1,i);if(i>=output.length)throw $.ioore(i);output[i]=t2;}return output;},
...
$$._FrozenElementList = {"":
 ...
 addAll$1: function(collection){throw $.$$throw($.CTC42);},
 sort$1: function(compare){throw $.$$throw($.CTC42);},
 removeRange$2: function(start,rangeLength){throw $.$$throw($.CTC42);},
 insertRange$3: function(start,rangeLength,initialValue){throw $.$$throw($.CTC42);},
...
$$._FrozenElementListIterator = {"":
 ["_lib_list", "_index"],
 "super": "Object",
 next$0: function(){if(this.hasNext$0()!==true)throw $.$$throw($.CTC12);var t1=this._lib_list;var t2=this._index;this._index=t2+1;return t1.operator$index$1(t2);},
 hasNext$0: function(){var t1=this._index;var t2=$.get$length(this._lib_list);if(typeof t2!=='number')return this.hasNext$0$bailout(1,t1,t2);return t1<t2;},
 hasNext$0$bailout: function(state0,t1,t2){return $.lt(t1,t2);}
};
...
$$._JsSerializer = {"":
 ...
 "super": "_Serializer",
 visitSendPortSync$1: function(x){if(!!x.is$_JsSendPortSync)return this.visitJsSendPortSync$1(x);if(!!x.is$_LocalSendPortSync)return this.visitLocalSendPortSync$1(x);if(!!x.is$_RemoteSendPortSync)return this.visitRemoteSendPortSync$1(x);throw $.$$throw('Unknown port type '+$.S(x));},
 visitJsSendPortSync$1: function(x){return ['sendport','nativejs',x._id];},
...
$$._JsSendPortSync = {"":
 ["_id?"],
 "super": "Object",
 callSync$1: function(message){var serialized=$._JsSerializer$().traverse$1(message);var result=$._callPortSync(this._id,serialized);return $._JsDeserializer$().deserialize$1(result);},
...
$$._MutationObserverScheduler = {"":
 ...
 "super": "_MeasurementScheduler",
 _schedule$0: function(){var t1=this._dummy.get$hidden()!==true;this._dummy.set$hidden(t1);},
 ...
 _MutationObserverScheduler$1: function(callback){this._observer=$.MutationObserver_MutationObserver(this.get$_handleMutation());this._dummy=$.DivElement_DivElement();this._observer.observe$3$attributes(this._dummy,$.makeLiteralMap([]),true);}
};
...
$$._Serializer = {"":
 ...
 visitMap$1: function(map){var copyId=this._visited.operator$index$1(map);if(!(copyId==null))return ['ref',copyId];var id=this._nextFreeRefId;this._nextFreeRefId=id+1;this._visited.operator$indexSet$2(map,id);return ['map',id,this._serializeList$1(map.getKeys$0()),this._serializeList$1(map.getValues$0())];},
...
$$._LocationWrapper = {"":
 ...
 assign$1: function(url){return $._LocationWrapper__assign(this._ptr,url);},
 replace$1: function(url){return $._LocationWrapper__replace(this._ptr,url);},
...
$$._VariableSizeListIterator = {"":
 ...
 hasNext$0$bailout: function(state0,t1){return $.gt(t1,this._pos);},
 next$0: function(){if(this.hasNext$0()!==true)throw $.$$throw($.CTC12);var t1=this._array;if(typeof t1!=='string'&&(typeof t1!=='object'||t1===null||t1.constructor!==Array&&!t1.is$JavaScriptIndexingBehavior()))return this.next$0$bailout(1,t1);var t3=this._pos;this._pos=t3+1;if(t3<0||t3>=t1.length)throw $.ioore(t3);return t1[t3];},
...
$$._WorkerSendPort = {"":
 ...
 operator$eq$1: function(other){if(typeof other==='object'&&other!==null&&!!other.is$_WorkerSendPort)var t1=$.eqB(this._workerId,other._workerId)&&$.eqB(this._lib9_isolateId,other._lib9_isolateId)&&$.eqB(this._receivePortId,other._receivePortId);else t1=false;return t1;},
...
$$._PendingSendPortFinder = {"":
 ...
 visitList$1: function(list){if(!($.index(this._lib9_visited,list)==null))return;$.indexSet(this._lib9_visited,list,true);$.forEach(list,new $._PendingSendPortFinder_visitList_anon(this));},
 visitMap$1: function(map){if(!($.index(this._lib9_visited,map)==null))return;$.indexSet(this._lib9_visited,map,true);$.forEach(map.getValues$0(),new $._PendingSendPortFinder_visitMap_anon(this));},
...
$$._JsSerializer0 = {"":
 ...
 visitWorkerSendPort$1: function(port){return ['sendport',port._workerId,port._lib9_isolateId,port._receivePortId];},
...
$$._MessageTraverser0 = {"":
 [],
 "super": "Object",
 traverse$1: function(x){if($._MessageTraverser_isPrimitive0(x))return this.visitPrimitive$1(x);this._lib9_visited.reset$0();var result=null;try{result=this._lib9_dispatch$1(x);}finally{this._lib9_visited.cleanup$0();}return result;},
 _lib9_dispatch$1: function(x){if($._MessageTraverser_isPrimitive0(x))return this.visitPrimitive$1(x);if(typeof x==='object'&&x!==null&&(x.constructor===Array||x.is$List()))return this.visitList$1(x);if(typeof x==='object'&&x!==null&&x.is$Map())return this.visitMap$1(x);if(typeof x==='object'&&x!==null&&!!x.is$SendPort)return this.visitSendPort$1(x);if(typeof x==='object'&&x!==null&&!!x.is$SendPortSync)return this.visitSendPortSync$1(x);return this.visitObject$1(x);},
 visitObject$1: function(x){throw $.$$throw('Message serialization: Illegal value '+$.S(x)+' passed');}
};
...
$$._Copier = {"":
 ...
 "super": "_MessageTraverser0",
 visitPrimitive$1: function(x){return x;},
 visitList$1: function(list){if(typeof list!=='object'||list===null||list.constructor!==Array&&!list.is$JavaScriptIndexingBehavior())return this.visitList$1$bailout(1,list);var copy=$.index(this._lib9_visited,list);if(!(copy==null))return copy;var len=list.length;copy=$.ListImplementation_List(len);$.indexSet(this._lib9_visited,list,copy);for(var i=0;i<len;++i){if(i>=list.length)throw $.ioore(i);copy[i]=this._lib9_dispatch$1(list[i]);}return copy;},
 visitList$1$bailout: function(state0,list){var copy=$.index(this._lib9_visited,list);if(!(copy==null))return copy;var len=$.get$length(list);copy=$.ListImplementation_List(len);$.indexSet(this._lib9_visited,list,copy);for(var i=0;$.ltB(i,len);++i){var t1=this._lib9_dispatch$1($.index(list,i));if(i>=copy.length)throw $.ioore(i);copy[i]=t1;}return copy;},
...
$$._Serializer0 = {"":
 ...
 visitMap$1: function(map){var copyId=$.index(this._lib9_visited,map);if(!(copyId==null))return ['ref',copyId];var id=this._lib9_nextFreeRefId;this._lib9_nextFreeRefId=id+1;$.indexSet(this._lib9_visited,map,id);return ['map',id,this._lib9_serializeList$1(map.getKeys$0()),this._lib9_serializeList$1(map.getValues$0())];},
 _lib9_serializeList$1: function(list){if(typeof list!=='string'&&(typeof list!=='object'||list===null||list.constructor!==Array&&!list.is$JavaScriptIndexingBehavior()))return this._lib9_serializeList$1$bailout(1,list);var len=list.length;var result=$.ListImplementation_List(len);for(var i=0;i<len;++i){if(i>=list.length)throw $.ioore(i);result[i]=this._lib9_dispatch$1(list[i]);}return result;},
 _lib9_serializeList$1$bailout: function(state0,list){var len=$.get$length(list);var result=$.ListImplementation_List(len);for(var i=0;$.ltB(i,len);++i){var t1=this._lib9_dispatch$1($.index(list,i));if(i>=result.length)throw $.ioore(i);result[i]=t1;}return result;}
};

$$._Deserializer0 = {"":
 [],
 "super": "Object",
 deserialize$1: function(x){if($._Deserializer_isPrimitive0(x))return x;this._lib9_deserialized=$.HashMapImplementation$();return this._lib9_deserializeHelper$1(x);},
 _lib9_deserializeHelper$1: function(x){if($._Deserializer_isPrimitive0(x))return x;switch($.index(x,0)){case 'ref':return this._lib9_deserializeRef$1(x);case 'list':return this._lib9_deserializeList$1(x);case 'map':return this._lib9_deserializeMap$1(x);case 'sendport':return this.deserializeSendPort$1(x);default:return this.deserializeObject$1(x);}},
...
$$.Enumerable = {"":
 ...
 firstOrDefault$2: function(f,defaultValue){if(f==null)f=new $.Enumerable_firstOrDefault_anon();var iter=$._WhereIterator$(this.iterator$0(),f);if(iter.hasNext$0()!==true)return defaultValue;return iter.next$0();},
 firstOrDefault$1: function(f) {
  return this.firstOrDefault$2(f,null)
},
 single$1: function(f){if(f==null)f=new $.Enumerable_single_anon();var iter=$._WhereIterator$(this.iterator$0(),f);if(iter.hasNext$0()!==true)throw $.$$throw($.CTC16);var value=iter.next$0();if(iter.hasNext$0()===true)throw $.$$throw($.CTC17);return value;},
...
$$._RangeIterator = {"":
 ...
 "super": "Object",
 hasNext$0: function(){var t1=this._current;var t2=this._count;if(typeof t2!=='number')return this.hasNext$0$bailout(1,t1,t2);return t1<t2;},
 hasNext$0$bailout: function(state0,t1,t2){return $.lt(t1,t2);},
...
$$.IndexIterator = {"":
 ...
 "super": "Object",
 hasNext$0: function(){var t1=this._lib0_length;if(typeof t1!=='number')return this.hasNext$0$bailout(1,t1);return t1>this._lib0_pos;},
 hasNext$0$bailout: function(state0,t1){return $.gt(t1,this._lib0_pos);},
 next$0: function(){if(this.hasNext$0()!==true)throw $.$$throw($.CTC12);var t1=this._lib0_pos;this._lib0_pos=t1+1;return this._indexer$1(t1);},
...
$$.ListBase = {"":
 ...
 addAll$1: function(value){throw $.$$throw($.CTC14);},
 sort$1: function(comparer){throw $.$$throw($.CTC14);},
 clear$0: function(){throw $.$$throw($.CTC14);},
 removeLast$0: function(){throw $.$$throw($.CTC14);},
 removeRange$2: function(start,length$){throw $.$$throw($.CTC14);},
 insertRange$3: function(start,length$,initialValue){throw $.$$throw($.CTC14);},
 is$List: function() { return true; },
 is$Collection: function() { return true; }
};
...
$$.Array2d = {"":
 ...
 getAdjacentIndices$2$bailout: function(state0,x,y){var adj=$.ListImplementation_List(null);for(var k=$.max(0,$.sub(y,1)),t1=this.height,t2=this.width;k<$.min(t1,$.add(y,2));++k)for(var j=$.max(0,$.sub(x,1)),t3=!(k===y);j<$.min(t2,$.add(x,2));++j)if(!(j===x)||t3)adj.push(this._getIndex$2(j,k));return adj;},
...
$$.AttachableObject = {"":
 ...
 _remove$1: function(key){this.validateNotDisposed$0();if(this._isSet$1(key)===true){this._propertyValues.remove$1(key);this._fireChange$1(key);}},
 _getValueOrUndefined$3: function(key,obj,ifAbsent){this.validateNotDisposed$0();if(this._isSet$1(key)===true)return this._propertyValues.operator$index$1(key);else if(!(ifAbsent==null)){var value=ifAbsent.call$1(obj);this._set$2(key,value);return value;}else return $.CTC22;},
...
$$.Property = {"":
 ["defaultValue", "name"],
 "super": "Attachable",
 get$2: function(obj,ifAbsent){var coreValue=this.getCore$2(obj,ifAbsent);if(!$.identical(coreValue,$.CTC22))return coreValue;else return this.defaultValue;},
 get$1: function(obj) {
...
$$._ResourceEntry = {"":
 ...
 updateProgress$2: function(completed,total){if(!$.eqB(this._completed,completed)){this._completed=completed;var changed=true;}else changed=false;if(!$.eqB(this._total,total)){this._total=total;changed=true;}return changed;},
...
$$.ResourceLoader = {"":
 ...
 load$0: function(){this._lib8_state='loading';for(var t1=$.iterator(this._entries);t1.hasNext$0()===true;)this._httpLoad$1(t1.next$0().get$url());},
 ...
 _loadResourceSucceed$2: function(blobUrl,resource){var entry=this._getByBlobUrl$1(blobUrl);entry.revokeBlobUrl$0();entry.setResource$1(resource);if($.every(this._entries,new $.ResourceLoader__loadResourceSucceed_anon())===true){this._lib8_state='loaded';this._loadedEvent.fireEvent$1($.CTC25);}},
 ...
 _httpLoad$1: function(url){var request=$.HttpRequest_HttpRequest();var e=this._getByUrl$1(url);$.add$1(request.get$on().get$abort(),new $.ResourceLoader__httpLoad_anon(this,e));$.add$1(request.get$on().get$error(),new $.ResourceLoader__httpLoad_anon0(this,e));$.add$1(request.get$on().get$loadEnd(),new $.ResourceLoader__httpLoad_anon1(this,e));$.add$1(request.get$on().get$progress(),new $.ResourceLoader__httpLoad_anon2(this,e));request.open$2('GET',url);request.set$responseType('blob');request.send$0();},
 ...
 _onProgress$2: function(entry,args){if(entry.updateProgress$2(args.get$loaded(),args.get$totalSize())===true)this._progressEvent.fireEvent$1($.CTC25);}
};
...
$$.AudioLoader = {"":
 ...
 "super": "ResourceLoader",
 _doLoad$1: function(blobUrl){var arrayBufferRequest=$.HttpRequest_HttpRequest();arrayBufferRequest.open$3('GET',blobUrl,true);arrayBufferRequest.set$responseType('arraybuffer');$.add$1(arrayBufferRequest.get$on().get$load(),new $.AudioLoader__doLoad_anon(arrayBufferRequest,blobUrl,this));$.add$1(arrayBufferRequest.get$on().get$error(),new $.AudioLoader__doLoad_anon0(this,blobUrl));arrayBufferRequest.send$0();},
...
$$.TextureData = {"":
 ["_textures"],
 "super": "Object",
 getTexture$1: function(key){return $.index(this._textures,key);},
 drawTextureKeyAt$3: function(ctx,textureKey,location$){this.drawTextureAt$3(ctx,location$,this.getTexture$1(textureKey));},
 drawTextureKeyAt$2: function(ctx,textureKey) {
  return this.drawTextureKeyAt$3(ctx,textureKey,Isolate.$isolateProperties.CTC57)
},
 drawTextureAt$3: function(ctx,location$,texture){ctx.save$0();var tx=$.AffineTransform$(1,0,0,1,0,0);tx.translate$2(location$.x,location$.y);var theFrame=texture.get$frame();var source=texture.get$sourceColorRect().get$topLeft();tx.translate$2(source.get$x(),source.get$y());if(texture.get$rotated()===true){var t1=theFrame.get$height();if(typeof t1!=='number')throw $.iae(t1);t1=0.5*t1;var t2=theFrame.get$height();if(typeof t2!=='number')throw $.iae(t2);tx.rotate$3(-1.5707963267948966,t1,0.5*t2);var theFrame0=$.Box$(theFrame.get$left(),theFrame.get$top(),theFrame.get$height(),theFrame.get$width());theFrame=theFrame0;}$.CanvasUtil_transform(ctx,tx);$.CanvasUtil_drawImage(ctx,texture.get$image(),theFrame,null);ctx.restore$0();}
};

$$.TextureAnimationElement = {"":
 ["_textureData?", "_requests", "_transforms", "cacheEnabled", "_updatedEventHandle", "_invalidatedEventHandle", "_cacheCanvas", "_width", "_height", "_alpha", "_lastDrawSize", "clip", "_lib2_parent", "_propertyValues", "_eventHandlers", "_disposed"],
 "super": "PElement",
 add$1: function(request){this._requests.push(request);this.invalidateDraw$0();},
 update$0: function(){var toRemove=$.ListImplementation_List(null);for(var t1=this._requests,t2=$.iterator(t1);t2.hasNext$0()===true;){var t3=t2.next$0();t3.update$0();if(t3.get$done()===true)toRemove.push(t3);}for(t2=$.iterator(toRemove);t2.hasNext$0()===true;)$.removeRange(t1,$.indexOf$2(t1,t2.next$0(),0),1);if(t1.length>0)this.invalidateDraw$0();},
 drawOverride$1: function(ctx){for(var t1=$.iterator(this._requests),t2=this._textureData;t1.hasNext$0()===true;){var data=t1.next$0()._getFrameDetails$0();var offset=data.get$item1();var frameName=data.get$item2();ctx.save$0();ctx.translate$2(offset.get$x(),offset.get$y());t2.drawTextureKeyAt$2(ctx,frameName);ctx.restore$0();}}
};
...
$$.TextureAnimationRequest = {"":
 ...
 update$0: function(){var t1=this._frame;if(typeof t1!=='number')return this.update$0$bailout(1,t1);if(t1<this._frameCount-1)this._frame=t1+1;else this._lib7_done=true;t1=this._frame;if(typeof t1!=='number')return this.update$0$bailout(4,t1);if(t1===0&&!this._lib7_done)this._startEventHandle.fireEvent$1($.CTC25);},
 update$0$bailout: function(state0,env0){switch(state0){case 1:t1=env0;break;case 2:t1=env0;break;case 3:t1=env0;break;case 4:t1=env0;break;}switch(state0){case 0:var t1=this._frame;case 1:state0=0;default:if(state0===2||state0===0&&t1==null)switch(state0){case 0:t1=this._delay;case 2:state0=0;this._frame=$.neg(t1);}else switch(state0){case 0:case 3:if(state0===3||state0===0&&$.ltB(t1,this._frameCount-1))switch(state0){case 0:t1=this._frame;case 3:state0=0;this._frame=$.add(t1,1);}else this._lib7_done=true;}t1=this._frame;case 4:state0=0;if($.eqB(t1,0)&&!this._lib7_done)this._startEventHandle.fireEvent$1($.CTC25);}},
 _getFrameDetails$0: function(){var offset=this._offset;var t1=this._frame;if(typeof t1!=='number')return this._getFrameDetails$0$bailout(1,offset,t1);if(t1<0&&!(this._initialFrame==null)){var frameName=this._initialFrame;var offset0=this._initialFrameOffset;if(!(offset0==null))offset=offset0;}else{if(t1<0)var frame=0;else frame=t1;var frameString=$.toString($.toInt(frame));if(typeof frameString!=='string')return this._getFrameDetails$0$bailout(4,frameString,offset);for(;frameString.length<4;)frameString='0'+frameString;frameName=this._texturePrefix+'_'+frameString+'.png';}return $.Tuple$(offset,frameName);},
 _getFrameDetails$0$bailout: function(state0,env0,env1){switch(state0){case 1:offset=env0;t1=env1;break;case 2:t1=env0;offset=env1;break;case 3:t1=env0;offset=env1;break;case 4:frameString=env0;offset=env1;break;}switch(state0){case 0:var offset=this._offset;var t1=this._frame;case 1:state0=0;default:if(state0===0&&$.ltB(t1,0)&&!(this._initialFrame==null)){var frameName=this._initialFrame;var offset0=this._initialFrameOffset;if(!(offset0==null))offset=offset0;}else switch(state0){case 0:t1=this._frame;case 2:state0=0;case 3:if(state0===0&&$.ltB(t1,0))var frame=0;else switch(state0){case 0:t1=this._frame;case 3:state0=0;frame=t1;}var frameString=$.toString($.toInt(frame));case 4:state0=0;for(;$.ltB($.get$length(frameString),4);)frameString='0'+$.S(frameString);frameName=this._texturePrefix+'_'+$.S(frameString)+'.png';}return $.Tuple$(offset,frameName);}},
...
$$.PElement = {"":
 ...
 drawCore$1: function(ctx){if(this.cacheEnabled)this._drawCached$1(ctx);else this._drawNormal$1(ctx);},
 ...
 _drawCached$1: function(ctx){if(this._cacheCanvas==null)this._cacheCanvas=$.CanvasElement_CanvasElement($,$);var t1=this._lastDrawSize;var intLastDrawSize=t1==null?null:$.Size$($.toInt(t1.get$width()),$.toInt(this._lastDrawSize.get$height()));if(!$.eqB($.CanvasUtil_getCanvasSize(this._cacheCanvas),intLastDrawSize)){$.indexSet(this._cacheCanvas.get$attributes(),'width',this.get$width());$.indexSet(this._cacheCanvas.get$attributes(),'height',this.get$height());this._drawInternal$1(this._cacheCanvas.get$context2d());}ctx.save$0();$.CanvasUtil_transform(ctx,this.getTransform$0());ctx.drawImage$3(this._cacheCanvas,0,0);ctx.restore$0();},
 _drawNormal$1: function(ctx){var tx=this.getTransform$0();if(this._isClipped$2(tx,ctx)===true)return;ctx.save$0();$.CanvasUtil_transform(ctx,tx);if(this.clip){ctx.beginPath$0();ctx.rect$4(0,0,this.get$width(),this.get$height());ctx.clip$0();}this._drawInternal$1(ctx);ctx.restore$0();},
 ...
 _isClipped$2: function(tx,ctx){if(this.clip);return false;},
...
$$.Panel = {"":
 ...
 insertAt$2: function(element,index){element.registerParent$1(this);$.insertRange$3(this._children,index,1,element);$.get$Panel__containerTransformProperty().set$2(element,element.addTransform$0());this.onChildrenChanged$0();},
...
$$.Stage = {"":
 ...
 draw$0: function(){this.validateNotDisposed$0();var t1=this._ctx;var t2=t1==null;var t3=this._canvas;if(t2)this._ctx=t3.get$context2d();else t1.clearRect$4(0,0,t3.get$width(),t3.get$height());return this._lib2_element.draw$1(this._ctx);},
 childInvalidated$1: function(child){this.validateNotDisposed$0();this._invalidatedEventHandle.fireEvent$1($.CTC25);},
...
$$.ClickManager = {"":
 ...
 "super": "Object",
 _mouseMove$1: function(e){var items=this._updateMouseLocation$1($.getMouseEventCoordinate(e));if($.gtB($.get$length(items),0))$.forEach(items,new $.ClickManager__mouseMove_anon($.ElementMouseEventArgs_ElementMouseEventArgs($.index(items,0),e)));},
 get$_mouseMove: function() { return new $.BoundClosure(this, '_mouseMove$1'); },
 _mouseOut$1: function(e){this._updateMouseLocation$1(null);$.get$ClickManager__mouseOutEvent().fireEvent$2(this._stage,$.CTC25);},
 get$_mouseOut: function() { return new $.BoundClosure(this, '_mouseOut$1'); },
 _mouseUp$1: function(e){var upElement=$.$$(this._updateMouseLocation$1($.getMouseEventCoordinate(e))).firstOrDefault$1(new $.ClickManager__mouseUp_anon());if(!(upElement==null)){this._doMouseUp$2(upElement,e);if($.eqB(upElement,this._mouseDownElement))this._doClick$2(upElement,e);this._mouseDownElement=null;}},
 get$_mouseUp: function() { return new $.BoundClosure(this, '_mouseUp$1'); },
 _mouseDown$1: function(e){this._mouseDownElement=$.$$(this._updateMouseLocation$1($.getMouseEventCoordinate(e))).firstOrDefault$1(new $.ClickManager__mouseDown_anon());var t1=this._mouseDownElement;if(!(t1==null))this._doMouseDown$2(t1,e);},
...
$$.Field = {"":
 ["bombCount?", "_adjacents", "width", "height", "_source"],
 "super": "Array2d",
 ...
 Field$_internal$3: function(bombCount,cols,source){for(var t1=$.iterator(this),count=0;t1.hasNext$0()===true;)if(t1.next$0()===true)++count;}
};

$$.Game = {"":
 ["field?", "_states", "_updatedEvent", "_gameStateEvent", "_state", "_bombsLeft", "_revealsLeft", "_startTime", "_endTime"],
 "super": "Object",
 ...
 get$gameEnded: function(){return $.eqB(this._state,$.CTC39)||$.eqB(this._state,$.CTC40);},
 ...
 setFlag$3: function(x,y,value){this._ensureStarted$0();var t1=this._states;var currentSS=t1.get$2(x,y);if(value){$.require($.eq(currentSS,$.CTC36),'');t1.set$3(x,y,$.CTC38);this._bombsLeft=$.sub(this._bombsLeft,1);}else{$.require($.eq(currentSS,$.CTC38),'');t1.set$3(x,y,$.CTC36);this._bombsLeft=$.add(this._bombsLeft,1);}this._update$0();},
 canReveal$2: function(x,y){if($.eqB(this._states.get$2(x,y),$.CTC36))return true;else if(this._canChord$2(x,y)===true)return true;return false;},
 reveal$2: function(x,y){this._ensureStarted$0();$.require(this.canReveal$2(x,y),'Item cannot be revealed.');if($.eqB(this._states.get$2(x,y),$.CTC36))if(this.field.get$2(x,y)===true){this._setLost$0();var reveals=[];}else{reveals=this._doReveal$2(x,y);if(typeof reveals!=='object'||reveals===null||reveals.constructor!==Array||!!reveals.fixed$length)return this.reveal$2$bailout(1,reveals);}else reveals=this._canChord$2(x,y)===true?this._doChord$2(x,y):null;this._update$0();if($.eqB(this._state,$.CTC40))return;else return reveals;},
 reveal$2$bailout: function(state0,env0){switch(state0){case 1:reveals=env0;break;}switch(state0){case 0:this._ensureStarted$0();$.require(this.canReveal$2(x,y),'Item cannot be revealed.');case 1:if(state0===1||state0===0&&$.eqB(this._states.get$2(x,y),$.CTC36))switch(state0){case 0:case 1:if(state0===0&&this.field.get$2(x,y)===true){this._setLost$0();var reveals=[];}else switch(state0){case 0:reveals=this._doReveal$2(x,y);case 1:state0=0;}}else reveals=this._canChord$2(x,y)===true?this._doChord$2(x,y):null;this._update$0();if($.eqB(this._state,$.CTC40))return;else return reveals;}},
 _canChord$2: function(x,y){if($.eqB(this._states.get$2(x,y),$.CTC37)){var adjCount=this.field.getAdjacentCount$2(x,y);if($.gtB(adjCount,0))if($.gtB(this._getAdjacentCount$3(x,y,$.CTC36),0))if($.eqB(this._getAdjacentCount$3(x,y,$.CTC38),adjCount))return true;}return false;},
 _doChord$2: function(x,y){var t1=this._states;if(typeof t1!=='string'&&(typeof t1!=='object'||t1===null||t1.constructor!==Array&&!t1.is$JavaScriptIndexingBehavior()))return this._doChord$2$bailout(1,x,y,t1,0,0,0);t1.get$2(x,y);var flagged=$.ListImplementation_List(null);var hidden=$.ListImplementation_List(null);var t3=this.field;if(typeof t3!=='string'&&(typeof t3!=='object'||t3===null||t3.constructor!==Array&&!t3.is$JavaScriptIndexingBehavior()))return this._doChord$2$bailout(2,x,y,t1,t3,flagged,hidden);t3.getAdjacentCount$2(x,y);for(var t2=$.iterator(t3.getAdjacentIndices$2(x,y)),failed=false;t2.hasNext$0()===true;){var t4=t2.next$0();if(t4!==(t4|0))throw $.iae(t4);if(t4<0||t4>=t1.length)throw $.ioore(t4);if($.eqB(t1[t4],$.CTC36)){hidden.push(t4);if(t4>=t3.length)throw $.ioore(t4);if(t3[t4]===true)failed=true;}else{if(t4>=t1.length)throw $.ioore(t4);if($.eqB(t1[t4],$.CTC38))flagged.push(t4);}}var reveals=[];if(failed)this._setLost$0();else for(t1=$.iterator(hidden);t1.hasNext$0()===true;){var c=t3.getCoordinate$1(t1.next$0());if(this.canReveal$2(c.get$item1(),c.get$item2())===true)$.addAll(reveals,this.reveal$2(c.get$item1(),c.get$item2()));}return reveals;},
 _doChord$2$bailout: function(state0,env0,env1,env2,env3,env4,env5){switch(state0){case 1:var x=env0;var y=env1;t1=env2;break;case 2:x=env0;y=env1;t1=env2;t3=env3;flagged=env4;hidden=env5;break;}switch(state0){case 0:var t1=this._states;case 1:state0=0;t1.get$2(x,y);var flagged=$.ListImplementation_List(null);var hidden=$.ListImplementation_List(null);var t3=this.field;case 2:state0=0;t3.getAdjacentCount$2(x,y);for(var t2=$.iterator(t3.getAdjacentIndices$2(x,y)),failed=false;t2.hasNext$0()===true;){var t4=t2.next$0();if($.eqB($.index(t1,t4),$.CTC36)){hidden.push(t4);if($.index(t3,t4)===true)failed=true;}else if($.eqB($.index(t1,t4),$.CTC38))flagged.push(t4);}var reveals=[];if(failed)this._setLost$0();else for(t1=$.iterator(hidden);t1.hasNext$0()===true;){var c=t3.getCoordinate$1(t1.next$0());if(this.canReveal$2(c.get$item1(),c.get$item2())===true)$.addAll(reveals,this.reveal$2(c.get$item1(),c.get$item2()));}return reveals;}},
 _doReveal$2: function(x,y){var t1=this._states;if(typeof t1!=='string'&&(typeof t1!=='object'||t1===null||t1.constructor!==Array&&!t1.is$JavaScriptIndexingBehavior()))return this._doReveal$2$bailout(1,x,y,t1,0,0,0);t1.set$3(x,y,$.CTC37);var t3=this._revealsLeft;if(typeof t3!=='number')return this._doReveal$2$bailout(2,x,y,t1,t3,0,0);this._revealsLeft=t3-1;var reveals=[$.Coordinate$(x,y)];var t2=this._revealsLeft;if(typeof t2!=='number')return this._doReveal$2$bailout(3,x,y,t1,t2,reveals,0);if(t2===0)this._setWon$0();else{t2=this.field;t3=t2.getAdjacentCount$2(x,y);if(typeof t3!=='number')return this._doReveal$2$bailout(4,x,y,t1,t2,t3,reveals);if(t3===0)for(t3=$.iterator(t2.getAdjacentIndices$2(x,y));t3.hasNext$0()===true;){var t4=t3.next$0();if(t4!==(t4|0))throw $.iae(t4);if(t4<0||t4>=t1.length)throw $.ioore(t4);if($.eqB(t1[t4],$.CTC36)){var c=t2.getCoordinate$1(t4);$.addAll(reveals,this._doReveal$2(c.get$item1(),c.get$item2()));}}}return reveals;},
 _doReveal$2$bailout: function(state0,env0,env1,env2,env3,env4,env5){switch(state0){case 1:var x=env0;var y=env1;t1=env2;break;case 2:x=env0;y=env1;t1=env2;t3=env3;break;case 3:x=env0;y=env1;t1=env2;t2=env3;reveals=env4;break;case 4:x=env0;y=env1;t1=env2;t2=env3;t3=env4;reveals=env5;break;}switch(state0){case 0:var t1=this._states;case 1:state0=0;t1.set$3(x,y,$.CTC37);var t3=this._revealsLeft;case 2:state0=0;this._revealsLeft=$.sub(t3,1);var reveals=[$.Coordinate$(x,y)];var t2=this._revealsLeft;case 3:state0=0;case 4:if(state0===0&&$.eqB(t2,0))this._setWon$0();else switch(state0){case 0:t2=this.field;t3=t2.getAdjacentCount$2(x,y);case 4:state0=0;if($.eqB(t3,0))for(t3=$.iterator(t2.getAdjacentIndices$2(x,y));t3.hasNext$0()===true;){var t4=t3.next$0();if($.eqB($.index(t1,t4),$.CTC36)){var c=t2.getCoordinate$1(t4);$.addAll(reveals,this._doReveal$2(c.get$item1(),c.get$item2()));}}}return reveals;}},
 _setWon$0: function(){var t1=this.field;if(typeof t1!=='string'&&(typeof t1!=='object'||t1===null||t1.constructor!==Array&&!t1.is$JavaScriptIndexingBehavior()))return this._setWon$0$bailout(1,t1,0);var t3=this._states;if(typeof t3!=='object'||t3===null||(t3.constructor!==Array||!!t3.immutable$list)&&!t3.is$JavaScriptIndexingBehavior())return this._setWon$0$bailout(2,t1,t3);var t5=t1.length;var t6=t3.length;var i=0;for(;i<t5;++i)if(t1[i]===true){if(i>=t6)throw $.ioore(i);t3[i]=$.CTC52;}this._setState$1($.CTC39);},
 _setWon$0$bailout: function(state0,env0,env1){switch(state0){case 1:t1=env0;break;case 2:t1=env0;t3=env1;break;}switch(state0){case 0:var t1=this.field;case 1:state0=0;var t3=this._states;case 2:state0=0;var i=0;for(;$.ltB(i,$.get$length(t1));++i)if($.index(t1,i)===true)$.indexSet(t3,i,$.CTC52);this._setState$1($.CTC39);}},
 _setLost$0: function(){var t1=this.field;if(typeof t1!=='string'&&(typeof t1!=='object'||t1===null||t1.constructor!==Array&&!t1.is$JavaScriptIndexingBehavior()))return this._setLost$0$bailout(1,t1,0);var t3=this._states;if(typeof t3!=='object'||t3===null||(t3.constructor!==Array||!!t3.immutable$list)&&!t3.is$JavaScriptIndexingBehavior())return this._setLost$0$bailout(2,t1,t3);var t5=t1.length;var t6=t3.length;var i=0;for(;i<t5;++i)if(t1[i]===true){if(i>=t6)throw $.ioore(i);t3[i]=$.CTC48;}this._setState$1($.CTC40);},
 _setLost$0$bailout: function(state0,env0,env1){switch(state0){case 1:t1=env0;break;case 2:t1=env0;t3=env1;break;}switch(state0){case 0:var t1=this.field;case 1:state0=0;var t3=this._states;case 2:state0=0;var i=0;for(;$.ltB(i,$.get$length(t1));++i)if($.index(t1,i)===true)$.indexSet(t3,i,$.CTC48);this._setState$1($.CTC40);}},
 _update$0: function(){return this._updatedEvent.fireEvent$1($.CTC25);},
 _setState$1: function(value){if(!$.eqB(this._state,value)){this._state=value;if($.eqB(this._state,$.CTC47))this._startTime=$.Date_Date$now();else if(this.get$gameEnded()===true)this._endTime=$.Date_Date$now();this._gameStateEvent.fireEvent$1(this._state);}},
 _ensureStarted$0: function(){if($.eqB(this.get$state(),$.CTC34))this._setState$1($.CTC47);},
 ...
 _getAdjacentCount$3$bailout: function(state0,state,t1,t2){var val=0;for(;t1.hasNext$0()===true;)if($.eqB($.index(t2,t1.next$0()),state))++val;return val;},
...
$$.BoardElement = {"":
 ["_lib3_elements", "_transforms", "cacheEnabled", "_updatedEventHandle", "_invalidatedEventHandle", "_cacheCanvas", "_width", "_height", "_alpha", "_lastDrawSize", "clip", "_lib2_parent", "_propertyValues", "_eventHandlers", "_disposed"],
 "super": "ElementParentImpl",
...
$$.GameElement = {"":
 ...
 _startPopAnimation$2: function(start,reveals){if(reveals==null)reveals=$.map($.filter($.map($.NumberEnumerable_NumberEnumerable$fromRange(0,$.get$length(this.get$game().get$field())),new $.GameElement__startPopAnimation_anon(this)),new $.GameElement__startPopAnimation_anon0()),new $.GameElement__startPopAnimation_anon1()).toList$0();var values=$.map($.$$(reveals),new $.GameElement__startPopAnimation_anon2(start)).toList$0();$.sort(values,new $.GameElement__startPopAnimation_anon3());for(var t1=$.iterator(values),t2=this._popAnimationLayer;t1.hasNext$0()===true;){var t3=t1.next$0();var c=$.index(t3,0);var initialOffset=$.index(t3,1);var squareOffset=$.index(t3,2);var delay=$.index(t3,3);var ss=this.get$game().getSquareState$2(c.get$x(),c.get$y());switch(ss){case $.CTC37:case $.CTC36:var frameCount=28;var texturePrefix='balloon_pop';break;case $.CTC48:frameCount=24;texturePrefix='balloon_explode';break;default:throw $.$$throw('not supported');}var request=$.TextureAnimationRequest$(texturePrefix,frameCount,squareOffset,delay,'balloon.png',initialOffset,0);switch(ss){case $.CTC37:case $.CTC36:$.add$1(request.get$started(),new $.GameElement__startPopAnimation_anon4());break;case $.CTC48:$.add$1(request.get$started(),new $.GameElement__startPopAnimation_anon5());break;}t2.add$1(request);}},
 _startPopAnimation$1: function(start) {
  return this._startPopAnimation$2(start,null)
},
 _startDartAnimation$1: function(points){$.get$GameAudio__audioEventHandle().fireEvent$1('throw');for(var t1=$.iterator(points),t2=this._dartAnimationLayer;t1.hasNext$0()===true;){var t3=t1.next$0();var t4=t3.get$x();if(typeof t4!=='number')throw $.iae(t4);t4=80*t4;t3=t3.get$y();if(typeof t3!=='number')throw $.iae(t3);var squareOffset=$.CTC53.operator$add$1($.Vector$(t4,80*t3));t2.add$1($.TextureAnimationRequest$('dart_fly_shadow',54,squareOffset,0,null,null,0));t2.add$1($.TextureAnimationRequest$('dart_fly',54,squareOffset,0,null,null,0));}},
 ...
 _squareClicked$1: function(args){if(this._lib3_game.get$gameEnded()!==true&&this._lastHoldUnfreeze==null){var se=args.get$element();this._click$3(se.get$x(),se.get$y(),args.get$shiftKey());}},
 ...
 _mouseDownTimeoutHandle$0: function(){this._click$3(this._lib3_mouseDownElement.get$x(),this._lib3_mouseDownElement.get$y(),true);this._lastHoldUnfreeze=this._lib3_mouseDownElement;this._clearTimeout$0();},
 ...
 _toggleFlag$2: function(x,y){var ss=this.get$game().getSquareState$2(x,y);if($.eqB(ss,$.CTC36)){this.get$game().setFlag$3(x,y,true);$.get$GameAudio__audioEventHandle().fireEvent$1('flag');return true;}else if($.eqB(ss,$.CTC38)){this.get$game().setFlag$3(x,y,false);$.get$GameAudio__audioEventHandle().fireEvent$1('unflag');return true;}return false;},
 _click$3: function(x,y,alt){var ss=this.get$game().getSquareState$2(x,y);var t1=alt===true;if(t1)if($.eqB(ss,$.CTC36)||$.eqB(ss,$.CTC38)){this._toggleFlag$2(x,y);var reveals=null;}else if($.eqB(ss,$.CTC37))if(this.get$game().canReveal$2(x,y)===true){this._startDartAnimation$1($.filter($.map($.$$(this.get$game().get$field().getAdjacentIndices$2(x,y)),new $.GameElement__click_anon(this)),new $.GameElement__click_anon0(this)).toList$0());reveals=this.get$game().reveal$2(x,y);}else reveals=null;else reveals=null;else if($.eqB(ss,$.CTC36)){this._startDartAnimation$1([$.Coordinate$(x,y)]);reveals=this.get$game().reveal$2(x,y);}else reveals=null;if(!(reveals==null)&&$.gtB($.get$length(reveals),0)){if(!t1)$.index(reveals,0);this._startPopAnimation$2($.Coordinate$(x,y),reveals);}else if($.eqB(this.get$game().get$state(),$.CTC40))this._startPopAnimation$1($.Coordinate$(x,y));},
 _updateSize$2: function(w,h){var t1=$.CTC31.width;var sizeX=$.GameElement__getScale(w,t1,1344);var sizeY=$.GameElement__getScale(h,$.CTC31.height,1344);var t2=$.Size$(sizeX,sizeY);this.set$size(t2);this._lib3_canvas.set$size(t2);this._scale=$.div(sizeX,t1);this._scaledBoardOffset=$.CTC32.scale$1(this._scale);t2=this._scale;if(typeof t2!=='number')throw $.iae(t2);this._scaledInnerBox=$.Box$(256*t2,0,$.sub(sizeX,512*t2),sizeY);},
 GameElement$1: function(textureData){var t1=this._lib3_canvas;t1.registerParent$1(this);t1.addElement$1(this._background);t1.addElement$1(this._boardElement);var t2=this._newGameElement;t1.addElement$1(t2);t1.addElement$1(this._scoreElement);t1.addElement$1(this._popAnimationLayer);var t3=this._titleElement;t1.addElement$1(t3);t1.addElement$1(this._dartAnimationLayer);$.add$1(t2.get$clicked(),new $.anon4());$.ClickManager_setClickable(t3,true);$.ClickManager_addHandler(t3,new $.anon5());}
};

$$.GameRoot = {"":
 ["_lib3_stage", "_lib3_canvas?", "_gameElement", "_clickMan", "_gameElementTx", "_frameRequested", "_lib5_width", "_lib5_height", "_bombCount", "_gameStorage", "_game", "_updatedEventId", "_gameStateChangedId", "_setIntervalId"],
 "super": "GameManager",
 ...
 onGameStateChanged$1: function(newState){switch(newState){case $.CTC39:$.get$GameAudio__audioEventHandle().fireEvent$1('win');break;}$.trackAnalyticsEvent('game',newState.name,$.toString(this.get$game().get$field()),null);},
 ...
 _onFrame$1: function(time){var t1=this._gameElement;var boardInnerBox=t1._scaledInnerBox;var t2=this._lib3_stage;var prettyScale=$.min(1,$.min($.div(t2.get$size().get$width(),boardInnerBox.get$width()),$.div(t2.get$size().get$height(),boardInnerBox.get$height())));var newDimensions=$.mul(t1.get$size(),prettyScale);var delta=$.Vector$($.sub(t2.get$size().get$width(),newDimensions.get$width()),$.sub(t2.get$size().get$height(),newDimensions.get$height())).scale$1(0.5).scale$1(1/prettyScale);var t3=this._gameElementTx;t3.setToScale$2(prettyScale,prettyScale);t3.translate$2(delta.get$x(),delta.get$y());var updated=t2.draw$0();this._frameRequested=false;if(updated===true)this._requestFrame$0();},
 ...
 _mouseMoveHandler$1: function(args){if(this.get$game().get$gameEnded()!==true){var t1=args.get$element();t1=typeof t1==='object'&&t1!==null&&!!t1.is$SquareElement;}else t1=false;if(t1){var se=args.get$element();var showPointer=this.get$game().canReveal$2(se.get$x(),se.get$y());}else{t1=args.get$element();if(typeof t1==='object'&&t1!==null&&!!t1.is$NewGameElement)showPointer=true;else{t1=args.get$element();showPointer=typeof t1==='object'&&t1!==null&&!!t1.is$GameTitleElement&&true;}}this._updateCursor$1(showPointer);},
...
$$.NewGameElement = {"":
 ...
 drawOverride$1: function(ctx){var texture=$.Mouse_isMouseDirectlyOver(this)===true?'button_new_game_clicked.png':'button_new_game.png';this.get$_lib3_textureData().drawTextureKeyAt$2(ctx,texture);},
 get$_lib3_parent: function(){return $.propertyTypeCast(this.get$parent(),'is$PCanvas').get$parent();},
 get$_lib3_textureData: function(){return this.get$_lib3_parent().get$_lib3_textureData();},
 get$_lib3_game: function(){return this.get$_lib3_parent().get$_lib3_game();},
...
$$.ScoreElement = {"":
 ["_gameManager", "_clockStr", "_bombsStr", "_bestTimeStr", "_textSize", "_transforms", "cacheEnabled", "_updatedEventHandle", "_invalidatedEventHandle", "_cacheCanvas", "_width", "_height", "_alpha", "_lastDrawSize", "clip", "_lib2_parent", "_propertyValues", "_eventHandlers", "_disposed"],
 "super": "PElement",
 setGameManager$1: function(manager){this._gameManager=manager;this.invalidateDraw$0();},
 update$0: function(){var newBombStr=$.toString(this.get$_lib3_game().get$bombsLeft());if(!$.eqB(newBombStr,this._bombsStr)){this._bombsStr=newBombStr;this.invalidateDraw$0();}var newClockStr=!(this.get$_lib3_game().get$duration()==null)?$.ScoreElement_toRecordString(this.get$_lib3_game().get$duration().get$inMilliseconds()):'';if(!$.eqB(newClockStr,this._clockStr)){this._clockStr=newClockStr;this.invalidateDraw$0();}var bestTimeStr=!(this._gameManager.get$bestTimeMilliseconds()==null)?$.ScoreElement_toRecordString(this._gameManager.get$bestTimeMilliseconds()):null;if(!$.eqB(this._bestTimeStr,bestTimeStr)){this._bestTimeStr=bestTimeStr;this.invalidateDraw$0();}$.PElement.prototype.update$0.call(this);},
...
$$.SquareElement = {"":
 ...
 drawOverride$1: function(ctx){var textureName=null;switch(this._lastDrawingState){case $.CTC36:textureName=this._getHiddenTexture$0();break;case $.CTC38:textureName='balloon_tagged_frozen.png';break;case $.CTC37:var t1=this.get$_adjacentCount();if(t1!==(t1|0))throw $.iae(t1);if(t1<0||t1>=9)throw $.ioore(t1);textureName=$.S($.CTC54[t1])+'.png';break;case $.CTC48:textureName='crater_b.png';break;case $.CTC52:textureName='balloon_tagged_bomb.png';break;}this.get$_lib3_textureData().drawTextureKeyAt$2(ctx,textureName);},
 toString$0: function(){return 'Square at ['+$.S(this.x)+', '+$.S(this.y)+']';},
 _getHiddenTexture$0: function(){if($.eqB(this.get$_lib3_game().get$state(),$.CTC40)){var index=$.mod($.add(this.x,this.y),4);if(index!==(index|0))throw $.iae(index);if(index<0||index>=4)throw $.ioore(index);return $.CTC55[index];}else return 'balloon.png';},
...
$$.GameStorage = {"":
 ...
 updateBestTime$1: function(game){var w=game.get$field().get$width();var h=game.get$field().get$height();var m=game.get$field().get$bombCount();var duration=game.get$duration().get$inMilliseconds();var key='w'+$.S(w)+'-h'+$.S(h)+'-m'+$.S(m);var currentScore=this._getIntValue$2(key,null);if(currentScore==null||$.gtB(currentScore,duration)){this._setIntValue$2(key,duration);this._bestTimeUpdated.fireEvent$1(null);return true;}else return false;},
...
$$.GameManager = {"":
 ...
 newGame$0: function(){if(!(this._updatedEventId==null)){this._game.get$updated().remove$1(this._updatedEventId);this._game.get$stateChanged().remove$1(this._gameStateChangedId);this._gameStateChanged$1($.CTC34);}this._game=$.Game$($.Field_Field(this._bombCount,this._lib5_width,this._lib5_height,null));this._updatedEventId=$.add$1(this._game.get$updated(),this.get$gameUpdated());this._gameStateChangedId=$.add$1(this._game.get$stateChanged(),this.get$_gameStateChanged());},
 gameUpdated$1: function(args){},
 get$gameUpdated: function() { return new $.BoundClosure(this, 'gameUpdated$1'); },
 _lib5_click$3: function(x,y,alt){var ss=this._game.getSquareState$2(x,y);if(alt===true){if($.eqB(ss,$.CTC36))this._game.setFlag$3(x,y,true);else if($.eqB(ss,$.CTC38))this._game.setFlag$3(x,y,false);else if($.eqB(ss,$.CTC37))this._game.reveal$2(x,y);}else if($.eqB(ss,$.CTC36))this._game.reveal$2(x,y);},
 updateClock$0: function(){if(this._setIntervalId==null&&$.eqB(this._game.get$state(),$.CTC47))this._setIntervalId=$.window().setInterval$2(this.get$_doClock(),1000);else if(!(this._setIntervalId==null)&&!$.eqB(this._game.get$state(),$.CTC47)){$.window().clearInterval$1(this._setIntervalId);this._setIntervalId=null;}},
 ...
 _gameStateChanged$1: function(newState){var t1=this._gameStorage;t1.recordState$1(newState);if($.eqB(newState,$.CTC39))if(t1.updateBestTime$1(this._game)===true)this.onNewBestTime$1(this.get$bestTimeMilliseconds());this.updateClock$0();this.onGameStateChanged$1(newState);},
...
$$.Callback = {"":
 ...
 _initialize$1: function(manualDispose){this._manualDispose=manualDispose;this._lib6_id=$.add$1($._proxiedFunctionTable(),this._lib6_callback);$._proxiedFunctionTable().globalize$1(this._lib6_id);$._deserializedFunctionTable().add$2(this._lib6_callback,this.get$_serialized());},
 Callback$many$1: function(f){this._lib6_callback=f;this._initialize$1(true);},
 is$Callback: true
};
...
$$.Proxy = {"":
 ["_port", "_lib6_id?"],
 "super": "Object",
 operator$index$1: function(arg){return this.noSuchMethod$2('[]',[arg]);},
 operator$eq$1: function(other){if(this===other)var t1=true;else t1=typeof other==='object'&&other!==null&&!!other.is$Proxy&&$._jsPortEquals.callSync$1([$._serialize(this),$._serialize(other)])===true;return t1;},
 noSuchMethod$2: function(method,args){if($.eqB($._depth(),0))throw $.$$throw('Cannot access a JavaScript proxy out of scope.');var result=this._port.callSync$1([this._lib6_id,method,$.map(args,$._serialize)]);switch($.index(result,0)){case 'return':return $._deserialize($.index(result,1));case 'throws':throw $.$$throw($._deserialize($.index(result,1)));case 'none':throw $.$$throw($.NoSuchMethodError$(this,method,args,null));default:throw $.$$throw('Invalid return value');}},
 is$Proxy: true
};
...
$$._ProxiedReferenceTable = {"":
 ...
 exitScope$0: function(){var t1=this._scopeIndices;if(0>=t1.length)throw $.ioore(0);var start=t1.pop();if(start!==(start|0))return this.exitScope$0$bailout(1,start);for(var t1=this._handleStack,t2=this._globalIds,t3=this._registry,i=start;t4=t1.length,i<t4;++i){if(i<0)throw $.ioore(i);if($.contains$1(t2,t1[i])!==true){if(i>=t1.length)throw $.ioore(i);t3.remove$1(t1[i]);this._deletedCount=this._deletedCount+1;}}$.removeRange(t1,start,t4-start);var t4;},
 exitScope$0$bailout: function(state0,start){for(var t1=this._handleStack,t2=this._globalIds,t3=this._registry,i=start;$.ltB(i,t1.length);i=$.add(i,1)){if(i!==(i|0))throw $.iae(i);if(i<0||i>=t1.length)throw $.ioore(i);if($.contains$1(t2,t1[i])!==true){if(i>=t1.length)throw $.ioore(i);t3.remove$1(t1[i]);this._deletedCount=this._deletedCount+1;}}t2=t1.length;if(typeof start!=='number')throw $.iae(start);$.removeRange(t1,start,t2-start);},
 globalize$1: function(id){return $.add$1(this._globalIds,id);},
...
$$._DeserializedFunctionTable = {"":
 ["data"],
 "super": "Object",
 find$1: function(f){for(var t1=$.iterator(this.data);t1.hasNext$0()===true;){var t2=t1.next$0();if($.eqB(f,$.index(t2,0)))return $.index(t2,1);}return;},
 remove$1: function(f){this.data=$.filter(this.data,new $._DeserializedFunctionTable_remove_anon(f));},
 add$2: function(f,x){$.add$1(this.data,[f,x]);},
...
$$._runppw_anon0 = {"":
 [],
 "super": "Closure",
 call$1: function(args){return $._processUrlHash();}
};

$$._runppw_anon1 = {"":
 [],
 "super": "Closure",
 call$1: function(args){return $._toggleAbout(true);}
};

$$._getTextures_anon = {"":
 ["frames_1", "transparentElement_0"],
 "super": "Closure",
 call$2: function(key,value){var parsed=$.TextureInput_TextureInput$fromHash(key,value,this.transparentElement_0);$.indexSet(this.frames_1,key,parsed);}
};

$$._getTextures_anon0 = {"":
 ["frames_3", "opaqueElement_2"],
 "super": "Closure",
 call$2: function(key,value){var parsed=$.TextureInput_TextureInput$fromHash(key,value,this.opaqueElement_2);$.indexSet(this.frames_3,key,parsed);}
};

$$._getTextures_anon1 = {"":
 ["frames_5", "transparentStaticElement_4"],
 "super": "Closure",
...
$$.anon = {"":
 ["this_0"],
 "super": "Closure",
 call$1: function(args){return this.this_0.newGame$0();}
};
...
$$._MutationObserverImpl_observe_anon = {"":
 ["parsedOptions_0"],
 "super": "Closure",
 call$2: function(k,v){if($.CTC26.containsKey$1(k)===true)this.parsedOptions_0[k] = true===v;else if($.eqB(k,'attributeFilter'))this.parsedOptions_0[k] = v;else throw $.$$throw($.ArgumentError$('Illegal MutationObserver.observe option \''+$.S(k)+'\''));}
};
...
$$.anon2 = {"":
 ["this_0"],
 "super": "Closure",
 call$1: function(msg){try{var id=$.index(msg,0);var args=$.map($.index(msg,1),$._deserialize);var f=$.index(this.this_0.get$_registry(),id);var result=null;switch($.get$length(args)){case 0:result=$._serialize(f.call$0());break;case 1:result=$._serialize(f.call$1($.index(args,0)));break;case 2:result=$._serialize(f.call$2($.index(args,0),$.index(args,1)));break;case 3:result=$._serialize(f.call$3($.index(args,0),$.index(args,1),$.index(args,2)));break;case 4:result=$._serialize(f.call$4($.index(args,0),$.index(args,1),$.index(args,2),$.index(args,3)));break;default:throw $.$$throw('Unsupported number of arguments.');}return ['return',result];}catch(exception){var t1=$.unwrapException(exception);var e=t1;return ['throws',$.S(e)];}}
};

$$._deserialize_deserializeFunction = {"":
 [],
 "super": "Closure",
 call$1: function(message){var id=$.index(message,1);var port=$.index(message,2);if($.eqB(port,$._proxiedFunctionTable().get$sendPort()))return $._proxiedFunctionTable().get$1(id);else{var f=new $._deserialize_deserializeFunction_anon(port,id);$._deserializedFunctionTable().add$2(f,message);return f;}}
};

$$._deserialize_deserializeFunction_anon = {"":
 ["port_1", "id_0"],
 "super": "Closure",
 call$4: function(arg0,arg1,arg2,arg3){var t1=$===arg0;if(t1)arg0=null;t1=!t1;var t2=$===arg1;if(t2)arg1=null;t2=!t2;var t3=$===arg2;if(t3)arg2=null;t3=!t3;var t4=$===arg3;if(t4)arg3=null;if(!t4)var args=[arg0,arg1,arg2,arg3];else if(t3)args=[arg0,arg1,arg2];else if(t2)args=[arg0,arg1];else args=t1?[arg0]:[];var message=[this.id_0,$.map(args,$._serialize)];var result=this.port_1.callSync$1(message);if($.eqB($.index(result,0),'throws'))throw $.$$throw($.index(result,1));return $._deserialize($.index(result,1));},
 call$0: function() {
  return this.call$4($,$,$,$)
},
...
$$._deserialize_deserializeObject = {"":
 [],
 "super": "Closure",
 call$1: function(message){var id=$.index(message,1);var port=$.index(message,2);if($.eqB(port,$._proxiedObjectTable().get$sendPort()))return $._proxiedObjectTable().get$1(id);else return $.Proxy$_internal(port,id);}
};

$$._DeserializedFunctionTable_remove_anon = {"":
 ["f_0"],
 "super": "Closure",
 call$1: function(item){return !$.eqB($.index(item,0),this.f_0);}
};
...
$$.anon5 = {"":
 [],
 "super": "Closure",
 call$1: function(args){return $.get$_titleClickedEventHandle().fireEvent$1($.CTC25);}
};

$$.anon3 = {"":
 ["this_0"],
 "super": "Closure",
 call$1: function(args){return this.this_0.get$_clickedEvent().fireEvent$1($.CTC25);}
};
...
$$.GameElement__click_anon0 = {"":
 ["this_1"],
 "super": "Closure",
 call$1: function(t){return $.eq(this.this_1.get$game().getSquareState$2(t.get$x(),t.get$y()),$.CTC36);}
};
...
$$.GameElement__startPopAnimation_anon0 = {"":
 [],
 "super": "Closure",
 call$1: function(t2){return $.eqB(t2.get$item2(),$.CTC48)||$.eqB(t2.get$item2(),$.CTC36);}
};
...
$$.GameElement__startPopAnimation_anon2 = {"":
 ["start_1"],
 "super": "Closure",
 call$1: function(c){var t1=c.get$x();if(typeof t1!=='number')throw $.iae(t1);t1=80*t1;var t2=c.get$y();if(typeof t2!=='number')throw $.iae(t2);var initialOffset=$.Vector$(t1,80*t2);var squareOffset=$.CTC51.operator$add$1(initialOffset);t1=$.toInt($.mul($.get$length($.sub(c,this.start_1)),4));if(typeof t1!=='number')throw $.iae(t1);var delay=12+t1;t1=$.rnd().nextInt$1(10);if(typeof t1!=='number')throw $.iae(t1);return [c,initialOffset,squareOffset,delay+t1];}
};
...
$$.ResourceLoader__httpLoad_anon = {"":
 ["this_1", "e_0"],
 "super": "Closure",
 call$1: function(args){return this.this_1._onError$2(this.e_0,args);}
};

$$.ResourceLoader__httpLoad_anon0 = {"":
 ["this_3", "e_2"],
 "super": "Closure",
 call$1: function(args){return this.this_3._onError$2(this.e_2,args);}
};

$$.ResourceLoader__httpLoad_anon1 = {"":
 ["this_5", "e_4"],
 "super": "Closure",
 call$1: function(args){return this.this_5._onLoadEnd$2(this.e_4,args);}
};

$$.ResourceLoader__httpLoad_anon2 = {"":
 ["this_7", "e_6"],
 "super": "Closure",
 call$1: function(args){return this.this_7._onProgress$2(this.e_6,args);}
};

$$.ImageLoader__doLoad_anon = {"":
 ["this_2", "img_1", "blobUrl_0"],
 "super": "Closure",
 call$1: function(args){this.this_2._loadResourceSucceed$2(this.blobUrl_0,this.img_1);}
};
...
$$.AudioLoader__doLoad_anon = {"":
 ...
 "super": "Closure",
 call$1: function(args){var t1=this.this_0;var t2=t1.get$context();var t3=this.arrayBufferRequest_2.get$response();var t4=this.blobUrl_1;t2.decodeAudioData$3(t3,new $.AudioLoader__doLoad_anon1(t1,t4),new $.AudioLoader__doLoad_anon2(t1,t4));}
};
...
$$._NativeJsSendPort_send_anon = {"":
 ...
 "super": "Closure",
 call$0: function(){var t1={};var t2=this.this_5;var t3=this.replyTo_3;t2._checkReplyTo$1(t3);var isolate=$.index($._globalState().get$isolates(),t2.get$_lib9_isolateId());if(isolate==null)return;if(t2.get$_lib9_receivePort().get$_lib9_callback()==null)return;var shouldSerialize=!($._globalState().get$currentContext()==null)&&!$.eqB($._globalState().get$currentContext().get$id(),t2.get$_lib9_isolateId());var msg=this.message_4;t1.msg_1=msg;t1.reply_2=t3;if(shouldSerialize){t1.msg_1=$._serializeMessage(t1.msg_1);t1.reply_2=$._serializeMessage(t1.reply_2);}$._globalState().get$topEventLoop().enqueue$3(isolate,new $._NativeJsSendPort_send_anon0(t2,t1,shouldSerialize),'receive '+$.S(msg));}
};

$$._NativeJsSendPort_send_anon0 = {"":
 ["this_7", "box_0", "shouldSerialize_6"],
 "super": "Closure",
 call$0: function(){var t1=this.this_7;if(!(t1.get$_lib9_receivePort().get$_lib9_callback()==null)){if(this.shouldSerialize_6===true){var t2=this.box_0;t2.msg_1=$._deserializeMessage(t2.msg_1);t2.reply_2=$._deserializeMessage(t2.reply_2);}t1=t1.get$_lib9_receivePort();t2=this.box_0;t1._lib9_callback$2(t2.msg_1,t2.reply_2);}}
};
...
$._ProxiedObjectTable$ = function(){var t1=$.makeLiteralMap([]);var t2=$.ReceivePortSync$();var t3=$.ListImplementation_List(null);var t4=$.ListImplementation_List(null);t4=new $._ProxiedObjectTable('dart-ref',0,0,t1,t2,$.Set_Set(),t3,t4);t4._ProxiedObjectTable$0();return t4;};
...
$.Callback$many = function(f){var t1=new $.Callback(null,null,null);t1.Callback$many$1(f);return t1;};
...
$._Audio__getAudioPath = function(name$){return 'audio/'+$.S(name$)+'.webm';};
...
$._ProxiedFunctionTable$ = function(){var t1=$.makeLiteralMap([]);var t2=$.ReceivePortSync$();var t3=$.ListImplementation_List(null);var t4=$.ListImplementation_List(null);t4=new $._ProxiedFunctionTable('func-ref',0,0,t1,t2,$.Set_Set(),t3,t4);t4._ProxiedFunctionTable$0();return t4;};

$._serialize = function(message){if(message==null)return;else if(typeof message==='string'||typeof message==='number'||typeof message==='boolean')return message;else if(typeof message==='object'&&message!==null&&!!message.is$SendPortSync)return message;else if(typeof message==='object'&&message!==null&&message.is$Element())return ['domref',$._serializeElement(message)];else if(typeof message==='object'&&message!==null&&!!message.is$Callback)return message.get$_serialized();else if(typeof message==='function'||typeof message==='object'&&message!==null&&!!message.is$Function){var serialized=$._deserializedFunctionTable().find$1(message);if(!(serialized==null))return serialized;else throw $.$$throw('A function must be converted to a Callback before it can be serialized.');}else if(typeof message==='object'&&message!==null&&!!message.is$Proxy)return ['objref',message._lib6_id,message._port];else return ['objref',$.add$1($._proxiedObjectTable(),message),$._proxiedObjectTable().get$sendPort()];};
...
$.Field$_internal = function(bombCount,cols,source){var t1=$.Array2d_Array2d(cols,$.tdiv($.get$length(source),cols),null);var t2=cols>0&&true?$.tdiv($.get$length(source),cols):0;t2=new $.Field(bombCount,t1,cols,t2,source);t2.Array2d$wrap$2(cols,source);t2.Field$_internal$3(bombCount,cols,source);return t2;};
...
$._LocalWindowImpl__isDartLocation = function(thing){try{var t1=thing;return typeof t1==='object'&&t1!==null&&t1.is$Location();}catch(exception){$.unwrapException(exception);return false;}};
...
$.Game$ = function(field){var t1=$.EventHandle$();var t2=$.EventHandle$();t2=new $.Game(field,$.Array2d_Array2d(field.get$width(),field.get$height(),$.CTC36),t1,t2,$.CTC34,null,null,null,null);t2.Game$1(field);return t2;};
...
$.GameRoot$_internal = function(width,height,bombCount,_canvas,_stage,gameElement,_clickMan){var t1=new $.GameRoot(_stage,_canvas,gameElement,_clickMan,gameElement.addTransform$0(),false,width,height,bombCount,$.GameStorage$(),null,null,null,null);t1.GameManager$3(width,height,bombCount);t1.GameRoot$_internal$7(width,height,bombCount,_canvas,_stage,gameElement,_clickMan);return t1;};

$._MessagePortEventsImpl$ = function(_ptr){return new $._MessagePortEventsImpl(_ptr);};

$.stringReplaceAllUnchecked = function(receiver,from,to){if(from==='')if(receiver==='')return to;else{var result=$.StringBuffer_StringBuffer('');var length$=receiver.length;$.add$1(result,to);for(var i=0;i<length$;++i){$.add$1(result,receiver[i]);$.add$1(result,to);}return $.toString(result);}else return $.stringReplaceJS(receiver,$.regExpMakeNative($.JSSyntaxRegExp$(from.replace($.regExpMakeNative($.CTC19,true), "\\$&"),false,false),true),to);};
...
$._toggleAbout = function(value){var loc=$.window().get$location();var hash=$.eqB($.get$length(loc.get$hash()),0)?'#':loc.get$hash();var isOpen=$.eqB(hash,'#about');if(value==null)value=!isOpen;var targetHash=value===true?'#about':'#';if(!(targetHash===hash))loc.assign$1(targetHash);};
...
$.Proxy__convert = function(data){if(typeof data==='object'&&data!==null&&data.is$Map()){var result=$._deserialize($._jsPortSync.callSync$1($._serialize('new Object()')));for(var t1=$.iterator(data.getKeys$0());t1.hasNext$0()===true;){var t2=t1.next$0();var value=$.Proxy__convert(data.operator$index$1(t2));result.noSuchMethod$2('set:'+$.S(t2),[value]);}return result;}else if(typeof data==='object'&&data!==null&&(data.constructor===Array||data.is$List())){if(typeof data!=='object'||data===null||data.constructor!==Array&&!data.is$JavaScriptIndexingBehavior())return $.Proxy__convert$bailout(1,data);result=$._deserialize($._jsPortSync.callSync$1($._serialize('new Array()')));for(var i=0;i<data.length;++i){value=$.Proxy__convert(data[i]);result.noSuchMethod$2('set:'+$.S(i),[value]);}return result;}return data;};

$._currentIsolate = function(){return $._globalState().get$currentContext();};

$._completeMeasurementFutures = function(){var t1=$._pendingRequests;if(!(t1==null))for(t1=$.iterator(t1);t1.hasNext$0()===true;){var request=t1.next$0();try{var t2=request.computeValue$0();request.set$value(t2);}catch(exception){t2=$.unwrapException(exception);var e=t2;t2=e;request.set$value(t2);request.set$exception(true);}}var completedRequests=$._pendingRequests;var readyMeasurementFrameCallbacks=$._pendingMeasurementFrameCallbacks;$._pendingRequests=null;$._pendingMeasurementFrameCallbacks=null;if(!(completedRequests==null))for(t1=$.iterator(completedRequests);t1.hasNext$0()===true;){t2=t1.next$0();var t3=t2.get$exception()===true;var t4=t2.get$completer();if(t3)t4.completeException$1(t2.get$value());else t4.complete$1(t2.get$value());}if(!(readyMeasurementFrameCallbacks==null))for(t1=$.iterator(readyMeasurementFrameCallbacks);t1.hasNext$0()===true;)t1.next$0().call$0();};
...
$.PCanvas$ = function(w,h,enableCache){return new $.PCanvas($.ListImplementation_List(null),null,$.ListImplementation_List(null),enableCache,$.EventHandle$(),$.EventHandle$(),null,w,h,null,null,false,null,$.HashMapImplementation$(),$.HashMapImplementation$(),false);};
...
$._LocationWrapper__assign = function(p,url){p.assign(url);};
...
$.TextureInput__parseCoordinate = function(input){return $.Size$($.index(input,'w'),$.index(input,'h'));};
...
$._onPopupClick = function(args){var t1=args.get$toElement();if(!(typeof t1==='object'&&t1!==null&&t1.is$AnchorElement()))$._toggleAbout(false);};
...
$._Audio__Audio = function(){if($._Audio__supportsAudio()===true)return $._Audio$_internal($.AudioLoader$($.AudioContext_AudioContext(),$._Audio__getAudioPaths($.CTC)));else return $._Audio$_disabled();};
...
$.Random_Random = function(seed){return $.CTC15;};
...
$._onKeyDown = function(args){switch(args.get$keyCode()){case 27:$._toggleAbout(false);break;case 72:$._toggleAbout(null);break;}};
...
$._onLoaded = function(args){if($.eqB($._imageLoader.get$state(),'loaded')&&$._audio.get$done()===true){var opaqueImage=$._imageLoader.getResource$1('images/dart_opaque_01.jpg');var textureData=$.TextureData$($._getTextures($._imageLoader.getResource$1('images/transparent_animated.png'),opaqueImage,$.ImageElement_ImageElement('images/transparent_static.png',$,$)));$.query('#loading').get$style().set$display('none');$._runppw(textureData);}};
...
$._deserializeMessage = function(message){if($._globalState().get$needSerialization()===true)return $._JsDeserializer$0().deserialize$1(message);else return message;};
...
$._Audio__supportsAudio = function(){try{var isChrome=$.contains$1($.window().get$clientInformation().get$userAgent(),'Chrome');return isChrome;}catch(exception){$.unwrapException(exception);return false;}};
...
$._LocationWrapper__replace = function(p,url){p.replace(url);};
...
$.SquareElement$ = function(x,y){var t1=new $.SquareElement(x,y,null,$.ListImplementation_List(null),false,$.EventHandle$(),$.EventHandle$(),null,80,80,null,null,false,null,$.HashMapImplementation$(),$.HashMapImplementation$(),false);t1.SquareElement$2(x,y);return t1;};
...
$.proxyDebug = function(message){$.print('Proxy status '+$.S(message)+':');var live=$.add($._proxiedObjectTable().get$count(),$._proxiedFunctionTable().get$count());var total=$.add($._proxiedObjectTable().get$total(),$._proxiedFunctionTable().get$total());$.print('  Dart objects Live : '+$.S(live)+' (out of '+$.S(total)+' ever allocated).');$.print('  '+$.S($._jsPortDebug.callSync$1([])));};
...
$._js = function(message){return $._deserialize($._jsPortSync.callSync$1($._serialize(message)));};
...
$._exitScope = function(depth){$._jsExitJavaScriptScope.callSync$1([]);$._proxiedFunctionTable().exitScope$0();$._proxiedObjectTable().exitScope$0();$.proxyDebug('');};
...
$.CanvasElement_CanvasElement = function(width,height){var t1=$===width;if(t1)width=null;var t2=$===height;if(t2)height=null;if(t1)return $._Elements_createCanvasElement(null,null);if(t2)return $._Elements_createCanvasElement(width,null);return $._Elements_createCanvasElement(width,height);};
...
$.TextureAnimationElement$ = function(width,height,_textureData){return new $.TextureAnimationElement(_textureData,$.ListImplementation_List(null),$.ListImplementation_List(null),false,$.EventHandle$(),$.EventHandle$(),null,width,height,null,null,false,null,$.HashMapImplementation$(),$.HashMapImplementation$(),false);};
...
$._DeserializedFunctionTable$ = function(){var t1=new $._DeserializedFunctionTable(null);t1._DeserializedFunctionTable$0();return t1;};
...
$._processUrlHash = function(){var loc=$.window().get$location();var hash=loc.get$hash();var href=loc.get$href();$.window().get$history();var showAbout=false;switch(hash){case '#reset':var newLoc=$.substring$2(href,0,$.sub($.get$length(href),$.get$length(hash)));$.clear($.window().get$localStorage());loc.replace$1(newLoc);showAbout=false;break;case '#big':return true;case '#about':showAbout=true;break;}var t1=showAbout?'inline-block':'none';$.query('#popup').get$style().set$display(t1);return false;};
...
$.Field_Field = function(bombCount,cols,rows,seed){if(typeof bombCount!=='number')return $.Field_Field$bailout(1,bombCount,cols,rows,seed);var squares=$.ListImplementation_List(null);$.insertRange$3(squares,0,rows*cols,false);var rnd=$.Random_Random(seed);for(var i=0;i<bombCount;++i){var index=null;do{index=rnd.nextInt$1(squares.length);if(index!==(index|0))throw $.iae(index);if(index<0||index>=squares.length)throw $.ioore(index);}while(squares[index]===true);squares[index]=true;}return $.Field$_internal(bombCount,cols,$.ReadOnlyCollection$(squares));};
...
$._Audio__getAudioPaths = function(names){return $.map($.$$(names),$._Audio__getAudioPath);};
...
$._MessageTraverser_isPrimitive0 = function(x){return x==null||typeof x==='string'||typeof x==='number'||typeof x==='boolean';};

$._Deserializer_isPrimitive0 = function(x){return x==null||typeof x==='string'||typeof x==='number'||typeof x==='boolean';};
...
$._callPortSync = function(id,message){return ReceivePortSync.dispatchCall(id, message);};
...
$.RetainedUtil__hitTest$bailout = function(state0,env0,env1,env2,env3){switch(state0){case 1:var element=env0;length$=env1;point=env2;hits=env3;break;}switch(state0){case 0:var point=$.RetainedUtil_transformPointGlobalToLocal(element,point);var bounds=$.Box$(0,0,element.get$width(),element.get$height());var hits=$.ListImplementation_List(null);case 1:if(state0===1||state0===0&&bounds.contains$1(point)===true)switch(state0){case 0:var length$=element.get$visualChildCount();case 1:state0=0;for(var i=0;$.ltB(i,length$);++i){hits=$.RetainedUtil__hitTest(element.getVisualChild$1($.sub($.sub(length$,1),i)),point);if(hits.length>0)break;}hits.push(element);return hits;}else return [];}};

$.Proxy__convert$bailout = function(state0,env0){switch(state0){case 1:var data=env0;break;}switch(state0){case 0:case 1:if(state0===0&&typeof data==='object'&&data!==null&&data.is$Map()){var result=$._deserialize($._jsPortSync.callSync$1($._serialize('new Object()')));for(var t1=$.iterator(data.getKeys$0());t1.hasNext$0()===true;){var t2=t1.next$0();var value=$.Proxy__convert(data.operator$index$1(t2));result.noSuchMethod$2('set:'+$.S(t2),[value]);}return result;}else switch(state0){case 0:case 1:if(state0===1||state0===0&&typeof data==='object'&&data!==null&&(data.constructor===Array||data.is$List()))switch(state0){case 0:case 1:state0=0;result=$._deserialize($._jsPortSync.callSync$1($._serialize('new Array()')));for(var i=0;$.ltB(i,$.get$length(data));++i){value=$.Proxy__convert($.index(data,i));result.noSuchMethod$2('set:'+$.S(i),[value]);}return result;}}return data;}};
...
$.Futures_wait$bailout = function(state0,futures,t1){if($.isEmpty(futures)===true)return $.Future_Future$immediate($.CTC1);var completer=$.Completer_Completer();var result=completer.get$future();t1.remaining_1=$.get$length(futures);var values=$.ListImplementation_List($.get$length(futures));for(var i=0;$.ltB(i,$.get$length(futures));++i){var future=$.index(futures,i);future.then$1(new $.Futures_wait_anon(completer,i,t1,result,values));future.handleException$1(new $.Futures_wait_anon0(future,completer,result));}return result;};

$.Field_Field$bailout = function(state0,bombCount,cols,rows,seed){var squares=$.ListImplementation_List(null);$.insertRange$3(squares,0,rows*cols,false);var rnd=$.Random_Random(seed);for(var i=0;$.ltB(i,bombCount);++i){var index=null;do{index=rnd.nextInt$1(squares.length);if(index!==(index|0))throw $.iae(index);if(index<0||index>=squares.length)throw $.ioore(index);}while(squares[index]===true);squares[index]=true;}return $.Field$_internal(bombCount,cols,$.ReadOnlyCollection$(squares));};
...
$.CTC65 = true;
$.CTC26 = new Isolate.$isolateProperties.ConstantMap(6, {'childList': true, 'attributes': true, 'characterData': true, 'subtree': true, 'attributeOldValue': true, 'characterDataOldValue': true}, Isolate.$isolateProperties.CTC64);
...
$.CTC67 = 'safe';
$.CTC52 = new Isolate.$isolateProperties.SquareState('safe');
$.CTC68 = 'started';
$.CTC47 = new Isolate.$isolateProperties.GameState('started');
$.CTC11 = new Isolate.$isolateProperties._DeletedKeySentinel();
$.CTC69 = 'revealed';
$.CTC37 = new Isolate.$isolateProperties.SquareState('revealed');
$.CTC70 = 'TODO(jacobr): should we impl?';
$.CTC50 = new Isolate.$isolateProperties.UnsupportedOperationException('TODO(jacobr): should we impl?');
...
$.CTC74 = 'flagged';
$.CTC38 = new Isolate.$isolateProperties.SquareState('flagged');
$.CTC75 = 'offsetX is only supported on elements';
$.CTC24 = new Isolate.$isolateProperties.UnsupportedOperationException('offsetX is only supported on elements');
$.CTC25 = new Isolate.$isolateProperties.EventArgs();
$.CTC76 = 2048;
$.CTC77 = 1536;
$.CTC31 = new Isolate.$isolateProperties.Size(2048, 1536);
$.CTC78 = 0;
$.CTC57 = new Isolate.$isolateProperties.Coordinate(0, 0);
$.CTC79 = 32;
$.CTC30 = new Isolate.$isolateProperties.Coordinate(32, 32);
$.CTC80 = 352;
$.CTC81 = 96;
$.CTC32 = new Isolate.$isolateProperties.Vector(352, 96);
$.CTC82 = 'reset';
$.CTC34 = new Isolate.$isolateProperties.GameState('reset');
$.CTC83 = 100;
$.CTC33 = new Isolate.$isolateProperties.Size(100, 100);
$.CTC84 = -472;
$.CTC85 = -348;
$.CTC53 = new Isolate.$isolateProperties.Vector(-472, -348);
...
$.CTC87 = -88;
$.CTC51 = new Isolate.$isolateProperties.Vector(-88, -88);
$.CTC22 = new Isolate.$isolateProperties._UndefinedValue();
$.CTC27 = new Isolate.$isolateProperties.IllegalAccessException();
$.CTC88 = 'bomb';
$.CTC48 = new Isolate.$isolateProperties.SquareState('bomb');
$.CTC89 = '^[*a-zA-Z0-9]+$';
$.CTC44 = new Isolate.$isolateProperties.JSSyntaxRegExp('^[*a-zA-Z0-9]+$', false, false);
$.CTC90 = 'structured clone of File';
$.CTC5 = new Isolate.$isolateProperties.NotImplementedException('structured clone of File');
$.CTC91 = 'game_board_center';
$.CTC92 = 'number_one';
$.CTC93 = 'number_two';
$.CTC94 = 'number_three';
$.CTC95 = 'number_four';
...
$.CTC98 = 'number_seven';
$.CTC99 = 'number_eight';
$.CTC54 = Isolate.makeConstantList(['game_board_center', 'number_one', 'number_two', 'number_three', 'number_four', 'number_five', 'number_six', 'number_seven', 'number_eight']);
$.CTC100 = 'structured clone of ImageData';
...
$.CTC102 = '';
$.CTC42 = new Isolate.$isolateProperties.UnsupportedOperationException('');
...
$.CTC104 = 'balloon_pieces_a.png';
$.CTC105 = 'balloon_pieces_b.png';
$.CTC106 = 'balloon_pieces_c.png';
$.CTC107 = 'balloon_pieces_d.png';
$.CTC55 = Isolate.makeConstantList(['balloon_pieces_a.png', 'balloon_pieces_b.png', 'balloon_pieces_c.png', 'balloon_pieces_d.png']);
$.CTC108 = '^#[_a-zA-Z]\\w*$';
$.CTC18 = new Isolate.$isolateProperties.JSSyntaxRegExp('^#[_a-zA-Z]\\w*$', false, false);
$.CTC109 = 'structured clone of ArrayBuffer';
...
$.CTC130 = 'Cannot sort immutable List.';
$.CTC49 = new Isolate.$isolateProperties.UnsupportedOperationException('Cannot sort immutable List.');
$.CTC131 = 'structured clone of Date';
...
$.CTC28 = new Isolate.$isolateProperties.EmptyElementRect(Isolate.$isolateProperties.CTC135, Isolate.$isolateProperties.CTC135, Isolate.$isolateProperties.CTC135, Isolate.$isolateProperties.CTC135, Isolate.$isolateProperties.CTC1);
$.CTC136 = 'Cannot removeRange on immutable List.';
$.CTC41 = new Isolate.$isolateProperties.UnsupportedOperationException('Cannot removeRange on immutable List.');
$.CTC137 = 'structured clone of Blob';
$.CTC6 = new Isolate.$isolateProperties.NotImplementedException('structured clone of Blob');
$.CTC138 = 'won';
$.CTC39 = new Isolate.$isolateProperties.GameState('won');
$.CTC139 = 'lost';
$.CTC40 = new Isolate.$isolateProperties.GameState('lost');
...
$.CTC46 = new Isolate.$isolateProperties.ArgumentError('Invalid list length');
$.CTC142 = '^\\[name=["\'][^\'"]+[\'"]\\]$';
$.CTC43 = new Isolate.$isolateProperties.JSSyntaxRegExp('^\\[name=["\'][^\'"]+[\'"]\\]$', false, false);
$.CTC15 = new Isolate.$isolateProperties._Random();
$.CTC143 = 'hidden';
$.CTC36 = new Isolate.$isolateProperties.SquareState('hidden');
...
$.Property_Undefined = Isolate.$isolateProperties.CTC22;
...
$.SquareElement__balloonBits = Isolate.$isolateProperties.CTC55;
...
$._getTypeNameOf = null;
$.GameElement__popExplodeAnimationOffset = Isolate.$isolateProperties.CTC51;
$.GameElement__popAnimationHitFrame = 12;
$._JsonParser_CHAR_B = 98;
$.SquareState_bomb = Isolate.$isolateProperties.CTC48;
...
$.SquareState_hidden = Isolate.$isolateProperties.CTC36;
...
$.SquareState_revealed = Isolate.$isolateProperties.CTC37;
$.GameState_reset = Isolate.$isolateProperties.CTC34;
$._JsonParser_NULL_STRING = 'null';
$._dartEnterDartScope = null;
$._JsonParser_COMMA = 44;
$.SquareElement__numberMap = Isolate.$isolateProperties.CTC54;
...
$.SquareState_flagged = Isolate.$isolateProperties.CTC38;
...
$.GameElement__boardOffset = Isolate.$isolateProperties.CTC32;
...
$.SquareState_safe = Isolate.$isolateProperties.CTC52;
$.GameElement__dartAnimationOffset = Isolate.$isolateProperties.CTC53;
...
$.GameState_won = Isolate.$isolateProperties.CTC39;
...
$.GameElement__backgroundSize = Isolate.$isolateProperties.CTC31;
$._jsPortEquals = null;
$._transparentTextureName = 'images/transparent_animated.png';
$.ScoreElement__bombsLeftStr = 'BOMBS LEFT:';
$._cachedBrowserPrefix = null;
$.GameState_lost = Isolate.$isolateProperties.CTC40;
...
$.$defineNativeClass('CSSRuleList', ["length?"], {
 ...
 every$1: function(f){return $._Collections_every(this,f);},
 isEmpty$0: function(){return $.eq($.get$length(this),0);},
 sort$1: function(compare){throw $.$$throw($.CTC49);},
 indexOf$2: function(element,start){return $._Lists_indexOf(this,element,start,$.get$length(this));},
 last$0: function(){return this.operator$index$1($.sub($.get$length(this),1));},
 removeLast$0: function(){throw $.$$throw($.CTC13);},
 removeRange$2: function(start,rangeLength){throw $.$$throw($.CTC41);},
 insertRange$3: function(start,rangeLength,initialValue){throw $.$$throw($.CTC35);},
...
$.$defineNativeClass('HTMLDocument', ["body?", "documentElement?"], {
 ...
 $dom_querySelector$1: function(selectors){return this.querySelector(selectors);},
 $dom_querySelectorAll$1: function(selectors){return this.querySelectorAll(selectors);},
 query$1: function(selectors){if($.CTC18.hasMatch$1(selectors)===true)return this.$dom_getElementById$1($.substring$1(selectors,1));return this.$dom_querySelector$1(selectors);},
 queryAll$1: function(selectors){if($.CTC43.hasMatch$1(selectors)===true){var mutableMatches=this.$dom_getElementsByName$1($.substring$2(selectors,7,selectors.length-2));if(typeof mutableMatches!=='string'&&(typeof mutableMatches!=='object'||mutableMatches===null||mutableMatches.constructor!==Array&&!mutableMatches.is$JavaScriptIndexingBehavior()))return this.queryAll$1$bailout(1,mutableMatches);var len=mutableMatches.length;var copyOfMatches=$.ListImplementation_List(len);for(var t1=mutableMatches.length,i=0;i<len;++i){if(i>=t1)throw $.ioore(i);copyOfMatches[i]=mutableMatches[i];}return $._FrozenElementList$_wrap(copyOfMatches);}else if($.CTC44.hasMatch$1(selectors)===true){mutableMatches=this.$dom_getElementsByTagName$1(selectors);if(typeof mutableMatches!=='string'&&(typeof mutableMatches!=='object'||mutableMatches===null||mutableMatches.constructor!==Array&&!mutableMatches.is$JavaScriptIndexingBehavior()))return this.queryAll$1$bailout(2,mutableMatches);len=mutableMatches.length;copyOfMatches=$.ListImplementation_List(len);for(t1=mutableMatches.length,i=0;i<len;++i){if(i>=t1)throw $.ioore(i);copyOfMatches[i]=mutableMatches[i];}return $._FrozenElementList$_wrap(copyOfMatches);}else return $._FrozenElementList$_wrap(this.$dom_querySelectorAll$1(selectors));},
 queryAll$1$bailout: function(state0,env0){switch(state0){case 1:mutableMatches=env0;break;case 2:mutableMatches=env0;break;}switch(state0){case 0:default:if(state0===1||state0===0&&$.CTC43.hasMatch$1(selectors)===true)switch(state0){case 0:var mutableMatches=this.$dom_getElementsByName$1($.substring$2(selectors,7,selectors.length-2));case 1:state0=0;var len=$.get$length(mutableMatches);var copyOfMatches=$.ListImplementation_List(len);for(var i=0;$.ltB(i,len);++i){var t1=$.index(mutableMatches,i);if(i>=copyOfMatches.length)throw $.ioore(i);copyOfMatches[i]=t1;}return $._FrozenElementList$_wrap(copyOfMatches);}else switch(state0){case 0:case 2:if(state0===2||state0===0&&$.CTC44.hasMatch$1(selectors)===true)switch(state0){case 0:mutableMatches=this.$dom_getElementsByTagName$1(selectors);case 2:state0=0;len=$.get$length(mutableMatches);copyOfMatches=$.ListImplementation_List(len);for(i=0;$.ltB(i,len);++i){t1=$.index(mutableMatches,i);if(i>=copyOfMatches.length)throw $.ioore(i);copyOfMatches[i]=t1;}return $._FrozenElementList$_wrap(copyOfMatches);}else return $._FrozenElementList$_wrap(this.$dom_querySelectorAll$1(selectors));}}},
 is$Element: function() { return true; }
});
...
$.$defineNativeClass('IDBIndex', ["name?"], {
 ...
 get$1: function(key){var t1=$===key;if(t1)key=null;t1=!t1;if(typeof key==='object'&&key!==null&&key.is$IDBKeyRange()||key==null)return this._get_1$1(key);if(t1)return this._get_2$1(key);throw $.$$throw($.CTC23);},
...
$.$defineNativeClass('DOMWindow', ["clientInformation?", "history?", "innerHeight?", "innerWidth?", "localStorage?", "name?", "navigator?", "status?"], {
 _open2$2: function(url,name){return this.open(url, name);},
 _open3$3: function(url,name,options){return this.open(url, name, options);},
 open$3: function(url,name$,options){if(options==null)return $._DOMWindowCrossFrameImpl__createSafe(this._open2$2(url,name$));else return $._DOMWindowCrossFrameImpl__createSafe(this._open3$3(url,name$,options));},
 open$2: function(url,name$) {
  return this.open$3(url,name$,null)
},
 get$location: function(){return this._get_location$0();},
 _get_location$0: function(){var result=this.get$_location();if($._LocalWindowImpl__isDartLocation(result)===true)return result;if(null==this._location_wrapper)this._location_wrapper=$._LocationWrapper$(result);return this._location_wrapper;},
 ...
 $dom_dispatchEvent$1: function(evt){return this.dispatchEvent(evt);},
 moveTo$2: function(x,y){return this.moveTo(x,y);},
 postMessage$3: function(message,targetOrigin,messagePorts){var t1=$===message;if(t1)message=null;t1=!t1;var t2=$===messagePorts;if(t2)messagePorts=null;if(t1&&t2){this._postMessage_1$2($._convertDartToNative_SerializedScriptValue(message),targetOrigin);return;}if(t1)t1=typeof messagePorts==='object'&&messagePorts!==null&&(messagePorts.constructor===Array||messagePorts.is$List())||messagePorts==null;else t1=false;if(t1){this._postMessage_2$3($._convertDartToNative_SerializedScriptValue(message),targetOrigin,messagePorts);return;}throw $.$$throw($.CTC23);},
 postMessage$2: function(message,targetOrigin) {
...
$.$defineNativeClass('MouseEvent', ["shiftKey?", "toElement?", "x?", "y?"], {
 get$offsetX: function(){if(!!this.offsetX)return this.get$_offsetX();else{var target=this.get$target();if(!(typeof target==='object'&&target!==null&&target.is$Element()))throw $.$$throw($.CTC24);return $.sub(this.clientX,this.get$target().getBoundingClientRect$0().get$left());}},
 get$offsetY: function(){if(!!this.offsetY)return this.get$_offsetY();else{var target=this.get$target();if(!(typeof target==='object'&&target!==null&&target.is$Element()))throw $.$$throw($.CTC24);return $.sub(this.clientY,this.get$target().getBoundingClientRect$0().get$top());}},
 get$_offsetX: function(){return this.offsetX},
 get$_offsetY: function(){return this.offsetY}
});

$.$defineNativeClass('MutationObserver', [], {
 observe$9: function(target,options,childList,attributes,characterData,subtree,attributeOldValue,characterDataOldValue,attributeFilter){var parsedOptions={};if(!(options==null))$.forEach(options,new $._MutationObserverImpl_observe_anon(parsedOptions));var t1=new $._MutationObserverImpl_observe_override(parsedOptions);t1.call$2('childList',childList);t1.call$2('attributes',attributes);t1.call$2('characterData',characterData);t1.call$2('subtree',subtree);t1.call$2('attributeOldValue',attributeOldValue);t1.call$2('characterDataOldValue',characterDataOldValue);if(!(attributeFilter==null))t1.call$2('attributeFilter',attributeFilter);this._call$2(target,parsedOptions);},
