...
$$.ResourceLoader = {"":
 ...
 _loadResourceSucceed$2: function(blobUrl, resource) {
  ...
  if ($.every(this._entries, new $.ResourceLoader__loadResourceSucceed_anon()) === true) {
    ...
    this._loadedEvent.fireEvent$1($.CTC25);
  }
},
 ...
 _onProgress$2: function(entry, args) {
  if (entry.updateProgress$2(args.get$loaded(), args.get$totalSize()) === true)
    this._progressEvent.fireEvent$1($.CTC25);
}
};
...
$$.TextureAnimationRequest = {"":
 ...
 update$0: function() {
  ...
  if (t1 === 0 && !this._lib7_done)
    this._startEventHandle.fireEvent$1($.CTC25);
},
...
$$.ClickManager = {"":
 ...
 _mouseOut$1: function(e) {
  ...
  $.get$ClickManager__mouseOutEvent().fireEvent$2(this._stage, $.CTC25);
},
...
$$.Game = {"":
 ...
 _update$0: function() {
  return this._updatedEvent.fireEvent$1($.CTC25);
},
...
$$.GameBackgroundElement = {"":
 ...
 _drawCorner$1: function(ctx) {
  ...
  this.get$_lib3_textureData().drawTextureKeyAt$3(ctx, 'background_side_left.png', $.Coordinate$(0, $.CTC32.y));
},
 get$_lib3_parent: function() {
  return $.propertyTypeCast(this.get$parent(), 'is$PCanvas').get$parent();
},
...
$$.GameElement = {"":
 ...
 _updateSize$2: function(w, h) {
  ...
  var sizeY = $.GameElement__getScale(h, $.CTC31.height, 1344);
  var t2 = $.Size$(sizeX, sizeY);
  this.set$size(t2);
  this._lib3_canvas.set$size(t2);
  this._scale = $.div(sizeX, t1);
  this._scaledBoardOffset = $.CTC32.scale$1(this._scale);
  t2 = this._scale;
  if (typeof t2 !== 'number')
    throw $.iae(t2);
...
$$.anon5 = {"":
 ...
 "super": "Closure",
 call$1: function(args) {
  return $.get$_titleClickedEventHandle().fireEvent$1($.CTC25);
}
};
...
$$.anon3 = {"":
 ...
 "super": "Closure",
 call$1: function(args) {
  return this.this_0.get$_clickedEvent().fireEvent$1($.CTC25);
}
};
...
$.Game$ = function(field) {
  var t1 = $.EventHandle$();
  var t2 = $.EventHandle$();
  t2 = new $.Game(field, $.Array2d_Array2d(field.get$width(), field.get$height(), $.CTC36), t1, t2, $.CTC34, null, null, null, null);
  t2.Game$1(field);
  return t2;
};
...
$._Audio__Audio = function() {
  if (!($.get$_Audio__audioFormat() == null))
    return $._Audio$_internal($.AudioLoader$($.AudioContext_AudioContext(), $._Audio__getAudioPaths($.CTC)));
  else
...
$._Audio__getAudioFormat = function() {
  try {
    var isWebKit = $.contains$1($.window().get$clientInformation().get$userAgent(), 'WebKit');
    if (isWebKit === true) {
      var isChrome = $.contains$1($.window().get$clientInformation().get$userAgent(), 'Chrome');
      if (isChrome === true)
        return 'webm';
      else
        return 'm4a';
...
$.GameElement$ = function(textureData) {
  ...
  t6 = new $.GameElement(t1, t2, t3, $.ScoreElement$(), t4, t5, t7, t8, textureData, t6, null, null, null, null, null, null, null, null, null, $.ListImplementation_List(null), false, $.EventHandle$(), $.EventHandle$(), null, 100, 100, null, null, false, null, $.HashMapImplementation$(), $.HashMapImplementation$(), false);
