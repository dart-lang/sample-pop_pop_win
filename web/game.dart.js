...
$$.Object = {"":
 ...
 _stageDraw$1: function($0) {
  return this.noSuchMethod$2("_stageDraw", [$0]);
 },
...
$$._Audio = {"":
 ...
 _onLoad$1: function(args) {
  ...
  var t4 = this._audioLoader;
  for (; t1.hasNext$0() === true;) {
    var t3 = t1.next$0();
    var t5 = t4.getResource$1($._Audio__getAudioPath(t3));
    if (t3 !== (t3 | 0))
      throw $.iae(t3);
 ...
 _playAudioCore$1: function(name$) {
  if (!(this.get$_audioContext() == null)) {
    var source = this.get$_audioContext().createBufferSource$0();
    source.set$buffer($.index(this._buffers, name$));
    source.connect$2(this.get$_audioContext().get$destination(), 0);
    source.start$1(0);
  }
},
 _Audio$_internal$1: function(_audioLoader) {
  var t1 = this._audioLoader;
  $.add$1(t1.get$progress(), $._onProgress);
  $.add$1(t1.get$loaded(), $._onLoaded);
  $.add$1(t1.get$loaded(), this.get$_onLoad());
  $.add$1($.GameAudio_audioEvent(), this.get$_playAudio());
  t1.load$0();
}
};
...
$$._DOMWindowCrossFrameImpl = {"":
 ...
 "super": "Object",
 get$history: function() {
  return $._HistoryCrossFrameImpl__createSafe(this._window.history);
},
 get$location: function() {
...
$$._LocationWrapper = {"":
 ...
 assign$1: function(url) {
  return $._LocationWrapper__assign(this._ptr, url);
},
...
$$._NativeJsSendPort = {"":
 ...
 operator$eq$1: function(other) {
  return typeof other === 'object' && other !== null && !!other.is$_NativeJsSendPort && $.eqB(this._lib9_receivePort, other._lib9_receivePort);
},
 hashCode$0: function() {
  return this._lib9_receivePort.get$_lib9_id();
},
...
$$._WorkerSendPort = {"":
 ...
 operator$eq$1: function(other) {
  if (typeof other === 'object' && other !== null && !!other.is$_WorkerSendPort)
    var t1 = $.eqB(this._workerId, other._workerId) && $.eqB(this._lib9_isolateId, other._lib9_isolateId) && $.eqB(this._receivePortId, other._receivePortId);
  else
    t1 = false;
  return t1;
},
 hashCode$0: function() {
  return $.xor($.xor($.shl(this._workerId, 16), $.shl(this._lib9_isolateId, 8)), this._receivePortId);
},
...
$$._PendingSendPortFinder = {"":
 ...
 visitList$1: function(list) {
  if (!($.index(this._lib9_visited, list) == null))
    return;
  $.indexSet(this._lib9_visited, list, true);
  $.forEach(list, new $._PendingSendPortFinder_visitList_anon(this));
},
 visitMap$1: function(map) {
  if (!($.index(this._lib9_visited, map) == null))
    return;
  $.indexSet(this._lib9_visited, map, true);
  $.forEach(map.getValues$0(), new $._PendingSendPortFinder_visitMap_anon(this));
},
 visitSendPort$1: function(port) {
  if (!!port.is$_BufferingSendPort && port._lib9_port == null)
    this.ports.push(port.get$_futurePort());
},
 _PendingSendPortFinder$0: function() {
  this._lib9_visited = $._JsVisitedMap$();
}
};
...
$$._JsSerializer0 = {"":
 ...
 visitNativeJsSendPort$1: function(port) {
  return ['sendport', $._globalState().get$currentManagerId(), port._lib9_isolateId, port._lib9_receivePort.get$_lib9_id()];
},
 visitWorkerSendPort$1: function(port) {
  return ['sendport', port._workerId, port._lib9_isolateId, port._receivePortId];
},
 visitBufferingSendPort$1: function(port) {
  var t1 = port._lib9_port;
  if (!(t1 == null))
...
$$._JsCopier = {"":
 ...
 visitNativeJsSendPort$1: function(port) {
  return $._NativeJsSendPort$(port._lib9_receivePort, port._lib9_isolateId);
},
 visitWorkerSendPort$1: function(port) {
  return $._WorkerSendPort$(port._workerId, port._lib9_isolateId, port._receivePortId);
},
 visitBufferingSendPort$1: function(port) {
  var t1 = port._lib9_port;
  if (!(t1 == null))
...
$$._MessageTraverser0 = {"":
 ...
 traverse$1: function(x) {
  if ($._MessageTraverser_isPrimitive0(x))
    return this.visitPrimitive$1(x);
  this._lib9_visited.reset$0();
  var result = null;
  try {
    result = this._lib9_dispatch$1(x);
  } finally {
    this._lib9_visited.cleanup$0();
  }
  return result;
},
 _lib9_dispatch$1: function(x) {
  if ($._MessageTraverser_isPrimitive0(x))
    return this.visitPrimitive$1(x);
  if (typeof x === 'object' && x !== null && (x.constructor === Array || x.is$List()))
    return this.visitList$1(x);
...
$$._Copier = {"":
 ...
 visitList$1: function(list) {
  ...
  var copy = $.index(this._lib9_visited, list);
  if (!(copy == null))
    return copy;
  var len = list.length;
  copy = $.ListImplementation_List(len);
  $.indexSet(this._lib9_visited, list, copy);
  for (var i = 0; i < len; ++i) {
    if (i >= list.length)
      throw $.ioore(i);
    copy[i] = this._lib9_dispatch$1(list[i]);
  }
  return copy;
},
 visitList$1$bailout: function(state0, list) {
  ...
  $.indexSet(this._lib9_visited, list, copy);
  for (var i = 0; $.ltB(i, len); ++i) {
    var t1 = this._lib9_dispatch$1($.index(list, i));
    if (i >= copy.length)
      throw $.ioore(i);
    copy[i] = t1;
  }
 ...
 visitMap$1: function(map) {
  var t1 = {};
  t1.copy_10 = $.index(this._lib9_visited, map);
  var t2 = t1.copy_10;
  if (!(t2 == null))
    return t2;
  t1.copy_10 = $.HashMapImplementation$();
  $.indexSet(this._lib9_visited, map, t1.copy_10);
...
$$._Serializer0 = {"":
 ...
 visitList$1: function(list) {
  var copyId = $.index(this._lib9_visited, list);
  if (!(copyId == null))
    return ['ref', copyId];
  var id = this._lib9_nextFreeRefId;
  this._lib9_nextFreeRefId = id + 1;
  $.indexSet(this._lib9_visited, list, id);
  return ['list', id, this._lib9_serializeList$1(list)];
},
 visitMap$1: function(map) {
  var copyId = $.index(this._lib9_visited, map);
  if (!(copyId == null))
    return ['ref', copyId];
  var id = this._lib9_nextFreeRefId;
  this._lib9_nextFreeRefId = id + 1;
  $.indexSet(this._lib9_visited, map, id);
  return ['map', id, this._lib9_serializeList$1(map.getKeys$0()), this._lib9_serializeList$1(map.getValues$0())];
},
 _lib9_serializeList$1: function(list) {
  if (typeof list !== 'string' && (typeof list !== 'object' || list === null || list.constructor !== Array && !list.is$JavaScriptIndexingBehavior()))
    return this._lib9_serializeList$1$bailout(1, list);
  var len = list.length;
  var result = $.ListImplementation_List(len);
  for (var i = 0; i < len; ++i) {
    if (i >= list.length)
      throw $.ioore(i);
    result[i] = this._lib9_dispatch$1(list[i]);
  }
  return result;
},
 _lib9_serializeList$1$bailout: function(state0, list) {
  var len = $.get$length(list);
  var result = $.ListImplementation_List(len);
  for (var i = 0; $.ltB(i, len); ++i) {
    var t1 = this._lib9_dispatch$1($.index(list, i));
...
$$._Deserializer0 = {"":
 ...
 deserialize$1: function(x) {
  if ($._Deserializer_isPrimitive0(x))
    return x;
  this._lib9_deserialized = $.HashMapImplementation$();
  return this._lib9_deserializeHelper$1(x);
},
 _lib9_deserializeHelper$1: function(x) {
  if ($._Deserializer_isPrimitive0(x))
    return x;
  switch ($.index(x, 0)) {
    case 'ref':
      return this._lib9_deserializeRef$1(x);
    case 'list':
      return this._lib9_deserializeList$1(x);
    case 'map':
      return this._lib9_deserializeMap$1(x);
    case 'sendport':
      return this.deserializeSendPort$1(x);
    default:
      return this.deserializeObject$1(x);
 ...
 _lib9_deserializeRef$1: function(x) {
  var id = $.index(x, 1);
  return $.index(this._lib9_deserialized, id);
},
 _lib9_deserializeList$1: function(x) {
  var id = $.index(x, 1);
  var dartList = $.index(x, 2);
  if (typeof dartList !== 'object' || dartList === null || (dartList.constructor !== Array || !!dartList.immutable$list) && !dartList.is$JavaScriptIndexingBehavior())
    return this._lib9_deserializeList$1$bailout(1, dartList, id);
  $.indexSet(this._lib9_deserialized, id, dartList);
  var len = dartList.length;
  for (var i = 0; i < len; ++i) {
    if (i >= dartList.length)
      throw $.ioore(i);
    var t1 = this._lib9_deserializeHelper$1(dartList[i]);
    if (i >= dartList.length)
      throw $.ioore(i);
    dartList[i] = t1;
  }
 ...
 _lib9_deserializeList$1$bailout: function(state0, dartList, id) {
  $.indexSet(this._lib9_deserialized, id, dartList);
  var len = $.get$length(dartList);
  for (var i = 0; $.ltB(i, len); ++i)
    $.indexSet(dartList, i, this._lib9_deserializeHelper$1($.index(dartList, i)));
  return dartList;
},
 _lib9_deserializeMap$1: function(x) {
  var result = $.HashMapImplementation$();
  var id = $.index(x, 1);
  $.indexSet(this._lib9_deserialized, id, result);
  var keys = $.index(x, 2);
  if (typeof keys !== 'string' && (typeof keys !== 'object' || keys === null || keys.constructor !== Array && !keys.is$JavaScriptIndexingBehavior()))
    return this._lib9_deserializeMap$1$bailout(1, x, result, keys);
  var values = $.index(x, 3);
  if (typeof values !== 'string' && (typeof values !== 'object' || values === null || values.constructor !== Array && !values.is$JavaScriptIndexingBehavior()))
    return this._lib9_deserializeMap$1$bailout(2, values, result, keys);
  var len = keys.length;
  for (var i = 0; i < len; ++i) {
    if (i >= keys.length)
      throw $.ioore(i);
    var key = this._lib9_deserializeHelper$1(keys[i]);
    if (i >= values.length)
      throw $.ioore(i);
    result.operator$indexSet$2(key, this._lib9_deserializeHelper$1(values[i]));
  }
  return result;
},
 _lib9_deserializeMap$1$bailout: function(state0, env0, env1, env2) {
  switch (state0) {
    case 1:
      var x = env0;
      result = env1;
  ...
  switch (state0) {
    ...
    case 2:
      ...
      var len = $.get$length(keys);
      for (var i = 0; $.ltB(i, len); ++i)
        result.operator$indexSet$2(this._lib9_deserializeHelper$1($.index(keys, i)), this._lib9_deserializeHelper$1($.index(values, i)));
      return result;
  }
},
 deserializeObject$1: function(x) {
...
$$.TextureAnimationElement = {"":
 ["_textureData?", "_requests", "_transforms", "cacheEnabled", "_invalidatedEventHandle", "_cacheCanvas", "_width", "_height", "_alpha", "_lastDrawSize", "clip", "_lib2_parent", "_propertyValues", "_eventHandlers", "_disposed"],
 "super": "PElement",
...
$$.TextureAnimationRequest = {"":
 ...
 update$0: function() {
  ...
  if (t1 < this._frameCount - 1)
    ...
    this._lib7_done = true;
  t1 = this._frame;
  if (typeof t1 !== 'number')
    return this.update$0$bailout(4, t1);
  if (t1 === 0 && !this._lib7_done)
    this._startEventHandle.fireEvent$1($.CTC24);
},
 update$0$bailout: function(state0, env0) {
  switch (state0) {
    case 1:
      t1 = env0;
      break;
    ...
    default:
      if (state0 === 2 || state0 === 0 && t1 == null)
        ...
        switch (state0) {
          case 0:
          case 3:
            if (state0 === 3 || state0 === 0 && $.ltB(t1, this._frameCount - 1))
              switch (state0) {
                case 0:
                  t1 = this._frame;
                case 3:
 ...
 _getFrameDetails$0$bailout: function(state0, env0, env1) {
  switch (state0) {
    case 1:
      offset = env0;
      t1 = env1;
  ...
  switch (state0) {
    ...
    case 1:
      state0 = 0;
    default:
      if (state0 === 0 && $.ltB(t1, 0) && !(this._initialFrame == null)) {
        var frameName = this._initialFrame;
        var offset0 = this._initialFrameOffset;
        if (!(offset0 == null))
          offset = offset0;
...
$$.Game = {"":
 ...
 get$gameEnded: function() {
  return $.eqB(this._state, $.CTC39) || $.eqB(this._state, $.CTC40);
},
 get$duration: function() {
 ...
 canReveal$2: function(x, y) {
  if ($.eqB(this._states.get$2(x, y), $.CTC36))
    return true;
 ...
 reveal$2$bailout: function(state0, env0) {
  ...
  switch (state0) {
    case 0:
      ...
      $.require(this.canReveal$2(x, y), 'Item cannot be revealed.');
    case 1:
      if (state0 === 1 || state0 === 0 && $.eqB(this._states.get$2(x, y), $.CTC36))
        switch (state0) {
          case 0:
          case 1:
 ...
 _canChord$2: function(x, y) {
  if ($.eqB(this._states.get$2(x, y), $.CTC37)) {
    var adjCount = this.field.getAdjacentCount$2(x, y);
    if ($.gtB(adjCount, 0))
      if ($.gtB(this._getAdjacentCount$3(x, y, $.CTC36), 0))
        if ($.eqB(this._getAdjacentCount$3(x, y, $.CTC38), adjCount))
          return true;
  }
  return false;
},
 ...
 _doChord$2$bailout: function(state0, env0, env1, env2, env3, env4, env5) {
  ...
  switch (state0) {
    ...
    case 2:
      ...
      for (var t2 = $.iterator(t3.getAdjacentIndices$2(x, y)), failed = false; t2.hasNext$0() === true;) {
        var t4 = t2.next$0();
        if ($.eqB($.index(t1, t4), $.CTC36)) {
          hidden.push(t4);
          if ($.index(t3, t4) === true)
            failed = true;
        } else if ($.eqB($.index(t1, t4), $.CTC38))
          flagged.push(t4);
      }
      var reveals = [];
      if (failed)
 ...
 _ensureStarted$0: function() {
  if ($.eqB(this.get$state(), $.CTC33))
    this._setState$1($.CTC47);
},
 ...
 Game$1: function(field) {
  ...
  this._revealsLeft = $.sub($.get$length(field), field.get$bombCount());
}
};
...
$$.BoardElement = {"":
 ["_lib3_elements", "_transforms", "cacheEnabled", "_invalidatedEventHandle", "_cacheCanvas", "_width", "_height", "_alpha", "_lastDrawSize", "clip", "_lib2_parent", "_propertyValues", "_eventHandlers", "_disposed"],
 "super": "ParentElement",
 get$visualChildCount: function() {
 ...
 update$0: function() {
  if (this.get$_lib3_game() == null)
    this._lib3_elements = null;
  else if (this.get$_elementsNeedUpdate() === true) {
    this._lib3_elements = $.Array2d_Array2d(this.get$_lib3_game().get$field().get$width(), this.get$_lib3_game().get$field().get$height(), null);
    var i = 0;
    while (true) {
      var t1 = $.get$length(this._lib3_elements);
      if (typeof t1 !== 'number')
        return this.update$0$bailout(1, i, t1, 0, 0, 0);
      if (!(i < t1))
        break;
      var coords = this._lib3_elements.getCoordinate$1(i);
      var se = $.SquareElement$(coords.get$item1(), coords.get$item2());
      se.registerParent$1(this);
      this.get$_lib3_parent().wireSquareMouseEvent$1(se);
      var etx = se.addTransform$0();
      t1 = coords.get$item1();
      if (typeof t1 !== 'number')
        return this.update$0$bailout(2, etx, t1, coords, i, se);
      t1 *= 80;
      var t3 = coords.get$item2();
      if (typeof t3 !== 'number')
        return this.update$0$bailout(3, etx, i, t1, t3, se);
      etx.setToTranslation$2(t1, t3 * 80);
      t1 = this._lib3_elements;
      if (typeof t1 !== 'object' || t1 === null || (t1.constructor !== Array || !!t1.immutable$list) && !t1.is$JavaScriptIndexingBehavior())
        return this.update$0$bailout(4, i, se, t1, 0, 0);
      if (i >= t1.length)
        throw $.ioore(i);
      t1[i] = se;
      ++i;
 ...
 update$0$bailout: function(state0, env0, env1, env2, env3, env4) {
  ...
  switch (state0) {
    case 0:
    default:
      if (state0 === 0 && this.get$_lib3_game() == null)
        this._lib3_elements = null;
      else
        switch (state0) {
          case 0:
 ...
 get$_elementsNeedUpdate: function() {
  var t1 = this._lib3_elements;
  return t1 == null || !$.eqB(t1.get$width(), this.get$_lib3_game().get$field().get$width()) || !$.eqB(this._lib3_elements.get$height(), this.get$_lib3_game().get$field().get$height());
},
 get$_lib3_textureData: function() {
...
$$.GameBackgroundElement = {"":
 ["_transforms", "cacheEnabled", "_invalidatedEventHandle", "_cacheCanvas", "_width", "_height", "_alpha", "_lastDrawSize", "clip", "_lib2_parent", "_propertyValues", "_eventHandlers", "_disposed"],
 "super": "PElement",
 update$0: function() {
 ...
 drawOverride$1: function(ctx) {
  ...
  ctx.save$0();
  ctx.transform$6(-1, 0, 0, 1, $.CTC30.width, 0);
  this._drawCorner$1(ctx);
  t1 = $.CTC30.height;
 ...
 _drawCorner$1: function(ctx) {
  ...
  this.get$_lib3_textureData().drawTextureKeyAt$3(ctx, 'background_side_left.png', $.Coordinate$(0, $.CTC31.y));
},
 get$_lib3_parent: function() {
  return $.propertyTypeCast(this.get$parent(), 'is$PCanvas').get$parent();
},
...
$$.GameElement = {"":
 ...
 update$0: function() {
  $.ParentElement.prototype.update$0.call(this);
  var offset = $.add(this._scaledBoardOffset, $.CTC29);
 ...
 _startPopAnimation$2: function(start, reveals) {
  ...
  for (var t1 = $.iterator(values), t2 = this._popAnimationLayer; t1.hasNext$0() === true;) {
    ...
    switch (ss) {
      case $.CTC37:
      case $.CTC36:
        $.add$1(request.get$started(), new $.GameElement__startPopAnimation_anon4());
        break;
      case $.CTC48:
        $.add$1(request.get$started(), new $.GameElement__startPopAnimation_anon5());
        break;
    }
    t2.add$1(request);
  }
 ...
 _startDartAnimation$1: function(points) {
  ...
  for (var t1 = $.iterator(points), t2 = this._dartAnimationLayer; t1.hasNext$0() === true;) {
    ...
    if (typeof t3 !== 'number')
      throw $.iae(t3);
    var squareOffset = $.CTC53.operator$add$1($.Vector$(t4, 80 * t3));
 ...
 _squareClicked$1: function(args) {
  if (this._lib3_game.get$gameEnded() !== true && this._lastHoldUnfreeze == null) {
 ...
 _squareMouseDown$1: function(args) {
  ...
  if (!(this.get$_mouseDownTimeoutHandle() == null))
    $.window().clearTimeout$1(this._mouseDownTimeoutHandleId);
  this._lib3_mouseDownElement = args.get$element();
 ...
 _squareMouseMove$1: function(args) {
  var se = args.get$element();
  if (!$.eqB(this._lib3_mouseDownElement, se))
 ...
 _mouseDownTimeoutHandle$0: function() {
  this._click$3(this._lib3_mouseDownElement.get$x(), this._lib3_mouseDownElement.get$y(), true);
  this._lastHoldUnfreeze = this._lib3_mouseDownElement;
  this._clearTimeout$0();
},
 ...
 _clearTimeout$0: function() {
  ...
  this._lib3_mouseDownElement = null;
},
 ...
 _click$3: function(x, y, alt) {
  ...
  var t1 = alt === true;
  if (t1)
    if ($.eqB(ss, $.CTC36) || $.eqB(ss, $.CTC38)) {
      this._toggleFlag$2(x, y);
      var reveals = null;
    } else if ($.eqB(ss, $.CTC37))
 ...
 GameElement$1: function(textureData) {
  ...
  var t3 = this._titleElement;
  t1.addElement$1(t3);
  t1.addElement$1(this._dartAnimationLayer);
  $.add$1(t2.get$clicked(), new $.anon4());
  $.ClickManager_setClickable(t3, true);
  $.ClickManager_addHandler(t3, new $.anon5());
}
};
...
$$.GameRoot = {"":
 ...
 onGameStateChanged$1: function(newState) {
  ...
  $.trackAnalyticsEvent('game', newState.name, $.toString(this.get$game().get$field()), null);
},
 onNewBestTime$1: function(value) {
  $.trackAnalyticsEvent('game', 'record', $.toString(this.get$game().get$field()), value);
},
 _updateCanvasSize$0: function() {
  var t1 = $.window().get$innerWidth();
  var t2 = this._lib3_canvas;
  t2.set$width(t1);
 ...
 _onFrame$1: function(time) {
  ...
  var delta = $.Vector$($.sub(t2.get$size().get$width(), newDimensions.get$width()), $.min(40, $.sub(t2.get$size().get$height(), newDimensions.get$height()))).scale$1(0.5).scale$1(1 / prettyScale);
...
$$.NewGameElement = {"":
 ["_clickedEvent?", "_transforms", "cacheEnabled", "_invalidatedEventHandle", "_cacheCanvas", "_width", "_height", "_alpha", "_lastDrawSize", "clip", "_lib2_parent", "_propertyValues", "_eventHandlers", "_disposed"],
 "super": "PElement",
 get$clicked: function() {
 ...
 NewGameElement$0: function() {
  ...
  $.ClickManager_addHandler(this, new $.anon3(this));
...
$$.ScoreElement = {"":
 ["_gameManager", "_clockStr", "_bombsStr", "_bestTimeStr", "_textSize", "_transforms", "cacheEnabled", "_invalidatedEventHandle", "_cacheCanvas", "_width", "_height", "_alpha", "_lastDrawSize", "clip", "_lib2_parent", "_propertyValues", "_eventHandlers", "_disposed"],
 "super": "PElement",
 setGameManager$1: function(manager) {
 ...
 update$0: function() {
  var newBombStr = $.toString(this.get$_lib3_game().get$bombsLeft());
  if (!$.eqB(newBombStr, this._bombsStr)) {
    this._bombsStr = newBombStr;
    this.invalidateDraw$0();
  }
  var newClockStr = !(this.get$_lib3_game().get$duration() == null) ? $.ScoreElement_toRecordString(this.get$_lib3_game().get$duration().get$inMilliseconds()) : '';
  if (!$.eqB(newClockStr, this._clockStr)) {
    this._clockStr = newClockStr;
    this.invalidateDraw$0();
  }
  var bestTimeStr = !(this._gameManager.get$bestTimeMilliseconds() == null) ? $.ScoreElement_toRecordString(this._gameManager.get$bestTimeMilliseconds()) : null;
...
$$.SquareElement = {"":
 ["x?", "y?", "_lastDrawingState", "_transforms", "cacheEnabled", "_invalidatedEventHandle", "_cacheCanvas", "_width", "_height", "_alpha", "_lastDrawSize", "clip", "_lib2_parent", "_propertyValues", "_eventHandlers", "_disposed"],
 "super": "PElement",
 update$0: function() {
 ...
 _getHiddenTexture$0: function() {
  if ($.eqB(this.get$_lib3_game().get$state(), $.CTC40)) {
...
$$.GameStorage = {"":
 ...
 updateBestTime$1: function(game) {
  ...
  var m = game.get$field().get$bombCount();
...
$$.GameManager = {"":
 ...
 get$bestTimeMilliseconds: function() {
  return this._gameStorage.getBestTimeMilliseconds$3(this._lib5_width, this._lib5_height, this._bombCount);
},
 newGame$0: function() {
  if (!(this._updatedEventId == null)) {
    ...
    this._gameStateChanged$1($.CTC33);
  }
  this._game = $.Game$($.Field_Field(this._bombCount, this._lib5_width, this._lib5_height, null));
 ...
 updateClock$0: function() {
  if (this._setIntervalId == null && $.eqB(this._game.get$state(), $.CTC47))
    this._setIntervalId = $.window().setInterval$2(this.get$_doClock(), 1000);
  else if (!(this._setIntervalId == null) && !$.eqB(this._game.get$state(), $.CTC47)) {
...
$$.Callback = {"":
 ...
 get$_serialized: function() {
  return ['funcref', this._lib6_id, $._proxiedFunctionTable().get$sendPort()];
},
 _initialize$1: function(manualDispose) {
  this._manualDispose = manualDispose;
  this._lib6_id = $.add$1($._proxiedFunctionTable(), this._lib6_callback);
  $._proxiedFunctionTable().globalize$1(this._lib6_id);
  $._deserializedFunctionTable().add$2(this._lib6_callback, this.get$_serialized());
},
 Callback$many$1: function(f) {
  this._lib6_callback = f;
...
$$.Proxy = {"":
 ...
 noSuchMethod$2: function(method, args) {
  ...
  var result = this._port.callSync$1([this._lib6_id, method, $.map(args, $._serialize)]);
...
$$.trackAnalyticsEvent_anon = {"":
 ...
 "super": "Closure",
 call$0: function() {
  $.context().pushAnalytics$1($.array(['_trackEvent', this.category_1, this.action_3, this.label_2, this.value_0]));
}
};
...
$$.anon5 = {"":
 ...
 "super": "Closure",
 call$1: function(args) {
  return $.get$_titleClickedEventHandle().fireEvent$1($.CTC24);
}
};
...
$$.GameElement__click_anon0 = {"":
 ...
 "super": "Closure",
 call$1: function(t) {
  return $.eq(this.this_1.get$game().getSquareState$2(t.get$x(), t.get$y()), $.CTC36);
}
};
...
$$.GameElement__startPopAnimation_anon0 = {"":
 ...
 "super": "Closure",
 call$1: function(t2) {
  return $.eqB(t2.get$item2(), $.CTC48) || $.eqB(t2.get$item2(), $.CTC36);
}
};
...
$$.GameElement__startPopAnimation_anon2 = {"":
 ...
 call$1: function(c) {
  ...
  var squareOffset = $.CTC51.operator$add$1(initialOffset);
...
$$._PendingSendPortFinder_visitMap_anon = {"":
 ...
 "super": "Closure",
 call$1: function(e) {
  return this.this_0._lib9_dispatch$1(e);
}
};
...
$$._NativeJsSendPort_send_anon = {"":
 ...
 call$0: function() {
  ...
  var isolate = $.index($._globalState().get$isolates(), t2.get$_lib9_isolateId());
  if (isolate == null)
    return;
  if (t2.get$_lib9_receivePort().get$_lib9_callback() == null)
    return;
  var shouldSerialize = !($._globalState().get$currentContext() == null) && !$.eqB($._globalState().get$currentContext().get$id(), t2.get$_lib9_isolateId());
...
$$._Copier_visitMap_anon = {"":
 ...
 call$2: function(key, val) {
  ...
  var t2 = this.this_2;
  $.indexSet(t1, t2._lib9_dispatch$1(key), t2._lib9_dispatch$1(val));
}
};
...
$._getTextures = function(transparentElement, opaqueElement, transparentStaticElement) {
  ...
  $.forEach($._getTransparentStaticItems(), new $._getTextures_anon1(frames$, transparentStaticElement));
  return frames$;
};
...
$.trackAnalyticsEvent = function(category, action, label, value) {
  $.scoped(new $.trackAnalyticsEvent_anon(action, label, category, value));
};
...
$._serialize = function(message) {
  if (message == null)
    ...
    return ['objref', message._lib6_id, message._port];
  else
...
$.Field$_internal = function(bombCount, cols, source) {
  ...
  t2 = new $.Field(bombCount, t1, cols, t2, source);
  t2.Array2d$wrap$2(cols, source);
  t2.Field$_internal$3(bombCount, cols, source);
  return t2;
};
...
$.Game$ = function(field) {
  var t1 = $.EventHandle$();
  var t2 = $.EventHandle$();
  t2 = new $.Game(field, $.Array2d_Array2d(field.get$width(), field.get$height(), $.CTC36), t1, t2, $.CTC33, null, null, null, null);
  t2.Game$1(field);
  return t2;
};
...
$._toggleAbout = function(value) {
  var loc = $.window().get$location();
  var hash = $.eqB($.get$length(loc.get$hash()), 0) ? '#' : loc.get$hash();
  var isOpen = $.eqB(hash, '#about');
  if (value == null)
    value = !isOpen;
  var targetHash = value === true ? '#about' : '#';
  if (!(targetHash === hash))
...
$._onProgress = function(args) {
  ...
  var percent = $.div($.add(completedBytes, $._audio.get$completedBytes()), $.add(totalBytes, $._audio.get$totalBytes()));
  $.div($.floor($.mul(percent, 1000)), 10);
  var t1 = $.S($.toInt($.mul(percent, 398))) + 'px';
...
$.NewGameElement$ = function() {
  var t1 = new $.NewGameElement($.EventHandle$(), $.ListImplementation_List(null), false, $.EventHandle$(), null, 294, 92, null, null, false, null, $.HashMapImplementation$(), $.HashMapImplementation$(), false);
  t1.NewGameElement$0();
  return t1;
};
...
$.ScoreElement$ = function() {
  return new $.ScoreElement(null, null, null, null, null, $.ListImplementation_List(null), false, $.EventHandle$(), null, 400, 96, null, null, false, null, $.HashMapImplementation$(), $.HashMapImplementation$(), false);
};
...
$.GameTitleElement$ = function() {
  return new $.GameTitleElement($.ListImplementation_List(null), false, $.EventHandle$(), null, 318, 96, null, null, false, null, $.HashMapImplementation$(), $.HashMapImplementation$(), false);
};
...
$._LocationWrapper__assign = function(p, url) {
p.assign(url);
};
...
$._Audio__Audio = function() {
  if (!($.get$_Audio__audioFormat() == null))
    try {
      var audioContext = $.AudioContext_AudioContext();
      var loader = $.AudioLoader$(audioContext, $._Audio__getAudioPaths($.CTC));
      return $._Audio$_internal(loader);
    } catch (exception) {
      var t1 = $.unwrapException(exception);
      var e = t1;
...
$._HistoryCrossFrameImpl$ = function(_history) {
  return new $._HistoryCrossFrameImpl(_history);
};
...
$._Audio__getAudioFormat = function() {
  try {
    var userAgent = $.window().get$clientInformation().get$userAgent();
    var isWebKit = $.contains$1(userAgent, 'WebKit');
    if (isWebKit === true) {
      var isChrome = $.contains$1(userAgent, 'Chrome');
      if (isChrome === true)
        return 'webm';
      else
        return 'm4a';
...
$.dynamicFunction = function(name$) {
  ...
  if (!(f == null) && !!f.methods)
    return f.methods;
  var methods = {};
  var dartMethod = Object.getPrototypeOf($.CTC56)[name$];
  if (!(dartMethod == null))
...
$._onLoaded = function(args) {
  if ($.eqB($._imageLoader.get$state(), 'loaded') && $._audio.get$done() === true) {
    var opaqueImage = $._imageLoader.getResource$1('images/dart_opaque_01.jpg');
    var textureData = $.TextureData$($._getTextures($._imageLoader.getResource$1('images/transparent_animated.png'), opaqueImage, $.ImageElement_ImageElement('images/transparent_static.png', $, $)));
...
$.SquareElement$ = function(x, y) {
  var t1 = new $.SquareElement(x, y, null, $.ListImplementation_List(null), false, $.EventHandle$(), null, 80, 80, null, null, false, null, $.HashMapImplementation$(), $.HashMapImplementation$(), false);
...
$.ScoreElement_toRecordString = function(milliseconds) {
  return $.toStringAsFixed($.mul(milliseconds, 0.001), 1);
};
...
$._runppw = function(textureData) {
  var size = $._processUrlHash(false) ? 16 : 7;
  $.GameRoot_GameRoot(size, size, $.toInt(size * size * 0.15625), $.query('#gameCanvas'), textureData);
  $.add$1($.window().get$on().get$touchMove(), new $._runppw_anon());
  $.add$1($.window().get$on().get$popState(), new $._runppw_anon0());
  $.add$1($.window().get$on().get$keyDown(), $._onKeyDown);
  $.add$1($.query('#popup').get$on().get$click(), $._onPopupClick);
...
$.TextureAnimationElement$ = function(width, height, _textureData) {
  return new $.TextureAnimationElement(_textureData, $.ListImplementation_List(null), $.ListImplementation_List(null), false, $.EventHandle$(), null, width, height, null, null, false, null, $.HashMapImplementation$(), $.HashMapImplementation$(), false);
};
...
$.GameBackgroundElement$ = function() {
  return new $.GameBackgroundElement($.ListImplementation_List(null), true, $.EventHandle$(), null, 0, 0, null, null, false, null, $.HashMapImplementation$(), $.HashMapImplementation$(), false);
};
...
$._processUrlHash = function(forceReload) {
  var loc = $.window().get$location();
  var hash = loc.get$hash();
  var href = loc.get$href();
  $.window().get$history();
  var showAbout = false;
  switch (hash) {
    case '#reset':
      var newLoc = $.substring$2(href, 0, $.sub($.get$length(href), $.get$length(hash)));
  ...
  var t1 = showAbout ? 'inline-block' : 'none';
...
$.BoardElement$ = function() {
  return new $.BoardElement(null, $.ListImplementation_List(null), true, $.EventHandle$(), null, 0, 0, null, null, false, null, $.HashMapImplementation$(), $.HashMapImplementation$(), false);
};
...
$._Audio$_internal = function(_audioLoader) {
  var t1 = new $._Audio(_audioLoader, $.HashMapImplementation$());
...
$._Audio__getAudioPaths = function(names) {
  return $.map($.$$(names), $._Audio__getAudioPath);
};
...
$._Audio$_disabled = function() {
  return new $._Audio(null, $.HashMapImplementation$());
};
...
$.GameElement$ = function(textureData) {
  ...
  t6 = new $.GameElement(t1, t2, t3, $.ScoreElement$(), t4, t5, t7, t8, textureData, t6, null, null, null, null, null, null, null, null, null, $.ListImplementation_List(null), false, $.EventHandle$(), null, 100, 100, null, null, false, null, $.HashMapImplementation$(), $.HashMapImplementation$(), false);
...
$._HistoryCrossFrameImpl__createSafe = function(h) {
  var t1 = $.window().get$history();
  if (h == null ? t1 == null : h === t1)
    return h;
  else
    return $._HistoryCrossFrameImpl$(h);
};
...
$.CTC80 = 32;
$.CTC29 = new Isolate.$isolateProperties.Coordinate(32, 32);
$.CTC81 = 2048;
$.CTC82 = 1536;
$.CTC30 = new Isolate.$isolateProperties.Size(2048, 1536);
$.CTC83 = 352;
$.CTC84 = 96;
$.CTC31 = new Isolate.$isolateProperties.Vector(352, 96);
$.CTC85 = -88;
$.CTC51 = new Isolate.$isolateProperties.Vector(-88, -88);
$.CTC86 = 100;
$.CTC32 = new Isolate.$isolateProperties.Size(100, 100);
...
$.CTC101 = 'reset';
$.CTC33 = new Isolate.$isolateProperties.GameState('reset');
...
$.CTC133 = 'IDBKey containing Date';
$.CTC18 = new Isolate.$isolateProperties.NotImplementedException('IDBKey containing Date');
$.CTC134 = 'Cannot insertRange on immutable List.';
$.CTC34 = new Isolate.$isolateProperties.UnsupportedOperationException('Cannot insertRange on immutable List.');
$.CTC135 = 'Incorrect number or type of arguments';
$.CTC20 = new Isolate.$isolateProperties.ExceptionImplementation('Incorrect number or type of arguments');
$.CTC136 = new Isolate.$isolateProperties._SimpleClientRect(0, 0, 0, 0);
$.CTC27 = new Isolate.$isolateProperties.EmptyElementRect(Isolate.$isolateProperties.CTC136, Isolate.$isolateProperties.CTC136, Isolate.$isolateProperties.CTC136, Isolate.$isolateProperties.CTC136, Isolate.$isolateProperties.CTC1);
$.CTC137 = 'Cannot removeRange on immutable List.';
$.CTC41 = new Isolate.$isolateProperties.UnsupportedOperationException('Cannot removeRange on immutable List.');
$.CTC138 = 'structured clone of Blob';
...
$.CTC141 = 'The input sequence contains more than one element.';
$.CTC22 = new Isolate.$isolateProperties.InvalidOperationException('The input sequence contains more than one element.');
$.CTC142 = '^\\[name=["\'][^\'"]+[\'"]\\]$';
...
$.Property_Undefined = Isolate.$isolateProperties.CTC19;
...
$.GameState_reset = Isolate.$isolateProperties.CTC33;
...
$.GameElement__boardOffset = Isolate.$isolateProperties.CTC31;
...
$.GameElement__backgroundSize = Isolate.$isolateProperties.CTC30;
$._jsPortEquals = null;
...
$.$defineNativeClass('HTMLDocument', ["body?", "documentElement?"], {
 ...
 queryAll$1: function(selectors) {
  if ($.CTC43.hasMatch$1(selectors) === true) {
  ...
  } else if ($.CTC44.hasMatch$1(selectors) === true) {
 ...
 queryAll$1$bailout: function(state0, env0) {
  ...
  switch (state0) {
    case 0:
    default:
      if (state0 === 1 || state0 === 0 && $.CTC43.hasMatch$1(selectors) === true)
        switch (state0) {
          case 0:
            var mutableMatches = this.$dom_getElementsByName$1($.substring$2(selectors, 7, selectors.length - 2));
          case 1:
        ...
        switch (state0) {
          case 0:
          case 2:
            if (state0 === 2 || state0 === 0 && $.CTC44.hasMatch$1(selectors) === true)
              switch (state0) {
                case 0:
                  mutableMatches = this.$dom_getElementsByTagName$1(selectors);
                case 2:
