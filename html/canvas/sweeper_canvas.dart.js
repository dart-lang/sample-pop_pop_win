...
$$.HashSetIterator = {"":
 ...
 next$0: function(){if(this.hasNext$0()!==true)$.$$throw($.CTC2);var t1=this._entries;if(typeof t1!=='string'&&(typeof t1!=='object'||t1===null||t1.constructor!==Array&&!t1.is$JavaScriptIndexingBehavior()))return this.next$0$bailout(1,t1);var t3=this._nextValidIndex;if(t3!==(t3|0))$.iae(t3);if(t3<0||t3>=t1.length)$.ioore(t3);var res=t1[t3];this._advance$0();return res;},
...
$$._DoubleLinkedQueueIterator = {"":
 ...
 next$0: function(){if(this.hasNext$0()!==true)$.$$throw($.CTC2);this._currentEntry=this._currentEntry.get$_next();return this._currentEntry.get$element();},
...
$$._AllMatchesIterator = {"":
 ...
 "super": "Object",
 next$0: function(){if(this.hasNext$0()!==true)$.$$throw($.CTC2);var next=this._next;this._next=null;return next;},
...
$$._Random = {"":
 [],
 "super": "Object",
 nextInt$1: function(max){if(max<0)$.$$throw($.IllegalArgumentException$('negative max: '+$.S(max)));if(max>4294967295)max=4294967295;return (Math.random() * max) >>> 0;}
};
...
$$.FilteredElementList = {"":
 ...
 set$length: function(newLength){var len=$.get$length(this);if($.geB(newLength,len))return;else if($.ltB(newLength,0))$.$$throw($.CTC40);this.removeRange$2($.sub(newLength,1),$.sub(len,newLength));},
 ...
 insertRange$3: function(start,rangeLength,initialValue){$.$$throw($.CTC32);},
...
$$._ChildrenElementList = {"":
 ...
 "super": "Object",
 _toList$0: function(){var t1=this._childElements;if(typeof t1!=='string'&&(typeof t1!=='object'||t1===null||t1.constructor!==Array&&!t1.is$JavaScriptIndexingBehavior()))return this._toList$0$bailout(1,t1);var output=$.ListImplementation_List(t1.length);for(var len=t1.length,i=0;i<len;++i){if(i<0||i>=t1.length)$.ioore(i);var t2=t1[i];if(i<0||i>=output.length)$.ioore(i);output[i]=t2;}return output;},
 _toList$0$bailout: function(state,t1){var output=$.ListImplementation_List($.get$length(t1));for(var len=$.get$length(t1),i=0;$.ltB(i,len);++i){var t2=$.index(t1,i);if(i<0||i>=output.length)$.ioore(i);output[i]=t2;}return output;},
 ...
 set$length: function(newLength){$.$$throw($.CTC39);},
 ...
 removeRange$2: function(start,rangeLength){$.$$throw($.CTC32);},
 insertRange$3: function(start,rangeLength,initialValue){$.$$throw($.CTC32);},
...
$$._FrozenElementList = {"":
 ...
 operator$indexSet$2: function(index,value){$.$$throw($.CTC39);},
 set$length: function(newLength){$.set$length(this._nodeList,newLength);},
 add$1: function(value){$.$$throw($.CTC39);},
 addLast$1: function(value){$.$$throw($.CTC39);},
 iterator$0: function(){return $._FrozenElementListIterator$(this);},
 addAll$1: function(collection){$.$$throw($.CTC39);},
 removeRange$2: function(start,rangeLength){$.$$throw($.CTC39);},
 insertRange$3: function(start,rangeLength,initialValue){$.$$throw($.CTC39);},
 getRange$2: function(start,rangeLength){return $._FrozenElementList$_wrap($.getRange(this._nodeList,start,rangeLength));},
 clear$0: function(){$.$$throw($.CTC39);},
 removeLast$0: function(){$.$$throw($.CTC39);},
...
$$._FrozenElementListIterator = {"":
 ["_lib_list", "_index"],
 "super": "Object",
 next$0: function(){if(this.hasNext$0()!==true)$.$$throw($.CTC2);var t1=this._lib_list;if(typeof t1!=='string'&&(typeof t1!=='object'||t1===null||t1.constructor!==Array&&!t1.is$JavaScriptIndexingBehavior()))return this.next$0$bailout(1,t1,0);var t3=this._index;if(typeof t3!=='number')return this.next$0$bailout(2,t1,t3);this._index=t3+1;if(t3!==(t3|0))$.iae(t3);if(t3<0||t3>=t1.length)$.ioore(t3);return t1[t3];},
 next$0$bailout: function(state,env0,env1){switch(state){case 1:t1=env0;break;case 2:t1=env0;t3=env1;break;}switch(state){case 0:if(this.hasNext$0()!==true)$.$$throw($.CTC2);var t1=this._lib_list;case 1:state=0;var t3=this._index;case 2:state=0;this._index=$.add(t3,1);return $.index(t1,t3);}},
...
$$._VariableSizeListIterator = {"":
 ...
 next$0: function(){if(this.hasNext$0()!==true)$.$$throw($.CTC2);var t1=this._array;if(typeof t1!=='string'&&(typeof t1!=='object'||t1===null||t1.constructor!==Array&&!t1.is$JavaScriptIndexingBehavior()))return this.next$0$bailout(1,t1,0);var t3=this._pos;if(typeof t3!=='number')return this.next$0$bailout(2,t1,t3);this._pos=t3+1;if(t3!==(t3|0))$.iae(t3);if(t3<0||t3>=t1.length)$.ioore(t3);return t1[t3];},
 next$0$bailout: function(state,env0,env1){switch(state){case 1:t1=env0;break;case 2:t1=env0;t3=env1;break;}switch(state){case 0:if(this.hasNext$0()!==true)$.$$throw($.CTC2);var t1=this._array;case 1:state=0;var t3=this._pos;case 2:state=0;this._pos=$.add(t3,1);return $.index(t1,t3);}}
};
...
$$._JsonParser = {"":
 ...
 _error$1: function(message){$.$$throw(message);},
...
$$.Game = {"":
 ...
 get$gameEnded: function(){return $.eqB(this._state,$.CTC45)||$.eqB(this._state,$.CTC46);},
 ...
 setFlag$3: function(x,y,value){this._ensureStarted$0();var t1=this._states;var currentSS=t1.get$2(x,y);if(value){$.require($.eq(currentSS,$.CTC23),'');t1.set$3(x,y,$.CTC24);this._minesLeft=$.sub(this._minesLeft,1);}else{$.require($.eq(currentSS,$.CTC24),'');t1.set$3(x,y,$.CTC23);this._minesLeft=$.add(this._minesLeft,1);}this._update$0();},
 canReveal$2: function(x,y){this._ensureStarted$0();if($.eqB(this._states.get$2(x,y),$.CTC23))return true;else if(this._canChord$2(x,y)===true)return true;return false;},
 reveal$2: function(x,y){this._ensureStarted$0();$.require(this.canReveal$2(x,y),'Item cannot be revealed.');if($.eqB(this._states.get$2(x,y),$.CTC23))if(this.field.get$2(x,y)===true){this._setLost$0();var reveals=0;}else reveals=this._doReveal$2(x,y);else reveals=this._canChord$2(x,y)===true?this._doChord$2(x,y):0;this._update$0();return reveals;},
 _canChord$2: function(x,y){if($.eqB(this._states.get$2(x,y),$.CTC25)){var adjCount=this.field.getAdjacentCount$2(x,y);if($.gtB(adjCount,0))if($.eqB(this._getAdjacentFlagCount$2(x,y),adjCount))return true;}return false;},
 _doChord$2: function(x,y){var t1=this._states;if(typeof t1!=='string'&&(typeof t1!=='object'||t1===null||t1.constructor!==Array&&!t1.is$JavaScriptIndexingBehavior()))return this._doChord$2$bailout(1,x,y,t1,0,0,0);t1.get$2(x,y);var flagged=$.ListImplementation_List(null,'int');var hidden=$.ListImplementation_List(null,'int');var t3=this.field;if(typeof t3!=='string'&&(typeof t3!=='object'||t3===null||t3.constructor!==Array&&!t3.is$JavaScriptIndexingBehavior()))return this._doChord$2$bailout(2,x,y,t1,t3,flagged,hidden);t3.getAdjacentCount$2(x,y);for(var t2=$.iterator(t3.getAdjacentIndices$2(x,y)),failed=false;t2.hasNext$0()===true;){var t4=t2.next$0();if(t4!==(t4|0))$.iae(t4);if(t4<0||t4>=t1.length)$.ioore(t4);if($.eqB(t1[t4],$.CTC23)){hidden.push(t4);if(t4<0||t4>=t3.length)$.ioore(t4);if(t3[t4]===true)failed=true;}else{if(t4<0||t4>=t1.length)$.ioore(t4);if($.eqB(t1[t4],$.CTC24))flagged.push(t4);}}if(failed){this._setLost$0();var reveals=0;}else for(t1=$.iterator(hidden),reveals=0;t1.hasNext$0()===true;){var c=t3.getCoordinate$1(t1.next$0());if(this.canReveal$2(c.get$Item1(),c.get$Item2())===true){t2=this.reveal$2(c.get$Item1(),c.get$Item2());if(typeof t2!=='number')$.iae(t2);reveals+=t2;}}return reveals;},
 ...
 _doReveal$2: function(x,y){var t1=this._states;if(typeof t1!=='string'&&(typeof t1!=='object'||t1===null||t1.constructor!==Array&&!t1.is$JavaScriptIndexingBehavior()))return this._doReveal$2$bailout(1,x,t1,y,0,0);t1.set$3(x,y,$.CTC25);var t3=this._revealsLeft;if(typeof t3!=='number')return this._doReveal$2$bailout(2,x,t1,y,t3,0);this._revealsLeft=t3-1;var t2=this._revealsLeft;if(typeof t2!=='number')return this._doReveal$2$bailout(3,x,t1,y,t2,0);if(t2===0){this._setWon$0();var revealCount=1;}else{t2=this.field;t3=t2.getAdjacentCount$2(x,y);if(typeof t3!=='number')return this._doReveal$2$bailout(4,x,t1,y,t3,t2);if(t3===0)for(t3=$.iterator(t2.getAdjacentIndices$2(x,y)),revealCount=1;t3.hasNext$0()===true;){var t4=t3.next$0();if(t4!==(t4|0))$.iae(t4);if(t4<0||t4>=t1.length)$.ioore(t4);if($.eqB(t1[t4],$.CTC23)){var c=t2.getCoordinate$1(t4);t4=this._doReveal$2(c.get$Item1(),c.get$Item2());if(typeof t4!=='number')$.iae(t4);revealCount+=t4;}}else revealCount=1;}return revealCount;},
 _doReveal$2$bailout: function(state,env0,env1,env2,env3,env4){switch(state){case 1:var x=env0;t1=env1;var y=env2;break;case 2:x=env0;t1=env1;y=env2;t3=env3;break;case 3:x=env0;t1=env1;y=env2;t2=env3;break;case 4:x=env0;t1=env1;y=env2;t3=env3;t2=env4;break;}switch(state){case 0:var t1=this._states;case 1:state=0;t1.set$3(x,y,$.CTC25);var t3=this._revealsLeft;case 2:state=0;this._revealsLeft=$.sub(t3,1);var t2=this._revealsLeft;case 3:state=0;case 4:if(state===0&&$.eqB(t2,0)){this._setWon$0();var revealCount=1;}else switch(state){case 0:t2=this.field;t3=t2.getAdjacentCount$2(x,y);case 4:state=0;if($.eqB(t3,0))for(t3=$.iterator(t2.getAdjacentIndices$2(x,y)),revealCount=1;t3.hasNext$0()===true;){var t4=t3.next$0();if($.eqB($.index(t1,t4),$.CTC23)){var c=t2.getCoordinate$1(t4);t4=this._doReveal$2(c.get$Item1(),c.get$Item2());if(typeof t4!=='number')$.iae(t4);revealCount+=t4;}}else revealCount=1;}return revealCount;}},
 _setWon$0: function(){var t1=this.field;if(typeof t1!=='string'&&(typeof t1!=='object'||t1===null||t1.constructor!==Array&&!t1.is$JavaScriptIndexingBehavior()))return this._setWon$0$bailout(1,t1,0);var t3=this._states;if(typeof t3!=='object'||t3===null||(t3.constructor!==Array||!!t3.immutable$list)&&!t3.is$JavaScriptIndexingBehavior())return this._setWon$0$bailout(2,t1,t3);var i=0;for(;t2=t1.length,i<t2;++i){if(i<0||i>=t2)$.ioore(i);if(t1[i]===true){if(i<0||i>=t3.length)$.ioore(i);t3[i]=$.CTC31;}}this._setState$1($.CTC45);var t2;},
 _setWon$0$bailout: function(state,env0,env1){switch(state){case 1:t1=env0;break;case 2:t1=env0;t3=env1;break;}switch(state){case 0:var t1=this.field;case 1:state=0;var t3=this._states;case 2:state=0;var i=0;for(;$.ltB(i,$.get$length(t1));++i)if($.index(t1,i)===true)$.indexSet(t3,i,$.CTC31);this._setState$1($.CTC45);}},
 _setLost$0: function(){var t1=this.field;if(typeof t1!=='string'&&(typeof t1!=='object'||t1===null||t1.constructor!==Array&&!t1.is$JavaScriptIndexingBehavior()))return this._setLost$0$bailout(1,t1,0);var t3=this._states;if(typeof t3!=='object'||t3===null||(t3.constructor!==Array||!!t3.immutable$list)&&!t3.is$JavaScriptIndexingBehavior())return this._setLost$0$bailout(2,t1,t3);var i=0;for(;t2=t1.length,i<t2;++i){if(i<0||i>=t2)$.ioore(i);if(t1[i]===true){if(i<0||i>=t3.length)$.ioore(i);t3[i]=$.CTC30;}}this._setState$1($.CTC46);var t2;},
 _setLost$0$bailout: function(state,env0,env1){switch(state){case 1:t1=env0;break;case 2:t1=env0;t3=env1;break;}switch(state){case 0:var t1=this.field;case 1:state=0;var t3=this._states;case 2:state=0;var i=0;for(;$.ltB(i,$.get$length(t1));++i)if($.index(t1,i)===true)$.indexSet(t3,i,$.CTC30);this._setState$1($.CTC46);}},
 _update$0: function(){return this._updatedEvent.fireEvent$1($.CTC13);},
 _setState$1: function(value){if(!$.eqB(this._state,value)){this._state=value;if($.eqB(this._state,$.CTC41))this._startTime=$.DateImplementation$now();else if(this.get$gameEnded()===true)this._endTime=$.DateImplementation$now();this._gameStateEvent.fireEvent$1(this._state);}},
 _ensureStarted$0: function(){if($.eqB(this.get$state(),$.CTC42))this._setState$1($.CTC41);},
 _getAdjacentFlagCount$2: function(x,y){var t1=$.iterator(this.field.getAdjacentIndices$2(x,y));var t2=this._states;if(typeof t2!=='string'&&(typeof t2!=='object'||t2===null||t2.constructor!==Array&&!t2.is$JavaScriptIndexingBehavior()))return this._getAdjacentFlagCount$2$bailout(1,t1,t2);var val=0;for(;t1.hasNext$0()===true;){var t3=t1.next$0();if(t3!==(t3|0))$.iae(t3);if(t3<0||t3>=t2.length)$.ioore(t3);if($.eqB(t2[t3],$.CTC24))++val;}return val;},
...
$$.Enumerable = {"":
 [],
 "super": "Object",
 iterator$0: function(){$.$$throw($.CTC32);},
 ...
 first$1: function(f){if(f==null)f=new $.Enumerable_first_anon();var iter=$._WhereIterator$(this.iterator$0(),f,$.getRuntimeTypeInfo(this).T);if(iter.hasNext$0()!==true)$.$$throw($.CTC38);return iter.next$0();},
 first$0: function() {
 ...
 single$1: function(f){if(f==null)f=new $.Enumerable_single_anon();var iter=$._WhereIterator$(this.iterator$0(),f,$.getRuntimeTypeInfo(this).T);if(iter.hasNext$0()!==true)$.$$throw($.CTC38);var value=iter.next$0();if(iter.hasNext$0()===true)$.$$throw($.CTC48);return value;},
 single$0: function() {
...
$$._WhereIterator = {"":
 ...
 next$0: function(){if(this.hasNext$0()!==true)$.$$throw($.CTC2);this._lib3_next=null;return this._current;}
};
...
$$.IndexIterator = {"":
 ...
 next$0: function(){if(this.hasNext$0()!==true)$.$$throw($.CTC2);var t1=this._lib3_pos;if(typeof t1!=='number')return this.next$0$bailout(1,t1);this._lib3_pos=t1+1;return this._indexer$1(t1);},
...
$$.ListBase = {"":
 ...
 isEmpty$0: function(){return $.eq($.get$length(this),0);},
 get$length: function(){$.$$throw($.CTC33);},
 operator$index$1: function(index){$.$$throw($.CTC33);},
 last$0: function(){return this.operator$index$1($.sub($.get$length(this),1));},
 getRange$2: function(start,itemCount){if(typeof start!=='number')return this.getRange$2$bailout(1,start,itemCount);$.requireArgument($.ge(itemCount,0),'count',null);if(typeof itemCount!=='number')$.iae(itemCount);var lastIndex=start+itemCount-1;if(itemCount>0)if(start<0)$.$$throw($.IndexOutOfRangeException$(start));else if($.geB(lastIndex,$.get$length(this)))$.$$throw($.IndexOutOfRangeException$(lastIndex));var list=$.ListImplementation_List(null,$.getRuntimeTypeInfo(this).T);for(var i=start;i<=lastIndex;++i)list.push(this.operator$index$1(i));return list;},
 getRange$2$bailout: function(state,start,itemCount){$.requireArgument($.ge(itemCount,0),'count',null);var lastIndex=$.sub($.add(start,itemCount),1);if($.gtB(itemCount,0))if($.ltB(start,0))$.$$throw($.IndexOutOfRangeException$(start));else if($.geB(lastIndex,$.get$length(this)))$.$$throw($.IndexOutOfRangeException$(lastIndex));var list=$.ListImplementation_List(null,$.getRuntimeTypeInfo(this).T);for(var i=start;$.leB(i,lastIndex);i=$.add(i,1))list.push(this.operator$index$1(i));return list;},
 operator$indexSet$2: function(index,value){$.$$throw($.CTC34);},
 add$1: function(value){$.$$throw($.CTC34);},
 addLast$1: function(value){$.$$throw($.CTC34);},
 addAll$1: function(value){$.$$throw($.CTC34);},
 clear$0: function(){$.$$throw($.CTC34);},
 removeLast$0: function(){$.$$throw($.CTC34);},
 removeRange$2: function(start,length$){$.$$throw($.CTC34);},
 insertRange$3: function(start,length$,initialValue){$.$$throw($.CTC34);},
 is$List: function() { return true; },
 is$Collection: function() { return true; }
};
...
$$.ReadOnlyCollection = {"":
 ...
 operator$index$1: function(index){var t1=this._items;if(index!==(index|0))$.iae(index);if(index<0||index>=t1.length)$.ioore(index);return t1[index];}
};
...
$$.NoneHashMap = {"":
 ...
 operator$indexSet$2: function(key,value){var newT=$.Tuple$(key,value,$.getRuntimeTypeInfo(this).K,$.getRuntimeTypeInfo(this).V);for(var t1=this._lib3_values,i=0;i<t1.length;++i){if(i<0||i>=t1.length)$.ioore(i);if($.eqB(t1[i].get$Item1(),key)){if(i<0||i>=t1.length)$.ioore(i);t1[i]=newT;return;}}t1.push(newT);},
 remove$1: function(key){for(var t1=this._lib3_values,i=0;i<t1.length;++i){if(i<0||i>=t1.length)$.ioore(i);if($.eqB(t1[i].get$Item1(),key)){if(i<0||i>=t1.length)$.ioore(i);var t=t1[i];$.removeRange(t1,i,1);return t.get$Item2();}}return;},
...
$$.Array2d = {"":
 ...
 operator$index$1: function(index){var t1=this._source;if(typeof t1!=='string'&&(typeof t1!=='object'||t1===null||t1.constructor!==Array&&!t1.is$JavaScriptIndexingBehavior()))return this.operator$index$1$bailout(1,t1,index);if(index!==(index|0))$.iae(index);if(index<0||index>=t1.length)$.ioore(index);return t1[index];},
...
$$.GameRoot = {"":
 ["_textureMap", "_textureImg", "_lib2_stage", "_lib2_canvas?", "_gameElement", "_clickMan", "_leftCountDiv", "_gameStateDiv", "_clockDiv", "_gameElementTx", "_frameRequested", "_lib4_width", "_lib4_height", "_mineCount", "gameStorage", "game", "_updatedEventId", "_gameStateChangedId", "_setIntervalId"],
 "super": "GameManager",
 ...
 GameRoot$_internal$12: function(width,height,mineCount,_canvas,_stage,gameElement,_clickMan,_leftCountDiv,_gameStateDiv,_clockDiv,_textureMap,_textureImg){$.add$1(this._lib2_stage.get$invalidated(),this.get$_stageInvalidated());}
};
...
$$.GameElement = {"":
 ...
 set$game: function(value){this._game=value;if(value==null)this.set$size($.CTC43);else{var t1=value.get$field().get$width();if(typeof t1!=='number')$.iae(t1);t1=80*t1;var t2=value.get$field().get$height();if(typeof t2!=='number')$.iae(t2);this.set$size($.Size$(t1,80*t2));}},
 get$visualChildCount: function(){var t1=this._elements;if(t1==null)return 0;else return $.get$length(t1);},
 getVisualChild$1: function(index){var t1=this._elements;if(typeof t1!=='string'&&(typeof t1!=='object'||t1===null||t1.constructor!==Array&&!t1.is$JavaScriptIndexingBehavior()))return this.getVisualChild$1$bailout(1,t1,index);if(index!==(index|0))$.iae(index);if(index<0||index>=t1.length)$.ioore(index);return t1[index];},
 ...
 _toggleFlag$2: function(x,y){var ss=this.get$game().getSquareState$2(x,y);if($.eqB(ss,$.CTC23)){this.get$game().setFlag$3(x,y,true);return true;}else if($.eqB(ss,$.CTC24)){this.get$game().setFlag$3(x,y,false);return true;}return false;},
 _click$3: function(x,y,alt){var ss=this.get$game().getSquareState$2(x,y);if(alt===true){if($.eqB(ss,$.CTC23)||$.eqB(ss,$.CTC24))this._toggleFlag$2(x,y);else if($.eqB(ss,$.CTC25))if(this.get$game().canReveal$2(x,y)===true)this.get$game().reveal$2(x,y);}else if($.eqB(ss,$.CTC23))this.get$game().reveal$2(x,y);},
...
$$.SquareElement = {"":
 ...
 "super": "PElement",
 drawOverride$1: function(ctx){ctx.set$fillStyle(this.get$_fillStyle());ctx.fillRect$4(0,0,this.get$width(),this.get$height());ctx.set$strokeStyle('rgb(153, 153, 153)');ctx.strokeRect$5(0.5,0.5,this.get$width(),this.get$height(),1);if($.eqB(this.get$_squareState(),$.CTC25)){var adjCount=this.get$_adjacentCount();if($.gtB(adjCount,0)){ctx.set$textBaseline('middle');ctx.set$font('40px Helvetica');ctx.set$fillStyle('black');ctx.set$textAlign('center');ctx.fillText$4($.toString(adjCount),40,40,80);}}},
 ...
 get$_fillStyle: function(){switch(this.get$_squareState()){case $.CTC24:return 'orange';case $.CTC25:return 'white';case $.CTC30:return 'red';case $.CTC31:return 'green';case $.CTC23:return '#6666CC';default:$.$$throw('not supported');}},
...
$$.GameManager = {"":
 ["game="],
 "super": "Object",
 newGame$0: function(){if(!(this._updatedEventId==null)){this.get$game().get$updated().remove$1(this._updatedEventId);this.get$game().get$stateChanged().remove$1(this._gameStateChangedId);this._gameStateChanged$1($.CTC42);}this.set$game($.Game$($.Field_Field(this._mineCount,this._lib4_width,this._lib4_height,null)));this._updatedEventId=$.add$1(this.get$game().get$updated(),this.get$gameUpdated());this._gameStateChangedId=$.add$1(this.get$game().get$stateChanged(),this.get$_gameStateChanged());},
 _lib4_click$3: function(x,y,alt){var ss=this.get$game().getSquareState$2(x,y);if(alt===true){if($.eqB(ss,$.CTC23))this.get$game().setFlag$3(x,y,true);else if($.eqB(ss,$.CTC24))this.get$game().setFlag$3(x,y,false);else if($.eqB(ss,$.CTC25))this.get$game().reveal$2(x,y);}else if($.eqB(ss,$.CTC23))this.get$game().reveal$2(x,y);},
 updateClock$0: function(){if(this._setIntervalId==null&&$.eqB(this.get$game().get$state(),$.CTC41))this._setIntervalId=$.window().setInterval$2(this.get$_doClock(),1000);else if(!(this._setIntervalId==null)&&!$.eqB(this.get$game().get$state(),$.CTC41)){$.window().clearInterval$1(this._setIntervalId);this._setIntervalId=null;}},
 _doClock$0: function(){this.updateClock$0();},
 get$_doClock: function() { return new $.BoundClosure0(this, '_doClock$0'); },
 _gameStateChanged$1: function(newState){var t1=this.gameStorage;t1.recordState$1(newState);if($.eqB(newState,$.CTC45))t1.updateHighScore$1(this.get$game());this.updateClock$0();},
...
$$.ClickManager__mouseDown_anon = {"":
 [],
 "super": "Closure",
 call$1: function(e){return $.CTC29.get$1(e);}
};
...
$.parseDouble = function(str){$.checkString(str);var ret=parseFloat(str);if(ret===0)var t1=$.startsWith(str,'0x')===true||$.startsWith(str,'0X')===true;else t1=false;if(t1)ret=parseInt(str);if($.isNaN(ret)===true&&!$.eqB(str,'NaN')&&!$.eqB(str,'-NaN'))$.$$throw($.FormatException$(str));return ret;};
...
$.Primitives_stringFromCharCodes = function(charCodes){for(var t1=$.iterator(charCodes);t1.hasNext$0()===true;){var t2=t1.next$0();if(!(typeof t2==='number'&&t2===(t2|0)))$.$$throw($.IllegalArgumentException$(t2));}return String.fromCharCode.apply(null, charCodes);};
...
$.Game$ = function(field){var t1=new $.Game(field,$.Array2d_Array2d(field.get$width(),field.get$height(),$.CTC23,'SquareState'),$.EventHandle$('EventArgs'),$.EventHandle$('GameState'),$.CTC42,null,null,null,null);t1.Game$1(field);return t1;};
...
$.GameRoot$_internal = function(width,height,mineCount,_canvas,_stage,gameElement,_clickMan,_leftCountDiv,_gameStateDiv,_clockDiv,_textureMap,_textureImg){var t1=new $.GameRoot(_textureMap,_textureImg,_stage,_canvas,gameElement,_clickMan,_leftCountDiv,_gameStateDiv,_clockDiv,gameElement.addTransform$0(),false,width,height,mineCount,$.GameStorage$(),null,null,null,null);t1.GameManager$3(width,height,mineCount);t1.GameRoot$_internal$12(width,height,mineCount,_canvas,_stage,gameElement,_clickMan,_leftCountDiv,_gameStateDiv,_clockDiv,_textureMap,_textureImg);return t1;};
...
$.min = function(a,b){if(typeof a==='number'){if(typeof b==='number'){if(a>b)return b;if(a<b)return a;if(typeof b==='number'){if(typeof a==='number')if(a===0.0)return (a+b)*a*b;if(a===0&&$.isNegative(b)===true||$.isNaN(b)===true)return b;return a;}return a;}$.$$throw($.IllegalArgumentException$(b));}$.$$throw($.IllegalArgumentException$(a));};
...
$.getRange = function(receiver,start,length$){if(!$.isJsArray(receiver))return receiver.getRange$2(start,length$);if(0===length$)return [];$.checkNull(start);$.checkNull(length$);if(!(typeof start==='number'&&start===(start|0)))$.$$throw($.IllegalArgumentException$(start));if(!(typeof length$==='number'&&length$===(length$|0)))$.$$throw($.IllegalArgumentException$(length$));var t1=length$<0;if(t1)$.$$throw($.IllegalArgumentException$(length$));if(start<0)$.$$throw($.IndexOutOfRangeException$(start));var end=start+length$;if($.gtB(end,$.get$length(receiver)))$.$$throw($.IndexOutOfRangeException$(length$));if(t1)$.$$throw($.IllegalArgumentException$(length$));return receiver.slice(start, end);};

$._Lists_getRange = function(a,start,length$,accumulator){if(typeof a!=='string'&&(typeof a!=='object'||a===null||a.constructor!==Array&&!a.is$JavaScriptIndexingBehavior()))return $._Lists_getRange$bailout(1,a,start,length$,accumulator);if(typeof start!=='number')return $._Lists_getRange$bailout(1,a,start,length$,accumulator);if($.ltB(length$,0))$.$$throw($.IllegalArgumentException$('length'));if(start<0)$.$$throw($.IndexOutOfRangeException$(start));if(typeof length$!=='number')$.iae(length$);var end=start+length$;if(end>a.length)$.$$throw($.IndexOutOfRangeException$(end));for(var i=start;i<end;++i){if(i!==(i|0))$.iae(i);if(i<0||i>=a.length)$.ioore(i);accumulator.push(a[i]);}return accumulator;};
...
$.max = function(a,b){if(typeof b==='number'){if(a>b)return a;if(a<b)return b;if(typeof b==='number'){if(typeof a==='number')if(a===0.0)return a+b;if($.isNaN(b)===true)return b;return a;}if(b===0&&$.isNegative(a)===true)return b;return a;}$.$$throw($.IllegalArgumentException$(b));$.$$throw($.IllegalArgumentException$(a));};
...
$.charCodeAt = function(receiver,index){if(typeof receiver==='string'){if(!(typeof index==='number'))$.$$throw($.IllegalArgumentException$(index));if(index<0)$.$$throw($.IndexOutOfRangeException$(index));if(index>=receiver.length)$.$$throw($.IndexOutOfRangeException$(index));return receiver.charCodeAt(index);}else return receiver.charCodeAt$1(index);};
...
$.TextureInput__parseCoordinate = function(input){var match=$.$$($.CTC47.allMatches$1(input)).single$0();return $.Coordinate$($.parseDouble($.index(match,1)),$.parseDouble($.index(match,2)));};
...
$.ClickManager_setClickable = function(element,value){if(value)$.CTC29.set$2(element,true);else $.CTC29.clear$1(element);};
...
$.substring$2 = function(receiver,startIndex,endIndex){if(!(typeof receiver==='string'))return receiver.substring$2(startIndex,endIndex);$.checkNum(startIndex);var length$=receiver.length;if(endIndex==null)endIndex=length$;$.checkNum(endIndex);if($.ltB(startIndex,0))$.$$throw($.IndexOutOfRangeException$(startIndex));if($.gtB(startIndex,endIndex))$.$$throw($.IndexOutOfRangeException$(startIndex));if($.gtB(endIndex,length$))$.$$throw($.IndexOutOfRangeException$(endIndex));return $.substringUnchecked(receiver,startIndex,endIndex);};

$.require = function(truth,message){if(truth!==true)$.$$throw($.ExceptionImplementation$(message));};
...
$.GameRoot_GameRoot = function(width,height,mineCount,canvasElement,leftCountDiv,gameStateDiv,clockDiv,targetMode,textureMap,textureImg){$.requireArgumentNotNull(targetMode,'targetMode');var rootElement=$.GameElement$(targetMode);var stage=$.Stage$(canvasElement,rootElement);return $.GameRoot$_internal(width,height,mineCount,canvasElement,stage,rootElement,$.ClickManager$(stage),leftCountDiv,gameStateDiv,clockDiv,textureMap,textureImg);};

$._DOMApplicationCacheEventsImpl$ = function(_ptr){return new $._DOMApplicationCacheEventsImpl(_ptr);};

$.TextureInput__parseRect = function(input){var matches=$.$$($.CTC47.allMatches$1(input)).toList$0();return $.Rect_Rect$fromCoordSize($.TextureInput__parseCoordinate($.index($.index(matches,0),0)),$.TextureInput__parseCoordinate($.index($.index(matches,1),0)).toSize$0());};
...
$._Lists_getRange$bailout = function(state,a,start,length$,accumulator){if($.ltB(length$,0))$.$$throw($.IllegalArgumentException$('length'));if($.ltB(start,0))$.$$throw($.IndexOutOfRangeException$(start));var end=$.add(start,length$);if($.gtB(end,$.get$length(a)))$.$$throw($.IndexOutOfRangeException$(end));for(var i=start;$.ltB(i,end);i=$.add(i,1))accumulator.push($.index(a,i));return accumulator;};
...
$.CTC29 = new Isolate.$isolateProperties.Property(false, 'isClickable');
$.CTC34 = new Isolate.$isolateProperties.UnsupportedOperationException('Mutation operations are not supported');
...
$.CTC46 = new Isolate.$isolateProperties.GameState('lost');
...
$.CTC43 = new Isolate.$isolateProperties.Size(100, 100);
...
$.CTC33 = new Isolate.$isolateProperties.NotImplementedException('must be implemented by subclass');
...
$.CTC32 = new Isolate.$isolateProperties.NotImplementedException(null);
...
$.CTC25 = new Isolate.$isolateProperties.SquareState('revealed');
$.CTC2 = new Isolate.$isolateProperties.NoMoreElementsException();
$.CTC48 = new Isolate.$isolateProperties.InvalidOperationException('The input sequence contains more than one element.');
$.CTC24 = new Isolate.$isolateProperties.SquareState('flagged');
$.CTC31 = new Isolate.$isolateProperties.SquareState('safe');
$.CTC41 = new Isolate.$isolateProperties.GameState('started');
$.CTC26 = new Isolate.$isolateProperties.AttachedEvent('clickEvent');
$.CTC47 = new Isolate.$isolateProperties.JSSyntaxRegExp(false, false, '{([^,{]+),([^}]+)}');
$.CTC49 = new Isolate.$isolateProperties.Object();
$.CTC30 = new Isolate.$isolateProperties.SquareState('mine');
...
$.CTC37 = new Isolate.$isolateProperties.EmptyElementRect(Isolate.$isolateProperties.CTC36, Isolate.$isolateProperties.CTC36, Isolate.$isolateProperties.CTC36, Isolate.$isolateProperties.CTC36, Isolate.$isolateProperties.CTC0);
...
$.TextureInput__pairExp = Isolate.$isolateProperties.CTC47;
$._JsonParser_TAB = 9;
...
$.SquareState_safe = Isolate.$isolateProperties.CTC31;
$.GameState_started = Isolate.$isolateProperties.CTC41;
$._getTypeNameOf = null;
$.Duration_MILLISECONDS_PER_DAY = 86400000;
$.SquareState_mine = Isolate.$isolateProperties.CTC30;
...
$.GameState_lost = Isolate.$isolateProperties.CTC46;
$._JsonParser_LAST_ASCII = 125;
$._JsonParser_CHAR_T = 116;
$.SquareState_revealed = Isolate.$isolateProperties.CTC25;
$.GameState_reset = Isolate.$isolateProperties.CTC42;
...
$.$defineNativeClass('CanvasRenderingContext2D', ["fillStyle!", "font!", "globalAlpha!", "strokeStyle!", "textAlign!", "textBaseline!"], {
...
$.$defineNativeClass('DOMStringList', ["length?"], {
 ...
 add$1: function(value){$.$$throw($.CTC);},
 addLast$1: function(value){$.$$throw($.CTC);},
 addAll$1: function(collection){$.$$throw($.CTC);},
 forEach$1: function(f){return $._Collections_forEach(this,f);},
 filter$1: function(f){return $._Collections_filter(this,[],f);},
 isEmpty$0: function(){return $.eq($.get$length(this),0);},
 last$0: function(){return this.operator$index$1($.sub($.get$length(this),1));},
 removeLast$0: function(){$.$$throw($.CTC3);},
 removeRange$2: function(start,rangeLength){$.$$throw($.CTC28);},
 insertRange$3: function(start,rangeLength,initialValue){$.$$throw($.CTC35);},
