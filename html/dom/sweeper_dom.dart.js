...
$$.Game = {"":
 ...
 setFlag$3: function(x, y, value) {
  ...
  if (value) {
    $.require($.eq(currentSS, $.CTC22), '');
    t1.set$3(x, y, $.CTC23);
    this._minesLeft = $.sub(this._minesLeft, 1);
  } else {
    $.require($.eq(currentSS, $.CTC23), '');
    t1.set$3(x, y, $.CTC22);
 ...
 canReveal$2: function(x, y) {
  this._ensureStarted$0();
  if ($.eqB(this._states.get$2(x, y), $.CTC22))
    return true;
 ...
 reveal$2$bailout: function(state, env0) {
  ...
  switch (state) {
    case 0:
      ...
      $.require(this.canReveal$2(x, y), 'Item cannot be revealed.');
    case 1:
      if (state === 1 || state === 0 && $.eqB(this._states.get$2(x, y), $.CTC22))
        switch (state) {
          case 0:
          case 1:
 ...
 _canChord$2: function(x, y) {
  if ($.eqB(this._states.get$2(x, y), $.CTC16)) {
    ...
    if ($.gtB(adjCount, 0))
      if ($.gtB(this._getAdjacentCount$3(x, y, $.CTC22), 0))
        if ($.eqB(this._getAdjacentCount$3(x, y, $.CTC23), adjCount))
          return true;
  }
  return false;
},
 ...
 _doChord$2$bailout: function(state, env0, env1, env2, env3, env4, env5) {
  ...
  switch (state) {
    ...
    case 2:
      ...
      for (var t2 = $.iterator(t3.getAdjacentIndices$2(x, y)), failed = false; t2.hasNext$0() === true;) {
        var t4 = t2.next$0();
        if ($.eqB($.index(t1, t4), $.CTC22)) {
          hidden.push(t4);
          if ($.index(t3, t4) === true)
            failed = true;
        } else if ($.eqB($.index(t1, t4), $.CTC23))
          flagged.push(t4);
      }
      var reveals = [];
      if (failed)
 ...
 _ensureStarted$0: function() {
  if ($.eqB(this.get$state(), $.CTC24))
    this._setState$1($.CTC25);
},
...
$$.GameManager = {"":
 ...
 updateClock$0: function() {
  if (this._setIntervalId == null && $.eqB(this.game.get$state(), $.CTC25))
    this._setIntervalId = $.window().setInterval$2(this.get$_doClock(), 1000);
  else if (!(this._setIntervalId == null) && !$.eqB(this.game.get$state(), $.CTC25)) {
 ...
 get$_canClick: function() {
  return $.eqB(this.game.get$state(), $.CTC24) || $.eqB(this.game.get$state(), $.CTC25);
},
...
$.GameView$ = function(width, height, mineCount, _table, _leftCountDiv, _gameStateDiv, _clockDiv) {
  var t1 = new $.GameView(_table, _leftCountDiv, _gameStateDiv, _clockDiv, width, height, mineCount, $.GameStorage$(), null, null, null, null);
...
$.Game$ = function(field) {
  ...
  t2 = new $.Game(field, $.Array2d_Array2d(field.get$width(), field.get$height(), $.CTC22, 'SquareState'), t1, t2, $.CTC24, null, null, null, null);
  t2.Game$1(field);
  return t2;
};
