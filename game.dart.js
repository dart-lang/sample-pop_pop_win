...
$$._Serializer0 = {"":
 ...
 _lib9_serializeList$1$bailout: function(state, list) {
  var len = $.get$length(list);
  var result = $.ListImplementation_List(len);
  for (var i = 0; $.ltB(i, len); ++i) {
    var t1 = this._lib9_dispatch$1($.index(list, i));
...
$$._Deserializer0 = {"":
 ...
 _lib9_deserializeList$1$bailout: function(state, dartList, id) {
  $.indexSet(this._lib9_deserialized, id, dartList);
  var len = $.get$length(dartList);
  for (var i = 0; $.ltB(i, len); ++i)
 ...
 _lib9_deserializeMap$1$bailout: function(state, env0, env1, env2) {
  switch (state) {
    case 1:
      var x = env0;
      result = env1;
...
$$.Field = {"":
 ...
 toString$0: function() {
  return 'w' + $.S(this.width) + 'h' + $.S(this.height) + 'm' + $.S(this.mineCount);
},
...
$$.Game = {"":
 ...
 _getAdjacentCount$3: function(x, y, ss) {
  var t1 = $.iterator(this.field.getAdjacentIndices$2(x, y));
  var t2 = this._states;
  if (typeof t2 !== 'string' && (typeof t2 !== 'object' || t2 === null || t2.constructor !== Array && !t2.is$JavaScriptIndexingBehavior()))
    return this._getAdjacentCount$3$bailout(1, ss, t1, t2);
  var val = 0;
 ...
 _getAdjacentCount$3$bailout: function(state, ss, t1, t2) {
  var val = 0;
  for (; t1.hasNext$0() === true;)
    if ($.eqB($.index(t2, t1.next$0()), ss))
      ++val;
  return val;
},
...
$$.GameElement = {"":
 ...
 _startDartAnimation$1: function(points) {
  ...
  for (var t1 = $.iterator(points), t2 = this._dartAnimationLayer; t1.hasNext$0() === true;) {
    ...
    if (typeof t3 !== 'number')
      throw $.iae(t3);
    var squareOffset = $.CTC51.operator$add$1($.Vector$(t4, 80 * t3));
...
$$.GameStorage = {"":
 ...
 getBestTimeMilliseconds$3: function(width, height, mineCount) {
...
$$.GameManager = {"":
 ...
 get$bestTimeMilliseconds: function() {
  return this._gameStorage.getBestTimeMilliseconds$3(this._lib5_width, this._lib5_height, this._mineCount);
},
 newGame$0: function() {
 ...
 updateClock$0: function() {
  if (this._setIntervalId == null && $.eqB(this._game.get$state(), $.CTC45))
    this._setIntervalId = $.window().setInterval$2(this.get$_doClock(), 1000);
  else if (!(this._setIntervalId == null) && !$.eqB(this._game.get$state(), $.CTC45)) {
...
$$.GameElement__startPopAnimation_anon0 = {"":
 ...
 "super": "Closure",
 call$1: function(t2) {
  return $.eqB(t2.get$item2(), $.CTC46) || $.eqB(t2.get$item2(), $.CTC34);
}
};
...
$$.GameElement__startPopAnimation_anon2 = {"":
 ...
 call$1: function(c) {
  ...
  var squareOffset = $.CTC49.operator$add$1(initialOffset);
...
$.$defineNativeClass('HTMLDocument', ["body?", "documentElement?"], {
 ...
 queryAll$1: function(selectors) {
  ...
  } else if ($.CTC42.hasMatch$1(selectors) === true) {
 ...
 queryAll$1$bailout: function(state, env0) {
  ...
  switch (state) {
    case 0:
    default:
      if (state === 1 || state === 0 && $.CTC41.hasMatch$1(selectors) === true)
        switch (state) {
          case 0:
            var mutableMatches = this.$dom_getElementsByName$1($.substring$2(selectors, 7, selectors.length - 2));
          case 1:
        ...
        switch (state) {
          case 0:
          case 2:
            if (state === 2 || state === 0 && $.CTC42.hasMatch$1(selectors) === true)
              switch (state) {
                case 0:
                  mutableMatches = this.$dom_getElementsByTagName$1(selectors);
                case 2:
