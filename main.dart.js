...
s=J.A(a)
if(typeof s!="string")throw H.b(H.G(a))
return s},
...
if(H.Q1(b))if(a instanceof H.v){s=H.JS(a)
...
if(r!=null)return r
return H.r9(a,s)},
r9:function(a,b){var s=a instanceof H.v?a.__proto__.__proto__.constructor:b,r=H.ai(v.typeUniverse,s.name)
b.$ccache=r
return r},
...
return this.z.b(a)},
t4:function(a){var s=this,r=s.r
...
break
case 42:l=a.u
f.push(H.SO(l,H.KQ(l,a.e,f.pop()),a.n))
break
case 63:l=a.u
...
uk:function(a,b){var s=0,r=P.F(t.H),q,p,o,n,m,l,k
...
$.LS=o+1
n=t.m
m=new O.Jq(p,"DIRECTION_RIGHT",o,H.VM([],n),T.oy())
m.c=51
m.d=8
m.sA7(0,0)
p=q.kI("loading_text")
o=$.LS
$.LS=o+1
l=new A.jx(p,o,H.VM([],n),T.oy())
l.c=141
l.d=10
p=H.VM([],t.o)
o=$.LS
$.LS=o+1
k=new A.AE(p,o,H.VM([],n),T.oy())
o=q.kI("loading_background")
p=$.LS
$.LS=p+1
k.bS(new A.jx(o,p,H.VM([],n),T.oy()))
k.bS(m)
k.bS(l)
k.c=C.jn.W(b.Yr,2)-504
k.id=!0
k.d=400
k.r=2
k.x=2
...
p=a.b
new P.Gm(p,H.Lh(p).C("Gm<1>")).yI(new E.y9(m,a))
s=2
...
dP:function(a){var s,r=new E.W1(),q=a==null?$.Y6().destination:a
r.a=q
s=$.Y6()
s=(s&&C.Fp).U5(s)
r.b=s
...
$.HX=E.dP(null)}var s=window.navigator.userAgent
if(J.U6(s).tg(s,"IEMobile"))if(C.xB.tg(s,"9.0"))$.FS=C.a1
...
s.P(a,b)
return s},
Jd:function(a){var s,r,q=a.c,p=q.a
p=p.gqN(p)
s=T.oy()
r=t.p
r=new L.p5(p,p.getContext("2d"),s,C.yK,new L.PT(),P.bK(r),P.bK(r))
r.CH(0)
return new A.Oo(a,r,q.gmH())},
...
this.b=b}},V={
AY:function(a,b){var s=H.VM([],t.o),r=$.LS
$.LS=r+1
r=new V.ce(s,r,H.VM([],t.m),T.oy())
r.Fr(a,b)
return r},
...
kZ:function(a){var s,r,q,p,o,n,m,l,k=t.o,j=H.VM([],k),i=$.LS
$.LS=i+1
s=t.m
r=H.VM([],s)
q=T.oy()
...
l=$.LS
$.LS=l+1
s=new U.Mp(a,new A.AE(j,i,r,q),new A.AE(p,o,n,m),k,l,H.VM([],s),T.oy())
s.Fr(a)
return s},
...
r.toString
$.uU=C.ol.ne(s,r)}},
mN:function(a,b,c,d){var s,r=T.oy(),q=new T.Xo(new Float32Array(16))
q.xI()
q=new L.PQ(C.yK,r,q,null)
s=new L.up(a,q)
s.e=q
if(b instanceof T.yW)r.M1(b)
if(typeof c=="number")q.a=c
return s},
...
break}s=$.pL
if(s==null)H.vh(P.PV("ResourceManager not initialized"))
...
$iqU:1}
H.Ow.prototype={
w:function(a){var s="LateInitializationError: "+this.a
return s}}
H.bQ.prototype={}
H.aL.prototype={
...
Oz:function(a,b){var s,r=this,q=new H.db(a,b)
...
return s==null?H.vh(H.yR("Local 'error' has not been initialized.")):s}}
P.V1.prototype={
$0:function(){var s=this.a.d
return s==null?H.vh(H.yR("Local 'stackTrace' has not been initialized.")):s}}
P.VN.prototype={
...
if(t.R.b(s))return r.R(s,a.a,a.b)
...
if((m.b&3)!==0)throw H.b(P.PV("Stream has already been listened to."))
s=$.X3
r=d?1:0
q=P.AM(s,a)
P.pF(s,b)
...
i:function(a){return this.RT(a,t.z)},
...
R:function(a,b,c){return this.rp(a,b,c,t.z,t.z,t.z)},
...
w:function(a){var s=this,r=P.Gq(H.tJ(s)),q=P.h0(H.NS(s)),p=P.h0(H.jA(s)),o=P.h0(H.KL(s)),n=P.h0(H.ch(s)),m=P.h0(H.XJ(s)),l=P.yy(H.o1(s))
...
P.Rt.prototype={
E:function(a,b){var s=this.a
if(b>=s)H.vh(P.Cf(b,this,"index",null,s))
return this.b.$1(b)},
gA:function(a){return this.a}}
P.An.prototype={}
...
if(b==null)return!1
if(t.q.b(b)){s=J.YE(b)
s=a.left==s.gBb(b)&&a.top==s.gG6(b)&&a.width==s.gq9(b)&&a.height==s.gLj(b)}else s=!1
return s},
...
r.Iv()}}}
D.Az.prototype={
$1:function(a){var s,r,q,p=this.a,o=t.r,n=o.a(p.fy).Qt.e.a,m=C.jn.zY(a,n.a),l=C.jn.xG(a,n.b)
n=A.MB(80,80,16777215)
s=$.LS
$.LS=s+1
r=t.m
s=new A.jx(n,s,H.VM([],r),T.oy())
n=H.VM([],t.o)
q=$.LS
$.LS=q+1
r=new A.Jf(m,l,s,n,q,H.VM([],r),T.oy())
r.bS(s)
s=t.Q
q=r.glh()
r.Ep(0,"click",s).XE(q,!1,0)
r.Ep(0,"rightClick",s).XE(q,!1,0)
r.r1="pointer"
n=this.b
r.c=m*n
r.id=!0
...
$S:19}
V.ce.prototype={
Fr:function(b2,b3){var s,r,q,p,o,n,m,l,k,j,i,h,g,f,e,d,c,b,a,a0,a1,a2,a3,a4,a5,a6,a7=this,a8=null,a9="background_top_left",b0="background_side_left",b1="source-over"
b2.bS(a7)
s=b3.kI(a9)
r=$.LS
$.LS=r+1
...
m=$.LS
$.LS=m+1
l=new A.jx(n,m,H.VM([],q),T.oy())
l.d=96
n=b3.kI(a9)
m=$.LS
$.LS=m+1
k=new A.jx(n,m,H.VM([],q),T.oy())
k.x=-1
k.d=1534
n=b3.kI(b0)
m=$.LS
$.LS=m+1
j=new A.jx(n,m,H.VM([],q),T.oy())
j.x=-1
j.d=1438
n=b3.kI(a9)
m=$.LS
$.LS=m+1
i=new A.jx(n,m,H.VM([],q),T.oy())
i.r=-1
i.c=2048
n=b3.kI(b0)
m=$.LS
$.LS=m+1
h=new A.jx(n,m,H.VM([],q),T.oy())
h.r=-1
h.c=2048
h.d=96
n=b3.kI(a9)
...
m=$.LS
$.LS=m+1
f=new A.jx(n,m,H.VM([],q),T.oy())
f.r=-1
f.c=2048
f.x=-1
f.d=1438
a7.bS(new A.jx(s,r,p,o))
a7.bS(l)
a7.bS(k)
a7.bS(j)
a7.bS(i)
...
e=A.MB(r,r,0)
r=t.b
d=new U.tn(0,0,112,122,r)
p=t.W
e.xV(b3.kI("game_board_corner_top_left"),d,new U.tZ(0,0,p))
e.xV(b3.kI("game_board_corner_top_right"),d,new U.tZ(s.a(a7.fy).YL-112,0,p))
e.xV(b3.kI("game_board_corner_bottom_left"),d,new U.tZ(0,s.a(a7.fy).YL-112,p))
o=b3.kI("game_board_corner_bottom_right")
n=s.a(a7.fy).YL-112
e.xV(o,d,new U.tZ(n,n,p))
c=new U.tn(0,0,80,112,r)
b=new U.tn(0,0,112,80,r)
for(r=e.c,o=t.aC,n=r.a,a=0;a<s.a(a7.fy).Qt.e.a.a-2;++a){m=b3.kI("game_board_side_top")
a0=112+a*80
a1=n.gqN(n)
a2=T.oy()
a3=a1.getContext("2d")
...
a3.globalCompositeOperation=b1
a3.globalAlpha=1
new A.Oo(e,new L.p5(a1,a3,a2,C.yK,new L.PT(),new P.DL(a8,a8,o),new P.DL(a8,a8,o)),r.gmH()).hW(m,c,new U.tZ(a0,0,p),a8)
n.Li(0)
m=b3.kI("game_board_side_bottom")
a2=s.a(a7.fy).YL
a3=n.gqN(n)
a1=T.oy()
a4=a3.getContext("2d")
...
a4.globalCompositeOperation=b1
a4.globalAlpha=1
new A.Oo(e,new L.p5(a3,a4,a1,C.yK,new L.PT(),new P.DL(a8,a8,o),new P.DL(a8,a8,o)),r.gmH()).hW(m,c,new U.tZ(a0,a2-112,p),a8)
n.Li(0)
a2=b3.kI("game_board_side_left")
m=n.gqN(n)
a1=T.oy()
a4=m.getContext("2d")
a3=a1.a
a4.setTransform(a3[0],a3[1],a3[2],a3[3],a3[4],a3[5])
a4.globalCompositeOperation=b1
a4.globalAlpha=1
new A.Oo(e,new L.p5(m,a4,a1,C.yK,new L.PT(),new P.DL(a8,a8,o),new P.DL(a8,a8,o)),r.gmH()).hW(a2,b,new U.tZ(0,a0,p),a8)
n.Li(0)
a2=b3.kI("game_board_side_right")
a1=s.a(a7.fy).YL
a4=n.gqN(n)
m=T.oy()
a3=a4.getContext("2d")
...
a3.globalCompositeOperation=b1
a3.globalAlpha=1
new A.Oo(e,new L.p5(a4,a3,m,C.yK,new L.PT(),new P.DL(a8,a8,o),new P.DL(a8,a8,o)),r.gmH()).hW(a2,b,new U.tZ(a1-112,a0,p),a8)
n.Li(0)}r=$.LS
$.LS=r+1
a6=new A.jx(e,r,H.VM([],q),T.oy())
q=$.Vi()
a6.c=q.a
a6.d=q.b
s=s.a(a7.fy).Hs
...
k=$.LS
$.LS=k+1
j=new A.jx(l,k,H.VM([],o),T.oy())
m=A.VK(new A.jx(s,p,n,m),j,j,j)
m.c=450
m.id=!0
m.d=20
s=t.Q
m.Ep(0,"click",s).XE(new U.oB(f),!1,0)
f.bS(m)
m=D.t5(f)
p=$.Vi()
n=p.a
...
l=$.LS
$.LS=l+1
l=new X.XY(a,m,l,H.VM([],o),T.oy())
l.EB(e,e)
l.sJv(Y.Uk("Slackey, cursive",28,b,"left",!1,0,e,0,!1,1,0,0,b,0,0,!1,"top",400))
l.kX="left"
l.HV|=3
l.c=1400
l.id=!0
...
m.c.a.Li(0)
p=$.pL
if(p==null)H.vh(P.PV("ResourceManager not initialized"))
...
if(!t.eI.b(a))H.vh(P.xY("tweenObject"))
...
try{s=b.r
r=new T.Xo(new Float32Array(16))
r.xI()
q=H.VM([],t.fi)
p=t.O
o=t.B
...
t.h4.a(d)
if(!t.gD.b(d))H.vh(P.PV("Failed to get WebGL context."))
e.e=d
d.enable(3042)
e.e.disable(2960)
e.e.disable(2929)
...
r.CH(0)
return r}},
Vp:function(){var s,r,q,p,o,n,m,l=this,k=l.Yr,j=l.hx,i=l.I6.getBoundingClientRect(),h=l.I6,g=h.clientLeft,f=J.Vu(i.left),e=h.clientTop,d=J.Vu(i.top),c=h.clientWidth,b=h.clientHeight
if(c===0||b===0)return
s=c/k
r=b/j
switch(l.c4){case C.pq:q=r
p=s
break
case C.o6:q=s>r?s:r
p=q
...
default:p=1
q=1}h=l.bb
switch(h){case C.fR:case C.kx:case C.e8:o=0
break
case C.d4:case C.eb:case C.L6:o=(c-k*p)/2
break
case C.IK:case C.ld:case C.Kq:o=c-k*p
break
default:o=0}switch(h){case C.e8:case C.d4:case C.IK:n=0
break
case C.fR:case C.eb:case C.ld:n=(b-j*q)/2
break
case C.kx:case C.L6:case C.Kq:n=b-j*q
break
default:n=0}h=l.GI
h.a=-o/p
h.b=-n/q
...
h.Pc(0,m,m)
m=l.No
m.Vy(1,0,0,1,-(g+f)-o,-(e+d)-n)
m.Pc(0,1/p,1/q)
m=l.V6
m.c0()
d=l.iN
m.Pc(0,d,d)
if(l.G4!==c||l.hU!==b){l.G4=c
l.hU=b
l.I6.width=C.CD.zQ(c*l.iN)
l.I6.height=C.CD.zQ(b*l.iN)
h=l.I6
if(h.clientWidth!==c||h.clientHeight!==b){h=h.style
g=H.d(c)+"px"
h.width=g
h=l.I6.style
g=H.d(b)+"px"
h.height=g}l.H2(0,new R.ea("resize",!1))}},
...
a0.ctrlKey
f=a0.shiftKey
m.H2(0,new R.Aj(o.f,l,h,f,"mouseOut",!0))}for(e=0;e<k.length-g;++e){d=k[e]
d.TK(q,p)
l=p.a
h=p.b
a0.altKey
a0.ctrlKey
f=a0.shiftKey
d.H2(0,new R.Aj(o.f,l,h,f,"rollOut",!1))}for(e=j.length-g-1;e>=0;--e){d=j[e]
d.TK(q,p)
l=p.a
h=p.b
a0.altKey
a0.ctrlKey
f=a0.shiftKey
d.H2(0,new R.Aj(o.f,l,h,f,"rollOver",!1))}if(n!=null){n.TK(q,p)
l=p.a
h=p.b
a0.altKey
a0.ctrlKey
f=a0.shiftKey
n.H2(0,new R.Aj(o.f,l,h,f,"mouseOver",!0))}a.rT=n}a.cq()
...
a0.ctrlKey
h=a0.shiftKey
n.H2(0,new R.Aj(o.f,s,l,h,c,!0))
if(b){s=p.a
l=p.b
a0.altKey
a0.ctrlKey
h=a0.shiftKey
n.H2(0,new R.Aj(o.f,s,l,h,o.c,!0))}}},
Yo:function(a){var s,r,q,p=this.No.Ey(new P.hL(a.clientX,a.clientY,t.n)),o=new U.tZ(0,0,t.e),n=this.Fo(p.a,p.b)
n.TK(p,o)
s=o.a
r=o.b
a.altKey
...
C.Kb.gOW(a)
C.Kb.gNC(a)
n.H2(0,new R.Aj(!1,s,r,q,"mouseWheel",!0))},
...
L.PQ.prototype={
gwW:function(){var s,r=this.f
if(r==null){r=T.oy()
s=new T.Xo(new Float32Array(16))
s.xI()
s=this.f=new L.PQ(C.yK,r,s,this)
r=s}return r}}
L.up.prototype={
...
s=q.c
return T.Te(0,0-p,p,0,o.a+s.b,o.b+o.d-s.a)}else throw H.b(P.Vx())},
...
XE:function(a,b,c){var s,r,q,p,o,n,m=this,l=m.$ti,k=new R.id(c,!1,m,a,l.C("id<1*>")),j=m.c,i=j.length,h=new Array(i+1)
h.fixed$length=Array
s=H.VM(h,l.C("jd<id<1*>*>"))
r=s.length-1
...
p=H.VM(q,this.$ti.C("jd<id<1*>*>"))
for(q=p.length,o=0,n=0;o<r;++o){m=s[o]
if(m===a)continue
if(n>=q)return
l=n+1
p[n]=m
...
else s.a=""}};(function aliases(){var s=J.vB.prototype
s.T=s.w
s=J.MF.prototype
s.t=s.w
s=P.Ly.prototype
...
q(P,"Cr","SZ",5)
s(P,"am","dL",2)
p(P.Pf.prototype,"gYJ",0,1,null,["$2","$1"],["k","pm"],14,0)
o(P.vs.prototype,"gFa","ZL",5)
n(P.EM.prototype,"gcv","Dd",2)
r(W,"Gu","Z3",39)
r(E,"o9","OL",10)
r(E,"py","px",11)
var l
n(l=A.k0.prototype,"gMx","TE",2)
m(l,"gpe","wG",18)
m(A.Jf.prototype,"glh","Nu",6)
r(K,"XM","AI",26)
m(l=A.QQ.prototype,"gNT","Z3",6)
m(l,"gd6","Hj",23)
m(l=A.mE.prototype,"gNT","Z3",10)
m(l,"gUm","Yo",25)
m(l,"gd6","Hj",40)
m(l,"gSf","Pr",11)
m(A.PC.prototype,"gXP","t3",28)
m(l=L.IM.prototype,"gUp","WO",12)
m(l,"gyD","aZ",12)
m(L.TS.prototype,"gL","Ve",13)
m(l=R.yk.prototype,"gyF","Yx",0)
m(l,"gZz","bT",0)
m(l=N.Nn.prototype,"gZQ","JN",32)
m(l,"gtB","mB",0)
m(l,"giW","UK",0)
m(E.za.prototype,"gtl","ZZ",0)
m(l=E.zo.prototype,"gAD","nR",33)
n(l,"gG7","SB",2)
m(l,"gGh","rH",13)
m(E.bH.prototype,"gxv","SN",0)
m(l=Y.XN.prototype,"gpx","aO",35)
m(l,"gEw","dv",36)
m(l,"gO6","cH",6)})();(function inheritance(){var s=hunkHelpers.mixin,r=hunkHelpers.inherit,q=hunkHelpers.inheritMany
r(P.a,null)
q(P.a,[H.FK,J.vB,J.m1,P.Ge,P.Ly,H.a7,P.An,H.Fu,H.SU,H.v,H.Zr,H.te,H.bq,H.XO,P.Yk,H.db,H.N6,H.VR,H.EK,H.Pb,H.tQ,H.Sd,H.Jc,H.ET,H.lY,P.W3,P.ih,P.qh,P.KA,P.WV,P.b8,P.Pf,P.Fe,P.vs,P.OM,P.MO,P.kT,P.Kd,P.VT,P.of,P.fI,P.B3,P.EM,P.xI,P.OH,P.m0,P.nY,P.lD,P.pW,P.a2,P.iP,P.lf,P.a6,P.ii,P.VS,P.CD,P.aE,P.zM,P.c8,P.Od,P.ib,P.Gz,P.Zd,P.P1,P.qU,P.Rn,W.P8,W.Fk,W.kG,W.G3,W.W9,W.dW,P.e7,P.b2,P.hL,N.Bk,N.cw,N.fq,A.k0,M.HB,D.Il,R.pp,U.tp,U.Nl,K.K1,K.Gn,K.LE,K.J3,K.O2,K.AS,A.js,A.uX,A.L1,A.Oo,L.Kw,L.TS,A.vc,A.dG,A.IK,A.P0,A.Rx,A.Bg,A.oA,A.ZF,L.GK,L.Io,L.O3,L.aK,L.dZ,L.UE,L.F7,L.Xt,L.pr,L.PQ,L.up,L.PT,L.Gp,L.jc,L.RK,L.yM,R.ea,R.T1,R.e0,R.vZ,T.yW,T.Xo,U.tZ,U.tn,U.xy,R.yk,N.Nn,E.Er,E.Me,E.W1,E.N2,E.ye,E.e5,O.fm,O.YY,O.lN,O.en,O.vx,O.Rj,O.vp,O.on,Y.Xv,Y.xV,Y.EW,Q.JW])
